...
@SqlResultSetMapping(name = "SecteurActivitePojo", 
        classes = @ConstructorResult(targetClass = SecteurActivitePojo.class, 
                columns = { 
                    @ColumnResult(name = "codeSecteurActivite", type = String.class), 
                    @ColumnResult(name = "libelleSecteurActivite", type = String.class), 
                    @ColumnResult(name = "libelleCourtSecteurActivite", type = String.class), 
                    @ColumnResult(name = "codeDomaineActivite", type = String.class), 
                    @ColumnResult(name = "libelleDomaineActivite", type = String.class), 
                    @ColumnResult(name = "libelleCourtDomaineActivite", type = String.class) 
}))

/*
In this class, I’ve created a mapping with the name “SecteurActivitePojo” 
and specified the SecteurActivitePojo.class class as the targetClass in the ConstructorResult annotation.
...
@Entity
public class SecteurActivitePojo {
    @Id
    private String codeSecteurActivite;

    /*
        CodeSecteurActivite, LibelleSecteurActivite, LibelleCourtSecteurActivite, isInactif, 
		CodeDomaineActivite, LibelleDomaineActivite, LibelleCourtDomaineActivite
    */
                        
    private String libelleSecteurActivite;
    private String libelleCourtSecteurActivite;
