...
@SqlResultSetMapping(name = "TableauCollectePojo", 
        classes = @ConstructorResult(targetClass = TableauCollectePojo.class, 
                columns = { 
                    @ColumnResult(name = "codeTableau", type = String.class),  
                    @ColumnResult(name = "libelleTableau", type = String.class),  
                    @ColumnResult(name = "libelleCourtTableau", type = String.class),  
                    
                    @ColumnResult(name = "codeIndicateur", type = String.class),  
                    @ColumnResult(name = "noOrdre", type = Integer.class),  
                    @ColumnResult(name = "libelleIndicateur", type = String.class),  
                    @ColumnResult(name = "libelleCourtIndicateur", type = String.class) 
}))

/*
In this class, I’ve created a mapping with the name “TableauCollectePojo” 
and specified the TableauCollectePojo.class class as the targetClass in the ConstructorResult annotation.
...
@Entity
public class TableauCollectePojo {
    @Id
    private String codeTableau;

    private String libelleTableau;
    private String libelleCourtTableau;
...
/*
    CodeTableau, LibelleTableau, LibelleCourtTableau,	
    CodeIndicateur, NoOrdre, LibelleIndicateur, LibelleCourtIndicateur
