...
@SqlResultSetMapping(name = "TypePorteurPojo", 
        classes = @ConstructorResult(targetClass = TypePorteurPojo.class, 
                columns = { 
                    @ColumnResult(name = "codeTypePorteur", type = String.class),  
                    @ColumnResult(name = "libelleTypePorteur", type = String.class),  
                    @ColumnResult(name = "libelleCourtTypePorteur", type = String.class),  
                    @ColumnResult(name = "noCompteClient", type = String.class)
}))

/*
In this class, I’ve created a mapping with the name “TypePorteurPojo” 
and specified the TypePorteurPojo.class class as the targetClass in the ConstructorResult annotation.
