...
@Entity
@Table(name="FacturationActeDetails")
/*
...
public class FacturationActeDetails implements Serializable {
    @EmbeddedId
    private FacturationActeDetailsId facturationActeDetailsId;    
    ...
    public FacturationActeDetails() {
        //Initialisation des valeurs par défaut
        this.montantFactureService = 0L;
    }

    public FacturationActeDetails(FacturationActe facturationActe, PrestationDemande prestationDemande) {
        this.facturationActeDetailsId = new FacturationActeDetailsId();
    ...
    public FacturationActeDetails(FacturationActe facturationActe) {
        this.facturationActeDetailsId = new FacturationActeDetailsId();
        this.facturationActeDetailsId.setNoFacturation(facturationActe.getNoFacturation());
        this.facturationActe = facturationActe;
    ...
    public FacturationActeDetails(PrestationDemande prestationDemande) {
        this.facturationActeDetailsId = new FacturationActeDetailsId();
        this.facturationActeDetailsId.setNoPrestation(prestationDemande.getNoPrestation());
        this.prestationDemande = prestationDemande;
