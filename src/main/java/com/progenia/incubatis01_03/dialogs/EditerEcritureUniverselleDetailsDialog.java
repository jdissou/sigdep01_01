 ...
 */
public class EditerEcritureUniverselleDetailsDialog extends BaseEditerTransactionDetailDialog<MouvementComptaDetails> {
    /***
     * EditerEcritureUniverselleDetailsDialog is responsible for launch Dialog. 
    ...
    */
    ...
    private MouvementCompta parentBean;
    ...
    /* Fields to edit properties in MouvementComptaDetails entity */
    ...
    public EditerEcritureUniverselleDetailsDialog() {
        //Cette méthode contient les instructions pour créer les composants
        super();
        this.binder = new BeanValidationBinder<>(MouvementComptaDetails.class);
        this.configureComponents(); 
    }

    public static EditerEcritureUniverselleDetailsDialog getInstance() {
        try 
        {
            if (VaadinSession.getCurrent().getAttribute(EditerEcritureUniverselleDetailsDialog.class) ==  null) {
                //Register an instance - We use this registre as a CACHE, i.e we store it only once
                VaadinSession.getCurrent().setAttribute(EditerEcritureUniverselleDetailsDialog.class, new EditerEcritureUniverselleDetailsDialog());
            }
            return (EditerEcritureUniverselleDetailsDialog)(VaadinSession.getCurrent().getAttribute(EditerEcritureUniverselleDetailsDialog.class));
        } 
        catch (Exception e) 
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.getInstance", e.toString());
            e.printStackTrace();
            return null;
        }
    } //public static EditerEcritureUniverselleDetailsDialog getInstance() {
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, MouvementCompta parentBean, ArrayList<MouvementComptaDetails> targetBeanList, EventBus.UIEventBus uiEventBus, MouvementComptaDetailsBusiness mouvementComptaDetailsBusiness, CompteBusiness compteBusiness) {
        ...
        try 
        {
            ...
            this.customSetButtonAjouterText("Ajouter une Ecriture");
            this.customSetButtonSupprimerText("Supprimer l'écriture courante");
            
            //4- Set up Target Bean - TargetBeanSet : cette instruction doit être exécutée avant l'exécution de Collections.sort(this.targetBeanList.....
            this.targetBeanList = targetBeanList;
            
            //5 - Make the this.targetBeanList sorted by NoCompte in ascending order
            Collections.sort(this.targetBeanList, Comparator.comparing(MouvementComptaDetails::getNoCompte));
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.showDialog", e.toString());
            e.printStackTrace();
        }
    }
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            */
            ...
            this.binder.forField(this.cboNoCompte)
                ...
                .bind(MouvementComptaDetails::getCompte, MouvementComptaDetails::setCompte); 
            ...
            this.binder.forField(this.txtLibelleEcriture)
                ...
                .bind(MouvementComptaDetails::getLibelleEcriture, MouvementComptaDetails::setLibelleEcriture); 
            ...
            this.binder.forField(this.txtDebit)
                ...
                .bind(MouvementComptaDetails::getDebit, MouvementComptaDetails::setDebit); 
            ...
            this.binder.forField(this.txtCredit)
                ...
                .bind(MouvementComptaDetails::getCredit, MouvementComptaDetails::setCredit); 
            
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in MouvementComptaDetails and MouvementComptaDetailsView based on their names.
            */
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.configureComponents", e.toString());
            e.printStackTrace();
        }
    }    
    ...
    private void execNoCompteAfterUpdate(Compte selectedCompte) {
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.execNoCompteAfterUpdate", e.toString());
            e.printStackTrace();
        }
    }    
    ...
    protected void workingConfigureReadOnlyField() {
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.workingConfigureReadOnlyField", e.toString());
            e.printStackTrace();
        }
    }    
    ...
    private void setComboBoxDataProvider() {
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.setComboBoxDataProvider", e.toString());
            e.printStackTrace();
        }
    }    
    ...
    private void cboNoCompte_NotInList(String strProposedVal, int intMaxFieldLength)
    {
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.cboNoCompte_NotInList", e.toString());
            e.printStackTrace();
        }
    } //private void cboNoCompte_NotInList(String strProposedVal, int intMaxFieldLength)
    ...
    private void handleCompteAddEventFromDialog(EditerCompteDialog.CompteAddEvent event) {
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.handleCompteAddEventFromDialog", e.toString());
            e.printStackTrace();
        }
    ...
    protected void workingExecuteOnCurrent() {
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.workingExecuteOnCurrent", e.toString());
            e.printStackTrace();
        }
    }
    ...
    protected void workingExecuteBeforeUpdate() {
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.workingExecuteBeforeUpdate", e.toString());
            e.printStackTrace();
        }
    }
    ...
    protected void workingExecuteBeforeAddNew() {
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.workingExecuteBeforeAddNew", e.toString());
            e.printStackTrace();
        }
    }
    ...
    protected void workingExecuteAfterAddNew() {
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.workingExecuteAfterUpdate", e.toString());
            e.printStackTrace();
        }
    }
    ...
    protected void workingDeleteItem(MouvementComptaDetails mouvementComptaDetailsItem) {
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.workingDeleteItem", e.toString());
            e.printStackTrace();
        }
    } //protected void workingDeleteItem(MouvementComptaDetails mouvementComptaDetailsItem) {
    ...
    public void publishRefreshEvent() {
        ...
        try 
        {
            //this.parentBean.setListeMouvementComptaDetails(new HashSet(this.targetBeanList));
            this.uiEventBus.publish(this, new EcritureUniverselleDetailsRefreshEvent(this.dialog, this.targetBeanList));
            //this.uiEventBus.publish(this, new EcritureUniverselleDetailsRefreshEventEvent(this.dialog));
        } 
        catch (Exception e) 
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.publishRefreshEvent", e.toString());
            e.printStackTrace();
        }
    }
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            ...
            //MouvementComptaDetailsId currentKeyValue = new MouvementComptaDetailsId(parentBean, this.txtDebit.getValue(), this.txtNoCompte.getValue());
            ...
            if (this.targetBeanList.stream()
                ...
                blnCheckOk = false;
                this.cboNoCompte.focus();
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Risque de Doublons dans champ clé principale. Veuillez en saisir un autre compte.");
            }
            else
                blnCheckOk = true;
            */
            /*
            //MouvementComptaDetailsId currentKeyValue = new MouvementComptaDetailsId(parentBean, this.txtDebit.getValue(), this.txtNoCompte.getValue());
            MouvementComptaDetailsId currentKeyValue = new MouvementComptaDetailsId();
            currentKeyValue.setNoMouvement(parentBean.getNoMouvement());
            currentKeyValue.setNoCompte(this.cboNoCompte.getValue().getNoCompte());

            if (this.targetBeanList.stream()
                    .anyMatch(p -> (p != this.currentBean) && 
                            (p.getMouvementComptaDetailsId().equals(currentKeyValue)))) {
                blnCheckOk = false;
                this.txtDebit.focus();
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Risque de Doublons dans champ clé principale. Veuillez en saisir un autre compte.");
            }
        ...
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.workingIsPrimaryKeyAndBeanExtraCheckValidated", e.toString());
            e.printStackTrace();
        }
    ...
    @Override
    public MouvementComptaDetails workingCreateNewBeanInstance()
    {
        try 
        {
            //Initialisation de valeurs par défaut
            MouvementComptaDetails mouvementComptaDetails = new MouvementComptaDetails(this.parentBean);

            return (mouvementComptaDetails);
        } 
        catch (Exception e) 
        {
            MessageDialogHelper.showAlertDialog("EditerEcritureUniverselleDetailsDialog.workingCreateNewBeanInstance", e.toString());
            e.printStackTrace();
            return (null);
        }
    }
    ...
    public static abstract class EditerEcritureUniverselleDetailsDialogEvent extends ComponentEvent<Dialog> {
        //private MouvementCompta mouvementCompta;
        private ArrayList<MouvementComptaDetails> mouvementComptaDetailsList;

        protected EditerEcritureUniverselleDetailsDialogEvent(Dialog source, ArrayList<MouvementComptaDetails> argMouvementComptaDetailsList) { 
            /* The second constructor parameter determines whether the event is triggered 
            by a DOM event in the browser 
            or through the component’s server-side API. */
            super(source, false); //Use false as the second constructor parameter to indicate that the event does not come from the client
            this.mouvementComptaDetailsList = argMouvementComptaDetailsList;
        }

        public ArrayList<MouvementComptaDetails> getMouvementComptaDetailsList() {
            return mouvementComptaDetailsList;
        }
    }

    /*
    public static class EcritureUniverselleDetailsAddEvent extends EditerEcritureUniverselleDetailsDialogEvent {
        public EcritureUniverselleDetailsAddEvent(Dialog source, EcritureUniverselle mouvementCompta) {
            super(source, mouvementCompta);
        }
    }

    public static class EcritureUniverselleDetailsUpdateEvent extends EditerEcritureUniverselleDetailsDialogEvent {
        public EcritureUniverselleDetailsUpdateEvent(Dialog source, EcritureUniverselle mouvementCompta) {
            super(source, mouvementCompta);
        }
    }
    */
    
    public static class EcritureUniverselleDetailsRefreshEvent extends EditerEcritureUniverselleDetailsDialogEvent {
        public EcritureUniverselleDetailsRefreshEvent(Dialog source, ArrayList<MouvementComptaDetails> mouvementComptaDetailsList) {
            super(source, mouvementComptaDetailsList);
        }
    }
    /* End of the API - EVENTS OUT */

    public void setParentBean(MouvementCompta parentBean) {
