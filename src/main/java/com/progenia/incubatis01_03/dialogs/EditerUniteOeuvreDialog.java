 ...
 */
public class EditerUniteOeuvreDialog extends BaseEditerReferentielMaitreFormDialog<UniteOeuvre> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in UniteOeuvre entity */
    ...
    public EditerUniteOeuvreDialog() {
        super();
        this.binder = new BeanValidationBinder<>(UniteOeuvre.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<UniteOeuvre> targetBeanList, ArrayList<UniteOeuvre> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(UniteOeuvre::getCodeUniteOeuvre));
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.binder.forField(this.txtCodeUniteOeuvre)
                ...
                .bind(UniteOeuvre::getCodeUniteOeuvre, UniteOeuvre::setCodeUniteOeuvre); 
            ...
            this.binder.forField(this.txtLibelleUniteOeuvre)
                ...
                .bind(UniteOeuvre::getLibelleUniteOeuvre, UniteOeuvre::setLibelleUniteOeuvre); 
            ...
            this.binder.forField(this.txtLibelleCourtUniteOeuvre)
                ...
                .bind(UniteOeuvre::getLibelleCourtUniteOeuvre, UniteOeuvre::setLibelleCourtUniteOeuvre); 
            
            this.binder.forField(this.chkInactif)
                .bind(UniteOeuvre::isInactif, UniteOeuvre::setInactif); 
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in UniteOeuvre and UniteOeuvreView based on their names.
            */
...
@Override
    ...
    @Override
    public UniteOeuvre workingCreateNewBeanInstance()
    {
        return (new UniteOeuvre());
    }
    ...
    public static abstract class EditerUniteOeuvreDialogEvent extends ComponentEvent<Dialog> {
        ...
        protected EditerUniteOeuvreDialogEvent(Dialog source, UniteOeuvre argUniteOeuvre) { 
    ...
    public static class UniteOeuvreAddEvent extends EditerUniteOeuvreDialogEvent {
        public UniteOeuvreAddEvent(Dialog source, UniteOeuvre uniteOeuvre) {
            super(source, uniteOeuvre);
        }
    }

    public static class UniteOeuvreUpdateEvent extends EditerUniteOeuvreDialogEvent {
        public UniteOeuvreUpdateEvent(Dialog source, UniteOeuvre uniteOeuvre) {
            super(source, uniteOeuvre);
        }
    }
