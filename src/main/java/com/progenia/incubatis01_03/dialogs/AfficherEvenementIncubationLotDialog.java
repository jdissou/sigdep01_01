...
import com.progenia.incubatis01_03.data.business.EvenementIncubationLotBusiness;
 ...
 */
public class AfficherEvenementIncubationLotDialog extends BaseAfficherTransactionDialog<EvenementIncubationLot> {
    /***
    ...
    */
    ...
    public void showDialog(String dialogTitle, EventBus.UIEventBus uiEventBus, CentreIncubateur centreIncubateurCible, EvenementIncubationLotBusiness evenementIncubationLotBusiness, ExerciceBusiness exerciceBusiness, UtilisateurBusiness utilisateurBusiness, CentreIncubateurBusiness centreIncubateurBusiness, TypeEvenementBusiness typeEvenementBusiness, CohorteBusiness cohorteBusiness, ProgrammeBusiness programmeBusiness) {
        ...
        try 
        {
            ...
            */
            ...
            this.dataProvider.setSortOrder(EvenementIncubationLot::getNoEvenement, SortDirection.DESCENDING);
    ...
    private void configureGridWithFilters() {
        ...
        try 
        {
            ...
            if (this.grid.getColumnByKey("Exercice") == null) {
                ...
                Grid.Column<EvenementIncubationLot> noChronoColumn = this.grid.addColumn(EvenementIncubationLot::getNoChrono).setKey("NoChrono").setHeader("N° Evénement").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("150px"); // fixed column
                ...
                Grid.Column<EvenementIncubationLot> centreIncubateurColumn = this.grid.addColumn(new ComponentRenderer<>(
                            evenementIncubationLot -> {
                                //ComboBox comboBox = new ComboBox();
                ...
                Grid.Column<EvenementIncubationLot> coutColumn = this.grid.addColumn(new NumberRenderer<>(EvenementIncubationLot::getCout, NumberFormat.getIntegerInstance(Locale.FRENCH))).setKey("Cout").setHeader("Coût").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("250px"); // fixed column
                Grid.Column<EvenementIncubationLot> nombreHeureColumn = this.grid.addColumn(new NumberRenderer<>(EvenementIncubationLot::getNombreHeure, NumberFormat.getIntegerInstance(Locale.FRENCH))).setKey("NombreHeure").setHeader("Nombre d'Heure").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("250px"); // fixed column
    ...
    @Override
    public void publishLoadEvent(EvenementIncubationLot selectedItem) {
        //Publish Load Event
        try 
        {
    ...
    public static abstract class AfficherEvenementIncubationLotDialogEvent extends ComponentEvent<Dialog> {
        ...
        protected AfficherEvenementIncubationLotDialogEvent(Dialog source, EvenementIncubationLot argEvenementIncubationLot) { 
        ...
        public EvenementIncubationLot getEvenementIncubationLot() {
    ...
    public static class EvenementIncubationLotLoadEvent extends AfficherEvenementIncubationLotDialogEvent {
        public EvenementIncubationLotLoadEvent(Dialog source, EvenementIncubationLot evenementIncubationLot) {
