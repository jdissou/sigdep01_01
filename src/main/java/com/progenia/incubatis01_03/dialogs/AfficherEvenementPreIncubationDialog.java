 ...
 */
public class AfficherEvenementPreIncubationDialog extends BaseAfficherTransactionDialog<EvenementPreIncubation> {
    /***
    ...
    */
    ...
    public void showDialog(String dialogTitle, EventBus.UIEventBus uiEventBus, CentreIncubateur centreIncubateurCible, EvenementPreIncubationBusiness evenementPreIncubationBusiness, ExerciceBusiness exerciceBusiness, UtilisateurBusiness utilisateurBusiness, CentreIncubateurBusiness centreIncubateurBusiness, TypeEvenementBusiness typeEvenementBusiness, ProgrammeBusiness programmeBusiness) {
        ...
        try 
        {
            ...
            */
            ...
            this.dataProvider.setSortOrder(EvenementPreIncubation::getNoEvenement, SortDirection.DESCENDING);
    ...
    private void configureGridWithFilters() {
        ...
        try 
        {
            ...
            if (this.grid.getColumnByKey("Exercice") == null) {
                ...
                Grid.Column<EvenementPreIncubation> noChronoColumn = this.grid.addColumn(EvenementPreIncubation::getNoChrono).setKey("NoChrono").setHeader("N° Evénement").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("150px"); // fixed column
                ...
                Grid.Column<EvenementPreIncubation> centreIncubateurColumn = this.grid.addColumn(new ComponentRenderer<>(
                            evenementPreIncubation -> {
                                //ComboBox comboBox = new ComboBox();
                ...
                Grid.Column<EvenementPreIncubation> coutColumn = this.grid.addColumn(new NumberRenderer<>(EvenementPreIncubation::getCout, NumberFormat.getIntegerInstance(Locale.FRENCH))).setKey("Cout").setHeader("Coût").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("250px"); // fixed column
                Grid.Column<EvenementPreIncubation> nombreHeureColumn = this.grid.addColumn(new NumberRenderer<>(EvenementPreIncubation::getNombreHeure, NumberFormat.getIntegerInstance(Locale.FRENCH))).setKey("NombreHeure").setHeader("Nombre d'Heure").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("250px"); // fixed column
    ...
    @Override
    public void publishLoadEvent(EvenementPreIncubation selectedItem) {
        //Publish Load Event
        try 
        {
    ...
    public static abstract class AfficherEvenementPreIncubationDialogEvent extends ComponentEvent<Dialog> {
        private EvenementPreIncubation evenementPreIncubation;

        protected AfficherEvenementPreIncubationDialogEvent(Dialog source, EvenementPreIncubation argEvenementPreIncubation) { 
        ...
        public EvenementPreIncubation getEvenementPreIncubation() {
    ...
    public static class EvenementPreIncubationLoadEvent extends AfficherEvenementPreIncubationDialogEvent {
        public EvenementPreIncubationLoadEvent(Dialog source, EvenementPreIncubation evenementPreIncubation) {
