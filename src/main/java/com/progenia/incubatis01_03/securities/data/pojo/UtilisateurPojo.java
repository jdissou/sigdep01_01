 ...
 */
package com.progenia.incubatis01_03.securities.data.pojo;
...
/* CodeUtilisateur, Login, CodeSecret, LibelleUtilisateur, InitialesUtilisateur, CodeCategorieUtilisateur, DateExpirationCodeSecret, Inactif, LibelleCategorieUtilisateur */
@SqlResultSetMapping(name = "UtilisateurPojo", 
        classes = @ConstructorResult(targetClass = UtilisateurPojo.class, 
                /* 
                CodeUtilisateur, Login, LibelleUtilisateur, InitialesUtilisateur, 
                CodeCategorieUtilisateur, DateExpirationCodeSecret, LibelleCategorieUtilisateur
                */
                columns = { 
                    @ColumnResult(name = "codeUtilisateur", type = String.class), 
                    @ColumnResult(name = "login", type = String.class), 
                    @ColumnResult(name = "libelleUtilisateur", type = String.class), 
                    @ColumnResult(name = "initialesUtilisateur", type = String.class), 
                    @ColumnResult(name = "codeCategorieUtilisateur", type = String.class), 
                    @ColumnResult(name = "libelleCategorieUtilisateur", type = String.class) 
}))


/*
In this class, I’ve created a mapping with the name “UtilisateurPojo” 
and specified the UtilisateurPojo.class class as the targetClass in the ConstructorResult annotation.
...
public class UtilisateurPojo {
    ...
    private String codeCategorieUtilisateur;
    private String libelleCategorieUtilisateur;
