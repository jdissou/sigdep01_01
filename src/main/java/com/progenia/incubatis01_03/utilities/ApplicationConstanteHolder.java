...
public class ApplicationConstanteHolder {
    ...
    //CONSTANTES DIVERS
    final static String REPORT_RELATIVE_PATH = "./src/main/resources/reports/";
    final static String REPORT_RESOURCES_PATH = "/reports/";
    final static String REPORT_COMPONENT = "ReportComponent";
    final static String REPORT_STREAM_RESOURCE = "ReportStreamResource";
    
    //CONSTANTES CLES du dictionnaire (MAP) de passage de paramètres de formulaire Editer
    final static String VIEW_TITLE = "ViewTitle";
    final static String MODE_FORMULAIRE_EDITER = "ModeFormulaireEditer";
    final static String BEANS_TARGET_LIST = "BeansTargetSet";
    final static String BEANS_REFRENCE_LIST = "BeansArrayList";
    final static String CALLER_COMPONENT = "CallerComponent";
    final static String BEANS_KEY_VALUE1 = "BeansKeyValue1";
    final static String BEANS_KEY_VALUE2 = "BeansKeyValue2";
    final static String BEANS_KEY_VALUE3 = "BeansKeyValue3";
