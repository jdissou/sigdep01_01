...
import com.progenia.incubatis01_03.dialogs.AfficherEvenementPreIncubationDialog;
import com.progenia.incubatis01_03.dialogs.AfficherEvenementPreIncubationDialog.EvenementPreIncubationLoadEvent;
...
import com.progenia.incubatis01_03.views.base.SaisieTransactionSimpleBase;
...
public class EvenementPreIncubationView extends SaisieTransactionSimpleBase<EvenementPreIncubation> {
    /*
    ...
    */
    ...
    final static String PAGE_TITLE = "Saisie des Evénements de Pré-Incubation";
    
    /* Defines a new FormLayout. */
    private FormLayout formLayout = new FormLayout();
    
    /* Fields to edit properties in EvenementPreIncubation entity */
    ...
    */
    ...
    private void initialize() {
        try 
        {
            ...
            this.reportTitle = "Evénement de Pré-Incubation";
            ...
            //4 - Setup the Binder
            this.binder = new BeanValidationBinder<>(EvenementPreIncubation.class);
        ...
        try 
        {
            ...
            */
            ...
            this.binder.forField(this.cboNoExercice)
                ...
                .bind(EvenementPreIncubation::getExercice, EvenementPreIncubation::setExercice); 
            ...
            this.binder.forField(this.cboCodeUtilisateur)
                ...
                .bind(EvenementPreIncubation::getUtilisateur, EvenementPreIncubation::setUtilisateur); 
            ...
            this.binder.forField(this.txtNoChrono)
                ...
                .bind(EvenementPreIncubation::getNoChrono, EvenementPreIncubation::setNoChrono); 
            ...
            this.binder.forField(this.datDateEvenement)
                ...
                .bind(EvenementPreIncubation::getDateEvenement, EvenementPreIncubation::setDateEvenement); 
            ...
            this.binder.forField(this.cboCodeCentreIncubateur)
                ...
                .bind(EvenementPreIncubation::getCentreIncubateur, EvenementPreIncubation::setCentreIncubateur); 
            ...
            this.binder.forField(this.cboCodeTypeEvenement)
                ...
                .bind(EvenementPreIncubation::getTypeEvenement, EvenementPreIncubation::setTypeEvenement); 
            ...
            this.binder.forField(this.cboCodeProgramme)
                ...
                .bind(EvenementPreIncubation::getProgramme, EvenementPreIncubation::setProgramme); 
            ...
            this.binder.forField(this.txtLibelleEvenement)
                ...
                .bind(EvenementPreIncubation::getLibelleEvenement, EvenementPreIncubation::setLibelleEvenement); 
            
            Label lblNombreParticipantValidationStatus = new Label();
            this.binder.forField(this.txtNombreParticipant)
                //Généralement pas de asRequired pour les nombres afin de permettre la saisie de zéro - .asRequired("La Saisie du Nombre de Participant est Obligatoire. Veuillez saisir le Nombre de Participant.")
                ...
                .bind(EvenementPreIncubation::getNombreParticipant, EvenementPreIncubation::setNombreParticipant); 
            ...
            this.binder.forField(this.txtCout)
                ...
                .bind(EvenementPreIncubation::getCout, EvenementPreIncubation::setCout); 
            ...
            this.binder.forField(this.txtNombreHeure)
                ...
                .bind(EvenementPreIncubation::getNombreHeure, EvenementPreIncubation::setNombreHeure); 
            ...
            this.binder.forField(this.txtNoPiece)
                ...
                .bind(EvenementPreIncubation::getNoPiece, EvenementPreIncubation::setNoPiece); 
            ...
            this.binder.forField(this.txtObservations)
                ...
                .bind(EvenementPreIncubation::getObservations, EvenementPreIncubation::setObservations); 

            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in Partenaire and EvenementPreIncubationView based on their names.
            */
    ...
    protected void workingSetFieldsInitValues() {
        try 
        {
            if (this.currentBean != null) {
                ...
                //Eviter d'exécuiter cete instruction pour éviter de créer des traansactions vides - this.currentBean = this.evenementPreIncubationBusiness.save(this.currentBean);
    ...
    private void setupDataprovider()
    {
        try 
        {
            ...
            */
            ...
            this.dataProvider.setSortOrder(EvenementPreIncubation::getNoChrono, SortDirection.ASCENDING);
    ...
    @Override
    public EvenementPreIncubation workingCreateNewBeanInstance()
    {
        return (new EvenementPreIncubation());
    }
    ...
    protected void workingExecuteValider() {
        ...
        try 
        {
            ...
            if (this.datDateEvenement.getValue() == null) {
                ...
                MessageDialogHelper.showWarningDialog("Validation de la Saisie de Transaction", "La saisie du Nombre de Participant de valeur positive est Obligatoire. Veuillez saisir la Durée (en heure) de valeur positive.");
            }
            ...
            else if (!this.binder.writeBeanIfValid(this.currentBean)) //Blindage - Vérifier toutes les exigences liées au Binding
            {
                ...
                ComponentEventListener<ClickEvent<Button>> noClickListener = ev -> {
                    ...
                    MessageDialogHelper.showWarningDialog("Validation de la Saisie de Transaction", "La Validation de la Saisie de l'Evénement de Pré-Incubation courant a été abandonnée.");
                    //Cancel - Il ne vaut pas la peine d'appeler clear ou setValue (null) sur le composant (ce qui revient au même). Le ComboBox a déjà une valeur nulle
                };
                ...
                ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                    ...
                    try 
                    {
                        //1 - Mise à jour du Compteur NoEvenementPreIncubation Exercice
                        ...
                        MessageDialogHelper.showInformationDialog("Validation de la Saisie de Transaction", "La Validation de la Saisie de l'Evénement de Pré-Incubation courant a été exécutée avec succès.");
                ...
                // Affiche une boîte de confirmation demandant si l'utilisateur désire valider la Saisie de l'Evénement de Pré-Incubation courant.
                MessageDialogHelper.showYesNoDialog("Validation de la Saisie de Transaction", "Désirez-vous valider la Saisie de l'Evénement de Pré-Incubation courant?. Cliquez sur Oui pour confirmer la validation.", yesClickListener, noClickListener);
            } //if (this.exerciceCourant != null) {
        } 
        catch (Exception e) 
        {
