...
import com.progenia.incubatis01_03.data.business.PrestationDemandeDetailsBusiness;
...
import com.progenia.incubatis01_03.dialogs.AfficherPrestationDemandeDialog;
import com.progenia.incubatis01_03.dialogs.AfficherPrestationDemandeDialog.PrestationDemandeLoadEvent;
import com.progenia.incubatis01_03.dialogs.EditerPrestationDemandeDetailsDialog;
...
public class PrestationDemandeView extends SaisieTransactionMaitreDetailsBase<PrestationDemande, PrestationDemandeDetails> {
    ...
    */
    ...
    private ArrayList<ServiceFourniParametrage> serviceFourniParametrageList = new ArrayList<ServiceFourniParametrage>();
    
    //Paramètres de Personnalisation ProGenia
    final static String PAGE_TITLE = "Saisie des Prestations de Service Ponctuel";
    ...
    */
    ...
    private void setGridBeanList() {
        try 
        {
            ...
            //Abandonnée, car crée une erreur - this.detailsDataProvider.setSortOrder(PrestationDemandeDetails::getNoPorteur, SortDirection.ASCENDING);
        ...
        try 
        {
            ...
            */
            ...
            this.binder.forField(this.cboNoPorteur)
                ...
                .bind(PrestationDemande::getPorteur, PrestationDemande::setPorteur); 
            ...
            //bindInstanceFields matches fields in Partenaire and PrestationDemandeView based on their names.
            */
    ...
    private void performInitialiser() {
        try 
        {
            ...
            for(ServiceFourniParametrage serviceFourniParametrage:this.serviceFourniParametrageList) {
    ...
    */
    ...
    private void cboNoPorteur_NotInList(String strProposedVal, int intMaxFieldLength)
    {
        ...
        {
            MessageDialogHelper.showAlertDialog("PrestationDemandeView.cboNoPorteur_NotInList", e.toString());
            e.printStackTrace();
        }
        */
    } //private void cboNoPorteur_NotInList(String strProposedVal, int intMaxFieldLength)
    ...
    private void handlePorteurAddEventFromDialog(PorteurAddEvent event) {
        ...
        {
            MessageDialogHelper.showAlertDialog("PrestationDemandeView.handlePorteurAddEventFromDialog", e.toString());
            e.printStackTrace();
        }
    } //private void handlePorteurAddEventFromDialog(PorteurAddEvent event) {
    */
