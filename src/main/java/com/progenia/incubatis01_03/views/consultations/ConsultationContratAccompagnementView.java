...
public class ConsultationContratAccompagnementView extends ConsultationSimpleBase<ContratAccompagnement> {
    /*
    ...
    */
    ...
    private ArrayList<ContratAccompagnementDetails> contratAccompagnementDetailsList = new ArrayList<ContratAccompagnementDetails>();
    ...
    final static String PAGE_TITLE = "Consultation des Contrats de Service Réccurent par Porteur de Projet";
    ...
    */
    ...
    private void initialize() {
        try 
        {
            ...
            this.reportTitle = "Contrat de Service Réccurent par Porteur de Projet";
    ...
    private void setupDataprovider()
    {
        try 
        {
            ...
            */
            ...
            this.dataProvider.setSortOrder(ContratAccompagnement::getNoChrono, SortDirection.DESCENDING);
        } 
        catch (Exception e) 
        {
    ...
    private void configureGridWithFilters() {
        ...
        try 
        {
            ...
            Grid.Column<ContratAccompagnement> noChronoColumn = this.grid.addColumn(ContratAccompagnement::getNoChrono).setKey("NoChrono").setHeader("N° Contrat").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("125px"); // fixed column
        ...
        try 
        {
            ...
            this.dataProvider.setFilter(item -> {
                ...
                */
                ...
                return isExerciceFilterMatch && isUtilisateurFilterMatch && isNoChronoFilterMatch && isDateContratFilterMatch && isPorteurFilterMatch && isDateDebutContratFilterMatch && isDateFinContratFilterMatch && isLibelleContratFilterMatch && isNoPieceFilterMatch && isObservationsFilterMatch;
            });
    ...
    private Boolean isTransactionCancelable(ContratAccompagnement contratAccompagnementItem) {
        try 
        {
            //return (true);
    ...
    @Override
    protected void workingProcedAnnulerTransactionItem(ContratAccompagnement contratAccompagnementItem) {
        try 
        {
            if (this.isTransactionCancelable(contratAccompagnementItem) == true) {
                //1 - Mise à jour de SaisieValidée dans ContratAccompagnement
                ...
                for(ContratAccompagnementDetails contratAccompagnementDetails:this.contratAccompagnementDetailsList) {
    ...
    @Override
    protected Long workingGetCurrentNoTransaction(ContratAccompagnement contratAccompagnementItem) {
        try 
        {
