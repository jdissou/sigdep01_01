 ...
 */
package com.progenia.immaria01_01.views.traitements;

import com.progenia.immaria01_01.data.business.CentreIncubateurBusiness;
import com.progenia.immaria01_01.data.business.CentreIncubateurExerciceBusiness;
...
public class LettrageManuelView extends FichierMajListeBase<MouvementComptaDetails> {
    ...
    */
    ...
    final static String PAGE_TITLE = "Lettrage Manuel des Ecritures";
    ...
    */
    ...
    private void initialize() {
        try 
        {
            ...
            this.customSetButtonOptionnel02Text("Délettrer les Ecritures");
        ...
        try 
        {
            ...
            this.isLettreeColumn = this.grid.addColumn(new ComponentRenderer<>(
                        porteur -> {
                            ...
                            checkbox.setValue(porteur.isLettree());                            
                            checkbox.setReadOnly(true);
                            return checkbox;
                        }
                    )
            ).setKey("isLettree").setHeader("Lettrée").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("125px");
            ...
            */
            ...
            this.isLettreeFilterCombo.setItems("Lettrée", "Non Lettrée");
            ...
            this.dataProvider.setFilter(item -> {
                ...
                */
                ...
                if(this.isLettreeFilterCombo.getValue() != null){
                    isLettreeFilterMatch = item.isLettree() == (this.isLettreeFilterCombo.getValue().equals("Lettrée"));
                }
    ...
    private void execLettrage(Boolean isLettree) {
        try 
        {
            ...
            {
                MessageDialogHelper.showWarningDialog("Lettrage des Ecritures", "Aucune Ecriture n'est sélectionnée. Veuillez d'abord sélectionner une écriture comptable dans le tableau.");
            }
            else
            {
                ...
                ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                    ...
                    MessageDialogHelper.showInformationDialog("Lettrage des Ecritures", "Le Lettrage des Ecritures Comptables a été exécutée avec succès.");
                ...
                MessageDialogHelper.showYesNoDialog("Lettrage des Ecritures", "Désirez-vous lettrer/délettrer les Ecritures Comptables Sélectionnées?. Cliquez sur Oui pour lettrer/délettrer ces écritures comptables.", yesClickListener, noClickListener);
            }
        } 
        catch (Exception e) 
        {
