...
import com.progenia.immaria01_01.data.business.StandingBusiness;
...
import com.progenia.immaria01_01.dialogs.EditerStandingDialog;
import com.progenia.immaria01_01.dialogs.EditerStandingDialog.StandingAddEvent;
import com.progenia.immaria01_01.dialogs.EditerStandingDialog.StandingRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerStandingDialog.StandingUpdateEvent;
...
import com.progenia.immaria01_01.dialogs.EditerTypeImmeubleDialog;
import com.progenia.immaria01_01.dialogs.EditerTypeImmeubleDialog.TypeImmeubleAddEvent;
import com.progenia.immaria01_01.dialogs.EditerTypeImmeubleDialog.TypeImmeubleRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerTypeImmeubleDialog.TypeImmeubleUpdateEvent;
import com.progenia.immaria01_01.dialogs.EditerLocalisationDialog;
import com.progenia.immaria01_01.dialogs.EditerLocalisationDialog.LocalisationAddEvent;
import com.progenia.immaria01_01.dialogs.EditerLocalisationDialog.LocalisationRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerLocalisationDialog.LocalisationUpdateEvent;
...
public class ClassificationImmobiliereView extends OngletReferentielBase {
    ...
    */
    ...
    final static String PAGE_TITLE = "Classification Immobilière";
    final static String CACHED_SELECTED_TAB_INDEX = "ClassificationImmobiliereViewSelectedTab";

    //ATTRIBUTS - tab10 - Standing
    private Tab tab10StandingTab = new Tab();
    private Grid<Standing> tab10StandingGrid = new Grid<>(); //Manually defining columns

    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private StandingBusiness tab10StandingBusiness;
    private ArrayList<Standing> tab10StandingList = new ArrayList<Standing>();
    //For Lazy Loading
    //DataProvider<Standing, Void> tab10StandingDataProvider; //The second DataProvider type parameter defines how the provider can be filtered. In the example, the filter type is Void
    //For ListDataProvider for Advanced In-memory Data Handling
    private ListDataProvider<Standing> tab10StandingDataProvider;
    ...
    //ATTRIBUTS - tab32 - Localisation
    private Tab tab32LocalisationTab = new Tab();
    private Grid<Localisation> tab32LocalisationGrid = new Grid<>(); //Manually defining columns

    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private LocalisationBusiness tab32LocalisationBusiness;
    private ArrayList<Localisation> tab32LocalisationList = new ArrayList<Localisation>();
    //For Lazy Loading
    //DataProvider<Localisation, Void> tab32LocalisationDataProvider; //The second DataProvider type parameter defines how the provider can be filtered. In the example, the filter type is Void
    //For ListDataProvider for Advanced In-memory Data Handling
    private ListDataProvider<Localisation> tab32LocalisationDataProvider;

    /* Fields to filter items in Localisation entity */
    ...
    private void tab10SetupDataprovider()
    {
        try
        {
            ...
            */
            ...
            this.tab10StandingDataProvider.setSortOrder(Standing::getCodeStanding, SortDirection.ASCENDING);
    ...
    private void tab10ConfigureGridWithFilters() {
        ...
        try
        {
            ...
            Grid.Column<Standing> codeStandingColumn = this.tab10StandingGrid.addColumn(Standing::getCodeStanding).setKey("CodeStanding").setHeader("Code Standing").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("200px"); // fixed column
            Grid.Column<Standing> libelleStandingColumn = this.tab10StandingGrid.addColumn(Standing::getLibelleStanding).setKey("LibelleStanding").setHeader("Libellé Standing").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("375px"); // fixed column
            Grid.Column<Standing> libelleCourtStandingColumn = this.tab10StandingGrid.addColumn(Standing::getLibelleCourtStanding).setKey("LibelleCourtStanding").setHeader("Libellé Abrégé").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("275px"); // fixed column
            Grid.Column<Standing> isInactifColumn = this.tab10StandingGrid.addColumn(new ComponentRenderer<>(
                            standing -> {
    ...
    private void tab32SetupDataprovider()
    {
        try
        {
            ...
            */
            ...
            this.tab32LocalisationDataProvider.setSortOrder(Localisation::getCodeLocalisation, SortDirection.ASCENDING);
    ...
    private void tab32ConfigureGridWithFilters() {
        ...
        try
        {
            ...
            //2 - Add columns to the empty table and set Data Properties to Columns - Width = 200 + 425 + 250 + 100 = 975
            Grid.Column<Localisation> codeLocalisationColumn = this.tab32LocalisationGrid.addColumn(Localisation::getCodeLocalisation).setKey("CodeLocalisation").setHeader("Code Localisation").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("200px"); // fixed column
            Grid.Column<Localisation> libelleLocalisationColumn = this.tab32LocalisationGrid.addColumn(Localisation::getLibelleLocalisation).setKey("LibelleLocalisation").setHeader("Libellé Localisation").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("375px"); // fixed column
            Grid.Column<Localisation> libelleCourtLocalisationColumn = this.tab32LocalisationGrid.addColumn(Localisation::getLibelleCourtLocalisation).setKey("LibelleCourtLocalisation").setHeader("Libellé Abrégé").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("275px"); // fixed column
            Grid.Column<Localisation> isInactifColumn = this.tab32LocalisationGrid.addColumn(new ComponentRenderer<>(
                            localisation -> {
                                Checkbox checkbox = new Checkbox();
    ...
    private void tab43ConfigureGridWithFilters() {
        ...
        try
        {
            ...
            //2 - Add columns to the empty table and set Data Properties to Columns - Width = 200 + 425 + 250 + 100 = 975
            Grid.Column<TypeImmeuble> codeTypeImmeubleColumn = this.tab43TypeImmeubleGrid.addColumn(TypeImmeuble::getCodeTypeImmeuble).setKey("CodeTypeImmeuble").setHeader("Code Type Immeuble").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("200px"); // fixed column
            Grid.Column<TypeImmeuble> libelleTypeImmeubleColumn = this.tab43TypeImmeubleGrid.addColumn(TypeImmeuble::getLibelleTypeImmeuble).setKey("LibelleTypeImmeuble").setHeader("Libellé Type Immeuble").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("375px"); // fixed column
    ...
    private void configureTabs() {
        ...
        try
        {
            ...
            this.tab43TypeImmeubleTab.setLabel("Référentiel des Types d'Immeuble");
    ...
    protected void workingHandleAjouterClick(ClickEvent event) {
        try
        {
            ...
            {
                EditerStandingDialog.getInstance().showDialog("Ajout de Standing", ModeFormulaireEditerEnum.AJOUTERLOT, new ArrayList<Standing>(), this.tab10StandingList, "", this.uiEventBus);
            }
            ...
            {
                EditerLocalisationDialog.getInstance().showDialog("Ajout de Localisation", ModeFormulaireEditerEnum.AJOUTERLOT, new ArrayList<Localisation>(), this.tab32LocalisationList, "", this.uiEventBus);
            }
            else if (this.selectedTab == this.tab43TypeImmeubleTab)
            {
                EditerTypeImmeubleDialog.getInstance().showDialog("Ajout de Type Immeuble", ModeFormulaireEditerEnum.AJOUTERLOT, new ArrayList<TypeImmeuble>(), this.tab43TypeImmeubleList, "", this.uiEventBus);
            }
        }
        catch (Exception e)
        {
    ...
    protected void workingHandleModifierClick(ClickEvent event) {
        try
        {
            if (this.selectedTab == this.tab10StandingTab)
            {
                ...
                */
                Set<Standing> selected = this.tab10StandingGrid.getSelectedItems();
                ...
                else
                {
                    ...
                    EditerStandingDialog.getInstance().showDialog("Modification de Standing", ModeFormulaireEditerEnum.MODIFIER, new ArrayList<Standing>(selected), this.tab10StandingList, "", this.uiEventBus);
                }
            }
            else if (this.selectedTab == this.tab21TypeBienImmobilierTab)
            {
            ...
            else if (this.selectedTab == this.tab32LocalisationTab)
            {
                ...
                or several items in multi-selection mode.
                */
                Set<Localisation> selected = this.tab32LocalisationGrid.getSelectedItems();
                ...
                else
                {
                    ...
                    EditerLocalisationDialog.getInstance().showDialog("Modification de Localisation", ModeFormulaireEditerEnum.MODIFIER, new ArrayList<Localisation>(selected), this.tab32LocalisationList, "", this.uiEventBus);
                }
            }
            else if (this.selectedTab == this.tab43TypeImmeubleTab)
            {
                ...
                */
                ...
                else
                {
                    ...
                    EditerTypeImmeubleDialog.getInstance().showDialog("Modification de Type Immeuble", ModeFormulaireEditerEnum.MODIFIER, new ArrayList<TypeImmeuble>(selected), this.tab43TypeImmeubleList, "", this.uiEventBus);
                }
            }
        }
        catch (Exception e)
        ...
        try
        {
            if (this.selectedTab == this.tab10StandingTab)
            {
                ...
                */
                ...
                {
                    EditerStandingDialog.getInstance().showDialog("Afficher détails Standing", ModeFormulaireEditerEnum.AFFICHER, new ArrayList<Standing>(selected), this.tab10StandingList, "", this.uiEventBus);
                }
            }
            else if (this.selectedTab == this.tab21TypeBienImmobilierTab)
            {
            ...
            else if (this.selectedTab == this.tab32LocalisationTab)
            {
                ...
                */
                ...
                {
                    EditerLocalisationDialog.getInstance().showDialog("Afficher détails Localisation", ModeFormulaireEditerEnum.AFFICHER, new ArrayList<Localisation>(selected), this.tab32LocalisationList, "", this.uiEventBus);
                }
            }
            else if (this.selectedTab == this.tab43TypeImmeubleTab)
            {
                ...
                */
                ...
                {
                    EditerTypeImmeubleDialog.getInstance().showDialog("Afficher détails Type Immeuble", ModeFormulaireEditerEnum.AFFICHER, new ArrayList<TypeImmeuble>(selected), this.tab43TypeImmeubleList, "", this.uiEventBus);
                }
            }
        }
        catch (Exception e)
    ...
    private void handleStandingAddEventFromEditorDialog(StandingAddEvent event) {
        //Handle Standing Add Event received from EditorView
        try
        {
            //1 - Sauvegarder la modification dans le backend
            Standing newInstance = this.tab10StandingBusiness.save(event.getStanding());
    ...
    private void handleStandingUpdateEventFromEditorDialog(StandingUpdateEvent event) {
        //Handle Standing Udpdate Event received from EditorView
        try
        {
            //1 - Sauvegarder la modification dans le backend
            Standing updateInstance = this.tab10StandingBusiness.save(event.getStanding());
    ...
    private void handleStandingRefreshEventFromEditorDialog(StandingRefreshEvent event) {
        //Handle Standing Cloee Event received from EditorView
        try
        {
    ...
    private void handleLocalisationAddEventFromEditorDialog(LocalisationAddEvent event) {
        //Handle Localisation Add Event received from EditorView
        try
        {
            //1 - Sauvegarder la modification dans le backend
            Localisation newInstance = this.tab32LocalisationBusiness.save(event.getLocalisation());
    ...
    private void handleLocalisationUpdateEventFromEditorDialog(LocalisationUpdateEvent event) {
        //Handle Localisation Udpdate Event received from EditorView
        try
        {
            //1 - Sauvegarder la modification dans le backend
            Localisation updateInstance = this.tab32LocalisationBusiness.save(event.getLocalisation());
    ...
    private void handleLocalisationRefreshEventFromEditorDialog(LocalisationRefreshEvent event) {
        //Handle Localisation Cloee Event received from EditorView
        try
        {
            //1 - Actualiser l'affichage du grid
            ...
            if (this.selectedTab == this.tab10StandingTab)
            {
                ...
                else
                {
                    ...
                    ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                        ...
                        for(Standing standingItem : selected) {
            ...
            else if (this.selectedTab == this.tab32LocalisationTab)
            {
                ...
                else
                {
                    ...
                    ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                        //Confirmer la suppression
                        //1 - Iterate Set Using For-Each Loop
                        for(Localisation localisationItem : selected) {
    ...
    protected void workingHandleImprimerClick(ClickEvent event) {
        try
        {
            if (this.selectedTab == this.tab10StandingTab)
            {
                this.execJasperReport("Standing", "Référentiel des Standings", this.tab10StandingBusiness.getReportData());
            }
            else if (this.selectedTab == this.tab21TypeBienImmobilierTab)
            {
            ...
            {
                this.execJasperReport("Localisation", "Référentiel des Localisations", this.tab32LocalisationBusiness.getReportData());
            }
            else if (this.selectedTab == this.tab43TypeImmeubleTab)
            {
                this.execJasperReport("TypeImmeuble", "Référentiel des Types d'Immeuble", this.tab43TypeImmeubleBusiness.getReportData());
            }
        }
        catch (Exception e)
        {
