...
import com.progenia.immaria01_01.dialogs.EditerUniteOeuvreDialog;
import com.progenia.immaria01_01.dialogs.EditerUniteOeuvreDialog.UniteOeuvreAddEvent;
import com.progenia.immaria01_01.dialogs.EditerUniteOeuvreDialog.UniteOeuvreRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerUniteOeuvreDialog.UniteOeuvreUpdateEvent;
...
import com.progenia.immaria01_01.dialogs.EditerTypeEvenementDialog.TypeEvenementRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerTypeEvenementDialog.TypeEvenementUpdateEvent;
    ...
    */
    ...
    private void tab43ConfigureGridWithFilters() {
        ...
        try 
        {
            ...
            //2 - Add columns to the empty table and set Data Properties to Columns - Width = 200 + 425 + 250 + 100 = 975
            Grid.Column<UniteOeuvre> codeUniteOeuvreColumn = this.tab43UniteOeuvreGrid.addColumn(UniteOeuvre::getCodeUniteOeuvre).setKey("CodeUniteOeuvre").setHeader("Code Unité d'Oeuvre").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("200px"); // fixed column
            Grid.Column<UniteOeuvre> libelleUniteOeuvreColumn = this.tab43UniteOeuvreGrid.addColumn(UniteOeuvre::getLibelleUniteOeuvre).setKey("LibelleUniteOeuvre").setHeader("Libellé Unité d'Oeuvre").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("375px"); // fixed column
    ...
    protected void workingHandleAjouterClick(ClickEvent event) {
        try 
        {
            ...
            {
                EditerUniteOeuvreDialog.getInstance().showDialog("Ajout d'Unité d'Oeuvre", ModeFormulaireEditerEnum.AJOUTERLOT, new ArrayList<UniteOeuvre>(), this.tab43UniteOeuvreList, "", this.uiEventBus);
            }
        } 
        catch (Exception e) 
        {
            ...
            else if (this.selectedTab == this.tab43UniteOeuvreTab)
            {
                ...
                */
                ...
                else
                {
                    ...
                    EditerUniteOeuvreDialog.getInstance().showDialog("Modification d'Unité d'Oeuvre", ModeFormulaireEditerEnum.MODIFIER, new ArrayList<UniteOeuvre>(selected), this.tab43UniteOeuvreList, "", this.uiEventBus);
                }
            }
        } 
        catch (Exception e) 
        ...
        try 
        {
            ...
            else if (this.selectedTab == this.tab43UniteOeuvreTab)
            {
                ...
                */
                ...
                {
                    EditerUniteOeuvreDialog.getInstance().showDialog("Afficher détails Unité d'Oeuvre", ModeFormulaireEditerEnum.AFFICHER, new ArrayList<UniteOeuvre>(selected), this.tab43UniteOeuvreList, "", this.uiEventBus);
                }
            }
        } 
        catch (Exception e) 
    ...
    protected void workingHandleImprimerClick(ClickEvent event) {
        try 
        {
            ...
            {
                this.execJasperReport("UniteOeuvre", "Référentiel des Unités d'Oeuvre", this.tab43UniteOeuvreBusiness.getReportData());
            }
        } 
        catch (Exception e) 
        {
