...
import com.progenia.immaria01_01.dialogs.EditerProprietaireDialog;
import com.progenia.immaria01_01.dialogs.EditerProprietaireDialog.ProprietaireAddEvent;
import com.progenia.immaria01_01.dialogs.EditerProprietaireDialog.ProprietaireRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerProprietaireDialog.ProprietaireUpdateEvent;
import com.progenia.immaria01_01.dialogs.EditerLocataireDialog;
import com.progenia.immaria01_01.dialogs.EditerCompteDialog;
import com.progenia.immaria01_01.dialogs.EditerCompteDialog.CompteAddEvent;
import com.progenia.immaria01_01.dialogs.EditerCompteDialog.CompteRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerCompteDialog.CompteUpdateEvent;
import com.progenia.immaria01_01.dialogs.EditerJournalDialog;
import com.progenia.immaria01_01.dialogs.EditerJournalDialog.JournalAddEvent;
import com.progenia.immaria01_01.dialogs.EditerJournalDialog.JournalRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerJournalDialog.JournalUpdateEvent;
import com.progenia.immaria01_01.dialogs.EditerLocataireDialog.LocataireAddEvent;
import com.progenia.immaria01_01.dialogs.EditerLocataireDialog.LocataireRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerLocataireDialog.LocataireUpdateEvent;
import com.progenia.immaria01_01.dialogs.EditerGestionnaireDialog;
import com.progenia.immaria01_01.dialogs.EditerGestionnaireDialog.GestionnaireAddEvent;
import com.progenia.immaria01_01.dialogs.EditerGestionnaireDialog.GestionnaireRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerGestionnaireDialog.GestionnaireUpdateEvent;
...
public class CorpusPartiePrenanteView extends OngletReferentielBase {
    ...
    */
    ...
    final static String PAGE_TITLE = "Corpus des Parties Prenantes";
    final static String CACHED_SELECTED_TAB_INDEX = "CorpusPartiePrenanteViewSelectedTab";

    //ATTRIBUTS - tab12 - Locataire
    private Tab tab12LocataireTab = new Tab();
    private Grid<Locataire> tab12LocataireGrid = new Grid<>(); //Manually defining columns

    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private LocataireBusiness tab12LocataireBusiness;
    private ArrayList<Locataire> tab12LocataireList = new ArrayList<Locataire>();
    //For Lazy Loading
    //DataProvider<Locataire, Void> tab12LocataireDataProvider; //The second DataProvider type parameter defines how the provider can be filtered. In the example, the filter type is Void
    //For ListDataProvider for Advanced In-memory Data Handling
    private ListDataProvider<Locataire> tab12LocataireDataProvider;

    //CIF
    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private CategorieLocataireBusiness tab12CategorieLocataireBusiness;
    private ArrayList<CategorieLocataire> tab12CategorieLocataireList = new ArrayList<CategorieLocataire>();
    private ListDataProvider<CategorieLocataire> tab12CategorieLocataireDataProvider;
    ...
    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private NationaliteBusiness tab12NationaliteBusiness;
    private ArrayList<Nationalite> tab12NationaliteList = new ArrayList<Nationalite>();
    private ListDataProvider<Nationalite> tab12NationaliteDataProvider;
    ...
    /* Fields to filter items in Locataire entity */
    ...
    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private ProprietaireBusiness tab23ProprietaireBusiness;
    ...
    private ArrayList<Journal> tab23JournalList = new ArrayList<Journal>();
    private ListDataProvider<Journal> tab23JournalDataProvider;
    ...
    //ATTRIBUTS - tab45 - Gestionnaire
    private Tab tab45GestionnaireTab = new Tab();
    private Grid<Gestionnaire> tab45GestionnaireGrid = new Grid<>(); //Manually defining columns

    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private GestionnaireBusiness tab45GestionnaireBusiness;
    private ArrayList<Gestionnaire> tab45GestionnaireList = new ArrayList<Gestionnaire>();
    //For Lazy Loading
    //DataProvider<Gestionnaire, Void> tab45GestionnaireDataProvider; //The second DataProvider type parameter defines how the provider can be filtered. In the example, the filter type is Void
    //For ListDataProvider for Advanced In-memory Data Handling
    private ListDataProvider<Gestionnaire> tab45GestionnaireDataProvider;

    /* Fields to filter items in Gestionnaire entity */
    ...
    */
    ...
    private void tab12SetupDataprovider()
    {
        try
        {
            ...
            */
            ...
            this.tab12CategorieLocataireDataProvider.setSortOrder(CategorieLocataire::getLibelleCategorieLocataire, SortDirection.ASCENDING);
            ...
            this.tab12NationaliteDataProvider.setSortOrder(Nationalite::getLibelleNationalite, SortDirection.ASCENDING);
            ...
            this.tab12LocataireDataProvider.setSortOrder(Locataire::getCodeLocataire, SortDirection.ASCENDING);
    ...
    private void tab23SetupDataprovider()
    {
        try
        {
            ...
            */
            ...
            this.tab23JournalDataProvider.setSortOrder(Journal::getCodeJournal, SortDirection.ASCENDING);
    ...
    private void tab45SetupDataprovider()
    {
        try
        {
            ...
            */
            ...
            this.tab45GestionnaireDataProvider.setSortOrder(Gestionnaire::getCodeGestionnaire, SortDirection.ASCENDING);
    ...
    private void tab12ConfigureGridWithFilters() {
        ...
        try
        {
            ...
            Grid.Column<Locataire> codeLocataireColumn = this.tab12LocataireGrid.addColumn(Locataire::getCodeLocataire).setKey("CodeLocataire").setHeader("Code Locataire").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("175px"); // fixed column
            Grid.Column<Locataire> libelleLocataireColumn = this.tab12LocataireGrid.addColumn(Locataire::getLibelleLocataire).setKey("LibelleLocataire").setHeader("Dénomination Locataire").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("375px"); // fixed column
            Grid.Column<Locataire> lieuNaissanceColumn = this.tab12LocataireGrid.addColumn(Locataire::getLieuNaissance).setKey("LieuNaissance").setHeader("Lieu de Naissance").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("250px"); // fixed column

            Grid.Column<Locataire> adresseColumn = this.tab12LocataireGrid.addColumn(Locataire::getAdresse).setKey("Adresse").setHeader("Adresse").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("200px"); // fixed column
            ...
            Grid.Column<Locataire> categorieLocataireColumn = this.tab12LocataireGrid.addColumn(new ComponentRenderer<>(
                            locataire -> {
                                ...
                                ComboBox<CategorieLocataire> comboBox = new ComboBox<>();
                                ...
                                comboBox.setItemLabelGenerator(CategorieLocataire::getLibelleCategorieLocataire);
            ...
            ).setKey("CategorieLocataire").setHeader("Catégorie Locataire").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("250px"); // fixed column

            Grid.Column<Locataire> titreCiviliteColumn = this.tab12LocataireGrid.addColumn(new ComponentRenderer<>(
                            locataire -> {
                                //ComboBox comboBox = new ComboBox();
            ...
            Grid.Column<Locataire> nationaliteColumn = this.tab12LocataireGrid.addColumn(new ComponentRenderer<>(
                            locataire -> {
                                //ComboBox comboBox = new ComboBox();
                                ComboBox<Nationalite> comboBox = new ComboBox<>();
                                ...
                                comboBox.setItemLabelGenerator(Nationalite::getLibelleNationalite);
            ...
            ).setKey("Nationalite").setHeader("Nationalité").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("250px"); // fixed column

            Grid.Column<Locataire> professionColumn = this.tab12LocataireGrid.addColumn(new ComponentRenderer<>(
                            locataire -> {
                                //ComboBox comboBox = new ComboBox();
            ...
            Grid.Column<Locataire> compteClientColumn = this.tab12LocataireGrid.addColumn(new ComponentRenderer<>(
                            locataire -> {
                                //ComboBox comboBox = new ComboBox();
            ...
            Grid.Column<Locataire> isInactifColumn = this.tab12LocataireGrid.addColumn(new ComponentRenderer<>(
                        locataire -> {
    ...
    private void tab23ConfigureGridWithFilters() {
        ...
        try
        {
            ...
            ).setKey("JournalLoyer").setHeader("Code Journal Loyer").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("150px"); // fixed column
            ...
            ).setKey("JournalDepense").setHeader("Code Journal Dépense").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("150px"); // fixed column
    ...
    protected void workingHandleAjouterClick(ClickEvent event) {
        try
        {
            ...
            {
                EditerLocataireDialog.getInstance().showDialog("Ajout de Locataire", ModeFormulaireEditerEnum.AJOUTERLOT, new ArrayList<Locataire>(), this.tab12LocataireList, "", this.uiEventBus,
            ...
            {
                EditerGestionnaireDialog.getInstance().showDialog("Ajout d'Agent Immobilier'", ModeFormulaireEditerEnum.AJOUTERLOT, new ArrayList<Gestionnaire>(), this.tab45GestionnaireList, "", this.uiEventBus);
            }
        }
        catch (Exception e)
        {
    ...
    protected void workingHandleModifierClick(ClickEvent event) {
        try
        {
            if (this.selectedTab == this.tab12LocataireTab)
            {
                ...
                */
                Set<Locataire> selected = this.tab12LocataireGrid.getSelectedItems();
                ...
                else
                {
                    ...
                    EditerLocataireDialog.getInstance().showDialog("Modification de Locataire", ModeFormulaireEditerEnum.MODIFIER, new ArrayList<Locataire>(selected), this.tab12LocataireList, "", this.uiEventBus,
                            this.tab12CategorieLocataireBusiness, this.tab12NationaliteBusiness, this.tab12ProfessionBusiness, this.tab12TitreCiviliteBusiness, this.tab12CompteBusiness);
                }
            }
            else if (this.selectedTab == this.tab23ProprietaireTab)
            ...
            else if (this.selectedTab == this.tab45GestionnaireTab)
            {
                ...
                or several items in multi-selection mode.
                */
                Set<Gestionnaire> selected = this.tab45GestionnaireGrid.getSelectedItems();
                ...
                else
                {
                    ...
                    EditerGestionnaireDialog.getInstance().showDialog("Modification d'Agent Immobilier", ModeFormulaireEditerEnum.MODIFIER, new ArrayList<Gestionnaire>(selected), this.tab45GestionnaireList, "", this.uiEventBus);
                }
            }
        }
        catch (Exception e)
        ...
        try
        {
            if (this.selectedTab == this.tab12LocataireTab)
            {
                ...
                */
                ...
                {
                    EditerLocataireDialog.getInstance().showDialog("Afficher détails Locataire", ModeFormulaireEditerEnum.AFFICHER, new ArrayList<Locataire>(selected), this.tab12LocataireList, "", this.uiEventBus, this.tab12CategorieLocataireBusiness, this.tab12NationaliteBusiness, this.tab12ProfessionBusiness, this.tab12TitreCiviliteBusiness, this.tab12CompteBusiness);
                }
            }
            else if (this.selectedTab == this.tab23ProprietaireTab)
            {
            ...
            else if (this.selectedTab == this.tab45GestionnaireTab)
            {
                ...
                */
                ...
                {
                    EditerGestionnaireDialog.getInstance().showDialog("Afficher détails Agent Immobilier", ModeFormulaireEditerEnum.AFFICHER, new ArrayList<Gestionnaire>(selected), this.tab45GestionnaireList, "", this.uiEventBus);
                }
            }
        }
        catch (Exception e) 
    ...
    private void handleLocataireAddEventFromEditorDialog(LocataireAddEvent event) {
        //Handle Locataire Add Event received from EditorView
        try 
        {
            //1 - Sauvegarder la modification dans le backend
            Locataire newInstance = this.tab12LocataireBusiness.save(event.getLocataire());
    ...
    private void handleGestionnaireAddEventFromEditorDialog(GestionnaireAddEvent event) {
        //Handle Gestionnaire Add Event received from EditorView
        try 
        {
            //1 - Sauvegarder la modification dans le backend
            Gestionnaire newInstance = this.tab45GestionnaireBusiness.save(event.getGestionnaire());
    ...
    private void handleLocataireUpdateEventFromEditorDialog(LocataireUpdateEvent event) {
        //Handle Locataire Udpdate Event received from EditorView
        try 
        {
            //1 - Sauvegarder la modification dans le backend
            Locataire updateInstance = this.tab12LocataireBusiness.save(event.getLocataire());
    ...
    private void handleGestionnaireUpdateEventFromEditorDialog(GestionnaireUpdateEvent event) {
        //Handle Gestionnaire Udpdate Event received from EditorView
        try 
        {
            //1 - Sauvegarder la modification dans le backend
            Gestionnaire updateInstance = this.tab45GestionnaireBusiness.save(event.getGestionnaire());
    ...
    private void handleLocataireRefreshEventFromEditorDialog(LocataireRefreshEvent event) {
        //Handle Locataire Cloee Event received from EditorView
        try 
        {
    ...
    private void handleGestionnaireRefreshEventFromEditorDialog(GestionnaireRefreshEvent event) {
        //Handle Gestionnaire Cloee Event received from EditorView
        try 
        {
            //1 - Actualiser l'affichage du grid
            ...
            if (this.selectedTab == this.tab12LocataireTab)
            {
                ...
                else
                {
                    ...
                    ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                        ...
                        for(Locataire locataireItem : selected) {
            ...
            else if (this.selectedTab == this.tab45GestionnaireTab)
            {
                ...
                else
                {
                    ...
                    ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                        //Confirmer la suppression
                        //1 - Iterate Set Using For-Each Loop
                        for(Gestionnaire gestionnaireItem : selected) {
    ...
    protected void workingHandleImprimerClick(ClickEvent event) {
        try 
        {
            if (this.selectedTab == this.tab12LocataireTab)
            {
                this.execJasperReport("Locataire", "Référentiel des Locataires", this.tab12LocataireBusiness.getReportData());
            }
            else if (this.selectedTab == this.tab23ProprietaireTab)
            {
            ...
            {
                this.execJasperReport("Gestionnaire", "Référentiel des Agents Immobiliers", this.tab45GestionnaireBusiness.getReportData());
            }
        }
        catch (Exception e) 
        {
