...
import com.progenia.immaria01_01.data.business.NationaliteBusiness;
import com.progenia.immaria01_01.data.business.CategorieLocataireBusiness;
import com.progenia.immaria01_01.data.business.TitreCiviliteBusiness;
import com.progenia.immaria01_01.data.business.ProfessionBusiness;
import com.progenia.immaria01_01.data.entity.*;
import com.progenia.immaria01_01.data.entity.TitreCivilite;
import com.progenia.immaria01_01.dialogs.EditerNationaliteDialog;
import com.progenia.immaria01_01.dialogs.EditerNationaliteDialog.NationaliteAddEvent;
import com.progenia.immaria01_01.dialogs.EditerNationaliteDialog.NationaliteRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerNationaliteDialog.NationaliteUpdateEvent;
import com.progenia.immaria01_01.dialogs.EditerCategorieLocataireDialog;
import com.progenia.immaria01_01.dialogs.EditerCategorieLocataireDialog.CategorieLocataireAddEvent;
import com.progenia.immaria01_01.dialogs.EditerCategorieLocataireDialog.CategorieLocataireRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerCategorieLocataireDialog.CategorieLocataireUpdateEvent;
import com.progenia.immaria01_01.dialogs.EditerTitreCiviliteDialog;
import com.progenia.immaria01_01.dialogs.EditerTitreCiviliteDialog.TitreCiviliteAddEvent;
import com.progenia.immaria01_01.dialogs.EditerTitreCiviliteDialog.TitreCiviliteRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerTitreCiviliteDialog.TitreCiviliteUpdateEvent;
import com.progenia.immaria01_01.dialogs.EditerProfessionDialog;
import com.progenia.immaria01_01.dialogs.EditerProfessionDialog.ProfessionAddEvent;
import com.progenia.immaria01_01.dialogs.EditerProfessionDialog.ProfessionRefreshEvent;
import com.progenia.immaria01_01.dialogs.EditerProfessionDialog.ProfessionUpdateEvent;
...
public class ClassificationPartiePrenanteView extends OngletReferentielBase {
    ...
    */
    ...
    final static String PAGE_TITLE = "Classification des Parties Prenantes";
    final static String CACHED_SELECTED_TAB_INDEX = "ClassificationPartiePrenanteViewSelectedTab";

    //ATTRIBUTS - tab10 - Nationalite
    private Tab tab10NationaliteTab = new Tab();
    private Grid<Nationalite> tab10NationaliteGrid = new Grid<>(); //Manually defining columns

    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private NationaliteBusiness tab10NationaliteBusiness;
    private ArrayList<Nationalite> tab10NationaliteList = new ArrayList<Nationalite>();
    //For Lazy Loading
    //DataProvider<Nationalite, Void> tab10NationaliteDataProvider; //The second DataProvider type parameter defines how the provider can be filtered. In the example, the filter type is Void
    //For ListDataProvider for Advanced In-memory Data Handling
    private ListDataProvider<Nationalite> tab10NationaliteDataProvider;
    ...
    private Grid<CategorieLocataire> tab21CategorieLocataireGrid = new Grid<>(); //Manually defining columns

    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private CategorieLocataireBusiness tab21CategorieLocataireBusiness;
    private ArrayList<CategorieLocataire> tab21CategorieLocataireList = new ArrayList<CategorieLocataire>();
    //For Lazy Loading
    //DataProvider<CategorieLocataire, Void> tab21CategorieLocataireDataProvider; //The second DataProvider type parameter defines how the provider can be filtered. In the example, the filter type is Void
    //For ListDataProvider for Advanced In-memory Data Handling
    private ListDataProvider<CategorieLocataire> tab21CategorieLocataireDataProvider;
    // @Autowired annotation provides the automatic dependency injection.
    ...
    /* Fields to filter items in CategorieLocataire entity */
    ...
    */
    ...
    private void tab10SetupDataprovider()
    {
        try
        {
            ...
            */
            ...
            this.tab10NationaliteDataProvider.setSortOrder(Nationalite::getCodeNationalite, SortDirection.ASCENDING);
    ...
    private void tab21SetupDataprovider()
    {
        try
        {
            ...
            */
            ...
            this.tab21CategorieLocataireDataProvider.setSortOrder(CategorieLocataire::getCodeCategorieLocataire, SortDirection.ASCENDING);
    ...
    private void tab21ConfigureGridWithFilters() {
        ...
        try
        {
            ...
            Grid.Column<CategorieLocataire> isInactifColumn = this.tab21CategorieLocataireGrid.addColumn(new ComponentRenderer<>(
                        iAndicateurSuivi -> {
                            Checkbox checkbox = new Checkbox();
    ...
    private void configureTabs() {
        ...
        try
        {
            ...
            this.tab21CategorieLocataireTab.setLabel("Référentiel des Catégories de Locataire");
    ...
    protected void workingHandleAjouterClick(ClickEvent event) {
        try
        {
            ...
            {
                EditerNationaliteDialog.getInstance().showDialog("Ajout de Nationalité", ModeFormulaireEditerEnum.AJOUTERLOT, new ArrayList<Nationalite>(), this.tab10NationaliteList, "", this.uiEventBus);
            }
            else if (this.selectedTab == this.tab21CategorieLocataireTab)
            {
                EditerCategorieLocataireDialog.getInstance().showDialog("Ajout de Catégorie de Locataire", ModeFormulaireEditerEnum.AJOUTERLOT, new ArrayList<CategorieLocataire>(), this.tab21CategorieLocataireList, "", this.uiEventBus, this.tab21CompteBusiness);
            }
    ...
    protected void workingHandleModifierClick(ClickEvent event) {
        try
        {
            if (this.selectedTab == this.tab10NationaliteTab)
            {
                ...
                */
                Set<Nationalite> selected = this.tab10NationaliteGrid.getSelectedItems();
                ...
                else
                {
                    ...
                    EditerNationaliteDialog.getInstance().showDialog("Modification de Nationalité", ModeFormulaireEditerEnum.MODIFIER, new ArrayList<Nationalite>(selected), this.tab10NationaliteList, "", this.uiEventBus);
                }
            }
            else if (this.selectedTab == this.tab21CategorieLocataireTab)
            {
                ...
                or several items in multi-selection mode.
                */
                Set<CategorieLocataire> selected = this.tab21CategorieLocataireGrid.getSelectedItems();
                ...
                else
                {
                    ...
                    EditerCategorieLocataireDialog.getInstance().showDialog("Modification de Catégorie de Locataire", ModeFormulaireEditerEnum.MODIFIER, new ArrayList<CategorieLocataire>(selected), this.tab21CategorieLocataireList, "", this.uiEventBus, this.tab21CompteBusiness);
                }
            }
            else if (this.selectedTab == this.tab32ProfessionTab)
            {
        ...
        try
        {
            if (this.selectedTab == this.tab10NationaliteTab)
            {
                ...
                */
                ...
                {
                    EditerNationaliteDialog.getInstance().showDialog("Afficher détails Nationalité", ModeFormulaireEditerEnum.AFFICHER, new ArrayList<Nationalite>(selected), this.tab10NationaliteList, "", this.uiEventBus);
                }
            }
            else if (this.selectedTab == this.tab21CategorieLocataireTab)
            {
                ...
                */
                ...
                {
                    EditerCategorieLocataireDialog.getInstance().showDialog("Afficher détails Catégorie de Locataire", ModeFormulaireEditerEnum.AFFICHER, new ArrayList<CategorieLocataire>(selected), this.tab21CategorieLocataireList, "", this.uiEventBus, this.tab21CompteBusiness);
                }
            }
            else if (this.selectedTab == this.tab32ProfessionTab)
            {
    ...
    private void handleNationaliteAddEventFromEditorDialog(NationaliteAddEvent event) {
        //Handle Nationalite Add Event received from EditorView
        try
        {
            //1 - Sauvegarder la modification dans le backend
            Nationalite newInstance = this.tab10NationaliteBusiness.save(event.getNationalite());
    ...
    private void handleNationaliteUpdateEventFromEditorDialog(NationaliteUpdateEvent event) {
        //Handle Nationalite Udpdate Event received from EditorView
        try
        {
            //1 - Sauvegarder la modification dans le backend
            Nationalite updateInstance = this.tab10NationaliteBusiness.save(event.getNationalite());
    ...
    private void handleNationaliteRefreshEventFromEditorDialog(NationaliteRefreshEvent event) {
        //Handle Nationalite Cloee Event received from EditorView
        try
        {
    ...
    private void handleCategorieLocataireAddEventFromEditorDialog(CategorieLocataireAddEvent event) {
        //Handle CategorieLocataire Add Event received from EditorView
        try
        {
            //1 - Sauvegarder la modification dans le backend
            CategorieLocataire newInstance = this.tab21CategorieLocataireBusiness.save(event.getCategorieLocataire());
    ...
    private void handleCategorieLocataireUpdateEventFromEditorDialog(CategorieLocataireUpdateEvent event) {
        //Handle CategorieLocataire Udpdate Event received from EditorView
        try
        {
            //1 - Sauvegarder la modification dans le backend
            CategorieLocataire updateInstance = this.tab21CategorieLocataireBusiness.save(event.getCategorieLocataire());
    ...
    private void handleCategorieLocataireRefreshEventFromEditorDialog(CategorieLocataireRefreshEvent event) {
        //Handle CategorieLocataire Cloee Event received from EditorView
        try
        {
            //1 - Actualiser l'affichage du grid
            ...
            if (this.selectedTab == this.tab10NationaliteTab)
            {
                ...
                else
                {
                    ...
                    ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                        ...
                        for(Nationalite nationaliteItem : selected) {
            ...
            else if (this.selectedTab == this.tab21CategorieLocataireTab)
            {
                ...
                else
                {
                    ...
                    ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                        //Confirmer la suppression
                        //1 - Iterate Set Using For-Each Loop
                        for(CategorieLocataire iAndicateurSuiviItem : selected) {
    ...
    protected void workingHandleImprimerClick(ClickEvent event) {
        try
        {
            if (this.selectedTab == this.tab10NationaliteTab)
            {
                this.execJasperReport("Nationalite", "Référentiel des Nationalités", this.tab10NationaliteBusiness.getReportData());
            }
            else if (this.selectedTab == this.tab21CategorieLocataireTab)
            {
                this.execJasperReport("CategorieLocataire", "Référentiel des Catégories de Locataire", this.tab21CategorieLocataireBusiness.getReportData());
            }
            else if (this.selectedTab == this.tab32ProfessionTab)
            {
