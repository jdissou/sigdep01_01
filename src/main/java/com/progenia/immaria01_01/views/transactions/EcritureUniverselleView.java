...
import com.progenia.immaria01_01.dialogs.AfficherEcritureUniverselleDialog;
import com.progenia.immaria01_01.dialogs.AfficherEcritureUniverselleDialog.MouvementComptaLoadEvent;
import com.progenia.immaria01_01.dialogs.EditerEcritureUniverselleDetailsDialog;
import com.progenia.immaria01_01.dialogs.EditerEcritureUniverselleDetailsDialog.EcritureUniverselleDetailsRefreshEvent;
...
public class EcritureUniverselleView extends SaisieTransactionMaitreDetailsBase<MouvementCompta, MouvementComptaDetails> {
    ...
    */
    ...
    final static String PAGE_TITLE = "Saisie Libre des Mouvements Comptables";
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            */
            ...
            //bindInstanceFields matches fields in Partenaire and EcritureUniverselleView based on their names.
            */
    ...
    */
    ...
    protected void workingExecuteValider() {
        ...
        try 
        {
            ...
            else if (SecurityService.getInstance().isAccessGranted("EcritureUniverselle"+(this.cboCodeValidation.getValue().getCodeValidation().equals("B")? "Brouillard" : "Journal")) == false) 
            {
