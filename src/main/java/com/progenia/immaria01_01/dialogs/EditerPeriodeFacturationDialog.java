 ...
 */
public class EditerPeriodeFacturationDialog extends BaseEditerReferentielMaitreFormDialog<PeriodeFacturation> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in PeriodeFacturation entity */
    ...
    public EditerPeriodeFacturationDialog() {
        ...
        super();
        this.binder = new BeanValidationBinder<>(PeriodeFacturation.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<PeriodeFacturation> targetBeanList, ArrayList<PeriodeFacturation> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(PeriodeFacturation::getNoPeriode));
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.binder.forField(this.txtNoPeriode)
                ...
                .bind(PeriodeFacturation::getNoPeriode, PeriodeFacturation::setNoPeriode); 
            ...
            this.binder.forField(this.txtLibellePeriode)
                ...
                .bind(PeriodeFacturation::getLibellePeriode, PeriodeFacturation::setLibellePeriode); 
            ...
            this.binder.forField(this.txtLibelleCourtPeriode)
                ...
                .bind(PeriodeFacturation::getLibelleCourtPeriode, PeriodeFacturation::setLibelleCourtPeriode); 
            
            this.binder.forField(this.chkInactif)
                .bind(PeriodeFacturation::isInactif, PeriodeFacturation::setInactif); 
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in PeriodeFacturation and PeriodeFacturationView based on their names.
            */
...
@Override
    ...
    @Override
    public PeriodeFacturation workingCreateNewBeanInstance()
    {
    ...
    public static abstract class EditerPeriodeFacturationDialogEvent extends ComponentEvent<Dialog> {
        ...
        protected EditerPeriodeFacturationDialogEvent(Dialog source, PeriodeFacturation argPeriodeFacturation) { 
    ...
    public static class PeriodeFacturationAddEvent extends EditerPeriodeFacturationDialogEvent {
        public PeriodeFacturationAddEvent(Dialog source, PeriodeFacturation periodeFacturation) {
    ...
    public static class PeriodeFacturationUpdateEvent extends EditerPeriodeFacturationDialogEvent {
        public PeriodeFacturationUpdateEvent(Dialog source, PeriodeFacturation periodeFacturation) {
            super(source, periodeFacturation);
        }
    }
