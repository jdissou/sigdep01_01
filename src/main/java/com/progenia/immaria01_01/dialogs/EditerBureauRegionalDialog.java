 ...
 */
public class EditerBureauRegionalDialog extends BaseEditerReferentielMaitreFormDialog<BureauRegional> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in BureauRegional entity */
    ...
    public EditerBureauRegionalDialog() {
        super();
        this.binder = new BeanValidationBinder<>(BureauRegional.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<BureauRegional> targetBeanList, ArrayList<BureauRegional> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(BureauRegional::getCodeBureauRegional));
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.binder.forField(this.txtCodeBureauRegional)
                ...
                .bind(BureauRegional::getCodeBureauRegional, BureauRegional::setCodeBureauRegional); 
            ...
            this.binder.forField(this.txtLibelleBureauRegional)
                ...
                .bind(BureauRegional::getLibelleBureauRegional, BureauRegional::setLibelleBureauRegional); 
            ...
            this.binder.forField(this.txtLibelleCourtBureauRegional)
                ...
                .bind(BureauRegional::getLibelleCourtBureauRegional, BureauRegional::setLibelleCourtBureauRegional); 
            ...
            this.binder.forField(this.txtCodeDescriptifBureauRegional)
                ...
                .bind(BureauRegional::getCodeDescriptifBureauRegional, BureauRegional::setCodeDescriptifBureauRegional); 
            
            this.binder.forField(this.chkInactif)
                .bind(BureauRegional::isInactif, BureauRegional::setInactif); 
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in BureauRegional and BureauRegionalView based on their names.
            */
...
@Override
    ...
    @Override
    public BureauRegional workingCreateNewBeanInstance()
    {
        return (new BureauRegional());
    }
    ...
    public static abstract class EditerBureauRegionalDialogEvent extends ComponentEvent<Dialog> {
        private BureauRegional bureauRegional;

        protected EditerBureauRegionalDialogEvent(Dialog source, BureauRegional argBureauRegional) { 
