    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.binder.forField(this.txtCodeTypeImmeuble)
                .asRequired("La Saisie du Code Type Immeuble est Obligatoire. Veuillez saisir le Code Type Immeuble.")
                .withValidator(text -> text != null && text.length() <= 2, "Code Type Immeuble ne peut contenir au plus 2 caractères")
            ...
            this.binder.forField(this.txtLibelleTypeImmeuble)
                .withValidator(text -> text.length() <= 50, "Libellé Type Immeuble ne peut contenir au plus 50 caractères.")
            ...
            this.binder.forField(this.txtLibelleCourtTypeImmeuble)
                .withValidator(text -> text.length() <= 20, "Libellé Abrégé Type Immeuble ne peut contenir au plus 20 caractères.")
            ...
            */
            ...
            //4 - Alternative
            this.formLayout.addFormItem(this.txtCodeTypeImmeuble, "Code Type Immeuble :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleTypeImmeuble, "Libellé Type Immeuble :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleCourtTypeImmeuble, "Libellé Abrégé Type Immeuble :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            if (this.referenceBeanList.stream()
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Risque de Doublons dans champ clé principale. Veuillez en saisir un autre Code Type Immeuble.");
