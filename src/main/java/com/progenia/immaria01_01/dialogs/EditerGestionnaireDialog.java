 ...
 */
public class EditerGestionnaireDialog extends BaseEditerReferentielMaitreFormDialog<Gestionnaire> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in Gestionnaire entity */
    ...
    public EditerGestionnaireDialog() {
        super();
        this.binder = new BeanValidationBinder<>(Gestionnaire.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<Gestionnaire> targetBeanList, ArrayList<Gestionnaire> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(Gestionnaire::getCodeGestionnaire));
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.binder.forField(this.txtCodeGestionnaire)
                ...
                .bind(Gestionnaire::getCodeGestionnaire, Gestionnaire::setCodeGestionnaire); 
            ...
            this.binder.forField(this.txtLibelleGestionnaire)
                ...
                .bind(Gestionnaire::getLibelleGestionnaire, Gestionnaire::setLibelleGestionnaire);
            ...
            this.binder.forField(this.txtInitialesGestionnaire)
                    ...
                    .bind(Gestionnaire::getInitialesGestionnaire, Gestionnaire::setInitialesGestionnaire);
            ...
            this.binder.forField(this.txtCodeDescriptifGestionnaire)
                    ...
                    .bind(Gestionnaire::getCodeDescriptifGestionnaire, Gestionnaire::setCodeDescriptifGestionnaire);

            this.binder.forField(this.chkInactif)
                .bind(Gestionnaire::isInactif, Gestionnaire::setInactif); 
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in Gestionnaire and GestionnaireView based on their names.
            */
...
@Override
    ...
    @Override
    public Gestionnaire workingCreateNewBeanInstance()
    {
    ...
    public static abstract class EditerGestionnaireDialogEvent extends ComponentEvent<Dialog> {
        ...
        protected EditerGestionnaireDialogEvent(Dialog source, Gestionnaire argGestionnaire) { 
    ...
    public static class GestionnaireAddEvent extends EditerGestionnaireDialogEvent {
        public GestionnaireAddEvent(Dialog source, Gestionnaire gestionnaire) {
            super(source, gestionnaire);
        }
    }

    public static class GestionnaireUpdateEvent extends EditerGestionnaireDialogEvent {
        public GestionnaireUpdateEvent(Dialog source, Gestionnaire gestionnaire) {
            super(source, gestionnaire);
        }
    }
