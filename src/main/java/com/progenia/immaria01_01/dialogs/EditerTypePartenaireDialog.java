    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.binder.forField(this.txtCodeTypePartenaire)
                .asRequired("La Saisie du Code Type Partenaire est Obligatoire. Veuillez saisir le Code Type Partenaire.")
                .withValidator(text -> text != null && text.length() <= 10, "Code Type Partenaire ne peut contenir au plus 10 caractères")
            ...
            this.binder.forField(this.txtLibelleTypePartenaire)
                .withValidator(text -> text.length() <= 50, "Libellé Type Partenaire ne peut contenir au plus 50 caractères.")
            ...
            this.binder.forField(this.txtLibelleCourtTypePartenaire)
                .withValidator(text -> text.length() <= 20, "Libellé Abrégé Type Partenaire ne peut contenir au plus 20 caractères.")
            ...
            */
            ...
            //4 - Alternative
            this.formLayout.addFormItem(this.txtCodeTypePartenaire, "Code Type Partenaire :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleTypePartenaire, "Libellé Type Partenaire :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleCourtTypePartenaire, "Libellé Abrégé Type Partenaire :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            if (this.referenceBeanList.stream()
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Risque de Doublons dans champ clé principale. Veuillez en saisir un autre Code Type Partenaire.");
