...
import com.progenia.immaria01_01.data.business.ConstanteBusiness;
...
import com.progenia.immaria01_01.systeme.data.business.SystemeModeAbattementBusiness;
import com.progenia.immaria01_01.systeme.data.business.SystemeModeArrondissementBusiness;
import com.progenia.immaria01_01.systeme.data.business.SystemeModeStockageBaseMontantBusiness;
import com.progenia.immaria01_01.systeme.data.business.SystemeModeStockageInterneExterneBusiness;
import com.progenia.immaria01_01.systeme.data.business.SystemeModeValorisationBaseBusiness;
import com.progenia.immaria01_01.systeme.data.business.SystemeModeValorisationRubriqueBusiness;
import com.progenia.immaria01_01.systeme.data.business.SystemeModeValorisationTauxBusiness;
import com.progenia.immaria01_01.systeme.data.business.SystemeTypeVariableBusiness;
import com.progenia.immaria01_01.systeme.data.business.SystemeValeurMinMaxBusiness;
import com.progenia.immaria01_01.systeme.data.entity.SystemeModeAbattement;
import com.progenia.immaria01_01.systeme.data.entity.SystemeModeArrondissement;
import com.progenia.immaria01_01.systeme.data.entity.SystemeModeStockageBaseMontant;
import com.progenia.immaria01_01.systeme.data.entity.SystemeModeStockageInterneExterne;
...
public class EditerRubriqueDialog extends BaseEditerReferentielMaitreTabGridDialog<Rubrique, RubriqueComptabilisation> {
    ...
    */
    ...
    private final static String CACHED_SELECTED_TAB_INDEX = "EditerRubriqueDialogSelectedTab";
    
    //CIF
    private SystemeModeValorisationRubriqueBusiness modeValorisationRubriqueBusiness;
    private ArrayList<SystemeModeValorisationRubrique> modeValorisationRubriqueList = new ArrayList<SystemeModeValorisationRubrique>();
    private ListDataProvider<SystemeModeValorisationRubrique> modeValorisationRubriqueDataProvider; 
    
    //CIF
    private SystemeModeValorisationBaseBusiness modeValorisationBaseBusiness;
    private ArrayList<SystemeModeValorisationBase> modeValorisationBaseList = new ArrayList<SystemeModeValorisationBase>();
    private ListDataProvider<SystemeModeValorisationBase> modeValorisationBaseDataProvider; 
    
    //CIF
    private SystemeModeValorisationTauxBusiness modeValorisationTauxBusiness;
    private ArrayList<SystemeModeValorisationTaux> modeValorisationTauxList = new ArrayList<SystemeModeValorisationTaux>();
    private ListDataProvider<SystemeModeValorisationTaux> modeValorisationTauxDataProvider; 
    ...
    private ArrayList<Constante> constanteList = new ArrayList<Constante>();
    private ListDataProvider<Constante> constanteDataProvider; 
    ...
    private ComboBox<SystemeModeValorisationRubrique> cboCodeModeValorisationRubrique = new ComboBox<>();
    private SuperDoubleField txtMontantFixe = new SuperDoubleField();
    private ComboBox<SystemeModeValorisationBase> cboCodeModeValorisationBase = new ComboBox<>();
    private SuperDoubleField txtBaseFixe = new SuperDoubleField();
    private ComboBox<SystemeModeValorisationTaux> cboCodeModeValorisationTaux = new ComboBox<>();
    ...
    private ComboBox<Constante> cboCodeConstanteRubrique = new ComboBox<>();
    private ComboBox<VariableService> cboCodeVariableBase = new ComboBox<>();
    private ComboBox<Constante> cboCodeConstanteBase = new ComboBox<>();
    private ComboBox<VariableService> cboCodeVariableTaux = new ComboBox<>();
    private ComboBox<Constante> cboCodeConstanteTaux = new ComboBox<>();
    ...
    private ComboBox<Constante> cboCodeConstanteValeurMinimum = new ComboBox<>();
    private ComboBox<Constante> cboCodeConstanteValeurMaximum = new ComboBox<>();
    ...
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<Rubrique> targetBeanList, ArrayList<Rubrique> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus, 
            SystemeModeValorisationRubriqueBusiness modeValorisationRubriqueBusiness, SystemeModeValorisationBaseBusiness modeValorisationBaseBusiness, SystemeModeValorisationTauxBusiness modeValorisationTauxBusiness, TrancheValeurBusiness  trancheValeurBusiness, VariableServiceBusiness variableServiceBusiness, ConstanteBusiness constanteBusiness, SystemeValeurMinMaxBusiness valeurMinMaxBusiness, SystemeModeAbattementBusiness modeAbattementBusiness, SystemeModeArrondissementBusiness modeArrondissementBusiness, SystemeModeStockageBaseMontantBusiness modeStockageBaseMontantBusiness, SystemeModeStockageInterneExterneBusiness modeStockageInterneExterneBusiness, 
            RubriqueComptabilisationBusiness rubriqueComptabilisationBusiness, TrancheValeurDetailsBusiness trancheValeurDetailsBusiness, SystemeTypeVariableBusiness typeVariableBusiness, UniteOeuvreBusiness uniteOeuvreBusiness, 
            TypePorteurBusiness typePorteurBusiness, CompteBusiness compteBusiness) {
        ...
        try 
        {
            ...
            this.modeValorisationRubriqueDataProvider.setSortOrder(SystemeModeValorisationRubrique::getLibelleModeValorisation, SortDirection.ASCENDING);
            ...
            this.modeValorisationBaseDataProvider.setSortOrder(SystemeModeValorisationBase::getLibelleModeValorisation, SortDirection.ASCENDING);
            ...
            this.modeValorisationTauxDataProvider.setSortOrder(SystemeModeValorisationTaux::getLibelleModeValorisation, SortDirection.ASCENDING);
            ...
            this.constanteDataProvider.setSortOrder(Constante::getLibelleConstante, SortDirection.ASCENDING);
    ...
    private void setGridBeanList() {
        try 
        {
            ...
            this.detailsDataProvider.setSortOrder(RubriqueComptabilisation::getCodeTypePorteur, SortDirection.ASCENDING);
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.cboCodeModeValorisationRubrique.setItemLabelGenerator(SystemeModeValorisationRubrique::getLibelleModeValorisation);
            ...
            this.cboCodeModeValorisationBase.setItemLabelGenerator(SystemeModeValorisationBase::getLibelleModeValorisation);
            ...
            this.cboCodeModeValorisationTaux.setItemLabelGenerator(SystemeModeValorisationTaux::getLibelleModeValorisation);
            ...
            */
            ...
            // Choose which property from Constante is the presentation value
            this.cboCodeConstanteRubrique.setItemLabelGenerator(Constante::getLibelleConstante);
            this.cboCodeConstanteRubrique.setRequired(true);
            this.cboCodeConstanteRubrique.setRequiredIndicatorVisible(true);
            //???this.cboCodeConstanteRubrique.setLabel("Constante");
            ...
            this.cboCodeConstanteRubrique.addValueChangeListener(event -> {
                if (event.getValue() != null) {
                    ...
                    if (event.getValue().isInactif() == true) {
                        MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Constante choisie est actuellement désactivée. Veuillez en saisir une autre.");
                        //Cancel
            ...
            */
            ...
            // Choose which property from Constante is the presentation value
            this.cboCodeConstanteBase.setItemLabelGenerator(Constante::getLibelleConstante);
            this.cboCodeConstanteBase.setRequired(true);
            this.cboCodeConstanteBase.setRequiredIndicatorVisible(true);
            //???this.cboCodeConstanteBase.setLabel("Constante");
            ...
            */
            ...
            // Choose which property from Constante is the presentation value
            this.cboCodeConstanteTaux.setItemLabelGenerator(Constante::getLibelleConstante);
            this.cboCodeConstanteTaux.setRequired(true);
            this.cboCodeConstanteTaux.setRequiredIndicatorVisible(true);
            //???this.cboCodeConstanteTaux.setLabel("Constante");
            ...
            */
            ...
            // Choose which property from Constante is the presentation value
            this.cboCodeConstanteValeurMinimum.setItemLabelGenerator(Constante::getLibelleConstante);
            this.cboCodeConstanteValeurMinimum.setRequired(true);
            this.cboCodeConstanteValeurMinimum.setRequiredIndicatorVisible(true);
            //???this.cboCodeConstanteValeurMinimum.setLabel("Constante");
            ...
            */
            ...
            // Choose which property from Constante is the presentation value
            this.cboCodeConstanteValeurMaximum.setItemLabelGenerator(Constante::getLibelleConstante);
            this.cboCodeConstanteValeurMaximum.setRequired(true);
            this.cboCodeConstanteValeurMaximum.setRequiredIndicatorVisible(true);
            //???this.cboCodeConstanteValeurMaximum.setLabel("Constante");
            ...
            */
            ...
            this.binder.forField(this.cboCodeConstanteRubrique)
                //.asRequired("La Saisie Constante Rubrique est requise. Veuillez sélectionner une Constante")
            ...
            this.binder.forField(this.cboCodeConstanteBase)
                //.asRequired("La Saisie Constante Base est requise. Veuillez sélectionner une Constante")
            ...
            this.binder.forField(this.cboCodeConstanteTaux)
                //.asRequired("La Saisie Constante Taux est requise. Veuillez sélectionner une Constante")
            ...
            this.binder.forField(this.cboCodeConstanteValeurMinimum)
                //.asRequired("La Saisie de la Constante Valeur Minimum est requise. Veuillez saisir la Constante Valeur Minimum")
            ...
            this.binder.forField(this.cboCodeConstanteValeurMaximum)
                //.asRequired("La Saisie de la Constante Valeur Maximum est requise. Veuillez saisir la Constante Valeur Maximum")
            ...
            */
            ...
            this.tabDefinitionFormLayout.addFormItem(this.cboCodeConstanteRubrique, "Constante Rubrique :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH200);
            ...
            this.tabDefinitionFormLayout.addFormItem(this.cboCodeConstanteBase, "Constante Base :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH200);
            ...
            this.tabDefinitionFormLayout.addFormItem(this.cboCodeConstanteTaux, "Constante Taux :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH200);
            ...
            this.tabAjustementFormLayout.addFormItem(this.cboCodeConstanteValeurMinimum, "Constante Valeur Minimum :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH200);
            this.tabAjustementFormLayout.addFormItem(this.cboCodeConstanteValeurMaximum, "Constante Valeur Maximum :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH200);
    ...
    private void myControlsManageAccordingToModeValorisation() {
        try 
        {
            ...
            else if (this.cboCodeModeValorisationRubrique.getValue().getCodeModeValorisation().equals("CONS")) //Constante
            {
                //Controls Conditionnels qui dépendent de CodeModeValorisationRubrique
                this.cboCodeModeValorisationBase.setReadOnly(true);
                this.cboCodeModeValorisationTaux.setReadOnly(true);
            ...
            else if (this.cboCodeModeValorisationRubrique.getValue().getCodeModeValorisation().equals("MTB")) //Montant Tranche Base
            {
                ...
                else if (this.cboCodeModeValorisationBase.getValue().getCodeModeValorisation().equals("CONS")) //Constante
                {
                    //Controls Conditionnels qui dépendent de CodeModeValorisationRubrique et de CodeModeValorisationBase
                    this.txtBaseFixe.setReadOnly(true);
                    this.cboCodeVariableBase.setReadOnly(true);
            ...
            else if (this.cboCodeModeValorisationRubrique.getValue().getCodeModeValorisation().equals("CALC")) //Calcul
            {
                ...
                else if (this.cboCodeModeValorisationTaux.getValue().getCodeModeValorisation().equals("CONS")) //Constante
                {
                    //Controls Conditionnels qui dépendent de CodeModeValorisationRubrique et de CodeModeValorisationTaux 
                    this.txtTauxFixe.setReadOnly(true);
                    this.cboCodeVariableTaux.setReadOnly(true);
    ...
    {
        //Ajoute une nouvelle Constante en entrant un libellé dans la zone de liste modifiable CodeConstanteRubrique.
        String strNewVal = strProposedVal;
        ...
        try 
        {
            if (SecurityService.getInstance().isAccessGranted("EditerConstanteDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> noClickListener = ev -> {
                    //Ajout non accompli
                    MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Constante Rubrique est requise. Veuillez en saisir une.");
                    //Cancel - Il ne vaut pas la peine d'appeler clear ou setValue (null) sur le composant (ce qui revient au même). Le ComboBox a déjà une valeur nulle
                };
                ...
                ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                    ...
                    EditerConstanteDialog.getInstance().showDialog("Ajout de Constante", ModeFormulaireEditerEnum.AJOUTERCIF, new ArrayList<Constante>(), this.constanteList, finalNewVal, this.uiEventBus);
                };

                // Affiche une boîte de confirmation demandant si l'utilisateur désire ajouter un nouveau Type Porteur.
                MessageDialogHelper.showYesNoDialog("La Constante '" + strNewVal + "' n'est pas dans la liste.", "Désirez-vous ajouter une nouvelle Constante?. Cliquez sur Oui pour confirmer l'ajout.", yesClickListener, noClickListener);
            }
            else {
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Constante Rubrique est requise. Veuillez en saisir une.");
            } //if (SecurityService.getInstance().isAccessGranted("EditerConstanteDialog") == true) {
    ...
    {
        //Ajoute une nouvelle Constante en entrant un libellé dans la zone de liste modifiable CodeConstanteBase.
        String strNewVal = strProposedVal;
        ...
        try 
        {
            if (SecurityService.getInstance().isAccessGranted("EditerConstanteDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> noClickListener = ev -> {
                    //Ajout non accompli
                    MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Constante Base est requise. Veuillez en saisir une.");
                    //Cancel - Il ne vaut pas la peine d'appeler clear ou setValue (null) sur le composant (ce qui revient au même). Le ComboBox a déjà une valeur nulle
                };
    ...
    {
        //Ajoute une nouvelle Constante en entrant un libellé dans la zone de liste modifiable CodeConstanteTaux.
        String strNewVal = strProposedVal;
        ...
        try 
        {
            if (SecurityService.getInstance().isAccessGranted("EditerConstanteDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> noClickListener = ev -> {
                    //Ajout non accompli
                    MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Constante Taux est requise. Veuillez en saisir une.");
                    //Cancel - Il ne vaut pas la peine d'appeler clear ou setValue (null) sur le composant (ce qui revient au même). Le ComboBox a déjà une valeur nulle
                };
    ...
    {
        //Ajoute une nouvelle Constante en entrant un libellé dans la zone de liste modifiable CodeConstanteValeurMinimum.
        String strNewVal = strProposedVal;
        ...
        try 
        {
            if (SecurityService.getInstance().isAccessGranted("EditerConstanteDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> noClickListener = ev -> {
                    //Ajout non accompli
                    MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Constante Valeur Minimum est requise. Veuillez en saisir une.");
                    //Cancel - Il ne vaut pas la peine d'appeler clear ou setValue (null) sur le composant (ce qui revient au même). Le ComboBox a déjà une valeur nulle
                };
    ...
    {
        //Ajoute une nouvelle Constante en entrant un libellé dans la zone de liste modifiable CodeConstanteValeurMaximum.
        String strNewVal = strProposedVal;
        ...
        try 
        {
            if (SecurityService.getInstance().isAccessGranted("EditerConstanteDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> noClickListener = ev -> {
                    //Ajout non accompli
                    MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Constante ValeurMaximum est requise. Veuillez en saisir une.");
                    //Cancel - Il ne vaut pas la peine d'appeler clear ou setValue (null) sur le composant (ce qui revient au même). Le ComboBox a déjà une valeur nulle
                };
    ...
    private void handleConstanteAddEventFromDialog(EditerConstanteDialog.ConstanteAddEvent event) {
        //Handle Ajouter Constante Add Event received from Dialog
        //Ajouté à cause du CIF
        try 
        {
            //1 - Sauvegarder la modification dans le backend
            Constante newInstance = this.constanteBusiness.save(event.getConstante());
    ...
    private void configureGrid() {
        ...
        try 
        {
            ...
            Grid.Column<RubriqueComptabilisation> typePorteurColumn = this.grid.addColumn(new ComponentRenderer<>(
                        rubriqueComptabilisation -> {
                            ...
                            comboBox.setValue(rubriqueComptabilisation.getTypePorteur());
    ...
    protected void workingHandleDetailsClick(ClickEvent event) {
        try 
        {
            ...
            EditerRubriqueComptabilisationDialog.getInstance().showDialog("Comptabilisation Rubrique", this.currentBean, this.detailsBeanList, this.referenceBeanDetailsList, this.uiEventBus, this.typePorteurBusiness, this.compteBusiness);
        } 
        catch (Exception e) 
        {
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            ...
            else if ((this.cboCodeModeValorisationRubrique.getValue().getCodeModeValorisation().equals("CONS")) && (this.cboCodeConstanteRubrique.getValue() == null))
            {
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Constante Rubrique est Obligatoire. Veuillez saisir la Constante de Valorisation de la Rubrique.");
            }
                    ...
                    && (this.cboCodeConstanteBase.getValue() == null))
            {
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Constante Base est Obligatoire. Veuillez saisir la Constante de Détermination de la Base.");
            }
            else if (((this.cboCodeModeValorisationRubrique.getValue().getCodeModeValorisation().equals("CALC")) || (this.cboCodeModeValorisationRubrique.getValue().getCodeModeValorisation().equals("MTB"))) 
                    ...
                    && (this.cboCodeConstanteTaux.getValue() == null))
            {
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Constante Taux est Obligatoire. Veuillez saisir la Constante de Détermination du Taux.");
            }
            else if ((this.cboCodeModeValorisationRubrique.getValue().getCodeModeValorisation().equals("CALC")) 
                    ...
                    && (this.cboCodeConstanteValeurMinimum.getValue() == null))
            {
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Constante Valeur Minimum est Obligatoire. Veuillez saisir la Constante Valeur Minimum.");
            }
            else if ((this.cboCodeValeurMaximum.getValue() != null) 
                    ...
                    && (this.cboCodeConstanteValeurMaximum.getValue() == null))
            {
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Constante Valeur Maximum est Obligatoire. Veuillez saisir la Constante Valeur Maximum.");
            }
