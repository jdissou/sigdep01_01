...
import com.progenia.immaria01_01.data.business.BureauRegionalBusiness;
import com.progenia.immaria01_01.data.entity.BureauRegional;
import com.progenia.immaria01_01.data.entity.CentreIncubateur;
import com.progenia.immaria01_01.dialogs.EditerBureauRegionalDialog.BureauRegionalAddEvent;
 ...
 */
public class EditerCentreIncubateurDialog extends BaseEditerReferentielMaitreFormDialog<CentreIncubateur> {
    /***
    ...
    */
    ...
    //CIF
    private BureauRegionalBusiness bureauRegionalBusiness;
    private ArrayList<BureauRegional> bureauRegionalList = new ArrayList<BureauRegional>();
    private ListDataProvider<BureauRegional> bureauRegionalDataProvider; 
    ...
    ComboBox<BureauRegional> cboCodeBureauRegional = new ComboBox<>();
    //ComboBox<BureauRegional> cboCodeBureauRegional = new ComboBox<>("Bureau Régional");
    ...
    public EditerCentreIncubateurDialog() {
        ...
        super();
        this.binder = new BeanValidationBinder<>(CentreIncubateur.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<CentreIncubateur> targetBeanList, ArrayList<CentreIncubateur> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus, BureauRegionalBusiness bureauRegionalBusiness) {
        ...
        try 
        {
            ...
            this.bureauRegionalDataProvider.setSortOrder(BureauRegional::getLibelleBureauRegional, SortDirection.ASCENDING);
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(CentreIncubateur::getCodeCentreIncubateur));
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.cboCodeBureauRegional.setItemLabelGenerator(BureauRegional::getLibelleBureauRegional);
            this.cboCodeBureauRegional.setRequired(true);
            this.cboCodeBureauRegional.setRequiredIndicatorVisible(true);
            //???this.cboCodeBureauRegional.setLabel("BureauRegional");
            ...
            */
            ...
            this.binder.forField(this.txtCodeCentreIncubateur)
                ...
                .bind(CentreIncubateur::getCodeCentreIncubateur, CentreIncubateur::setCodeCentreIncubateur); 
            ...
            this.binder.forField(this.txtLibelleCourtCentreIncubateur)
                ...
                .bind(CentreIncubateur::getLibelleCourtCentreIncubateur, CentreIncubateur::setLibelleCourtCentreIncubateur); 
            ...
            this.binder.forField(this.cboCodeBureauRegional)
                ...
                .bind(CentreIncubateur::getBureauRegional, CentreIncubateur::setBureauRegional); 
            
            this.binder.forField(this.chkInactif)
                .bind(CentreIncubateur::isInactif, CentreIncubateur::setInactif); 
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in CentreIncubateur and CentreIncubateurView based on their names.
            */
        ...
        try 
        {
            if (SecurityService.getInstance().isAccessGranted("EditerBureauRegionalDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                    ...
                    EditerBureauRegionalDialog.getInstance().showDialog("Ajout de Bureau Régional", ModeFormulaireEditerEnum.AJOUTERCIF, new ArrayList<BureauRegional>(), this.bureauRegionalList, finalNewVal, this.uiEventBus);
                };
    ...
    private void handleBureauRegionalAddEventFromDialog(BureauRegionalAddEvent event) {
        //Handle Ajouter BureauRegional Add Event received from Dialog
        //Ajouté à cause du CIF
        try 
        {
            //1 - Sauvegarder la modification dans le backend
            BureauRegional newInstance = this.bureauRegionalBusiness.save(event.getBureauRegional());
    ...
    @Override
    public CentreIncubateur workingCreateNewBeanInstance()
    {
        return (new CentreIncubateur());
    }
    ...
    public static abstract class EditerCentreIncubateurDialogEvent extends ComponentEvent<Dialog> {
        ...
        protected EditerCentreIncubateurDialogEvent(Dialog source, CentreIncubateur argCentreIncubateur) { 
