...
@SqlResultSetMapping(name = "ComptePojo", 
        classes = @ConstructorResult(targetClass = ComptePojo.class, 
                columns = { 
                    @ColumnResult(name = "noCompte", type = String.class),  
                    @ColumnResult(name = "libelleCompte", type = String.class),  
                    @ColumnResult(name = "regroupement", type = Boolean.class),  
                    @ColumnResult(name = "noClasse", type = String.class),  
                    @ColumnResult(name = "noSousClasse", type = String.class) 
}))
                        

/*
In this class, I’ve created a mapping with the name “ComptePojo” 
and specified the ComptePojo.class class as the targetClass in the ConstructorResult annotation.
