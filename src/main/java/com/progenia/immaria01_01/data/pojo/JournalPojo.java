...
@SqlResultSetMapping(name = "JournalPojo", 
        classes = @ConstructorResult(targetClass = JournalPojo.class, 
                columns = { 
                    @ColumnResult(name = "codeJournal", type = String.class),  
                    @ColumnResult(name = "libelleJournal", type = String.class),  
                    @ColumnResult(name = "noCompte", type = String.class),  
                    @ColumnResult(name = "referenceJournal", type = String.class) 
}))

/*
In this class, I’ve created a mapping with the name “JournalPojo” 
and specified the JournalPojo.class class as the targetClass in the ConstructorResult annotation.
