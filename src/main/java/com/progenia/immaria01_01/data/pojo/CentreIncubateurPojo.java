...
@SqlResultSetMapping(name = "CentreIncubateurPojo", 
        classes = @ConstructorResult(targetClass = CentreIncubateurPojo.class, 
                columns = { 
                    ...
                    @ColumnResult(name = "codeBureauRegional", type = String.class), 
                    @ColumnResult(name = "codeDescriptifCentreIncubateur", type = String.class), 
                    @ColumnResult(name = "libelleBureauRegional", type = String.class)
}))

/*
In this class, I’ve created a mapping with the name “CentreIncubateurPojo” 
and specified the CentreIncubateurPojo.class class as the targetClass in the ConstructorResult annotation.
...
@Entity
public class CentreIncubateurPojo {
    @Id
...
CodeCentreIncubateur, LibelleCentreIncubateur, LibelleCourtCentreIncubateur, 
			CodeBureauRegional, CodeDescriptifCentreIncubateur, 
			LibelleBureauRegional
