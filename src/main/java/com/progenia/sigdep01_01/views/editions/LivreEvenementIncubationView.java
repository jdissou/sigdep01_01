...
public class LivreEvenementIncubationView extends EditionBase {
    ...
    */
    ...
    static final String PAGE_TITLE = "Livre des Evénements d'Incubation";
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            */
            ...
            this.formLayout.addFormItem(this.cboCodeCategorieInstrumentFilter, "Catégorie Instrument :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH150);
        ...
        try 
        {
            ...
            if (this.cboCodeTypeLivre.getValue() == null) {
                ...
                else
                {
                    ...
                    this.paramSerie2 = this.paramSerie2 + "Catégorie Instrument: " + this.cboCodeCategorieInstrumentFilter.getValue().getLibelleCourtCategorieInstrument() + ". ";
                }
