...
import com.progenia.sigdep01_01.views.base.ConsultationMaitreDetailsBase;
...
public class ContrepassationView extends ConsultationMaitreDetailsBase<MouvementCompta, MouvementComptaDetails> {
    ...
    */
    ...
    static final String PAGE_TITLE = "Contrepassation des Mouvements Comptables";
    ...
    private ComboBox<ZZZJournal> cboCodeJournalFilter = new ComboBox<>();
    ...
    */
    ...
    private void initialize() {
        try 
        {
            ...
            this.customSetButtonOptionnel02Text("Contrepasser dans le ZZZJournal");
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.cboCodeJournalFilter.setItemLabelGenerator(ZZZJournal::getCodeJournal);
            ...
            this.formLayout.addFormItem(this.cboCodeJournalFilter, "Code ZZZJournal :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH150);
    ...
    protected void workingHandleButtonOptionnel02Click(ClickEvent event) {
        //Contrepasser le mouvement comptable courant au ZZZJournal
        try 
        {
            //Code Ad Hoc à exécuter pour contrepasser les mouvements comptables au ZZZJournal
            //Contrepasser les mouvements comptables sélectionnés
