...
public class ClotureExerciceView extends TraitementBase {
    ...
    */
    ...
    static final String PAGE_TITLE = "Clôture et Ouverture de Période";
    ...
    */
            if (this.cboNoExercice.getValue() == null) {
                ...
                MessageDialogHelper.showWarningDialog("Clôture et Ouverture de Période", "La saisie du Code ZZZJournal est Obligatoire. Veuillez saisir le Code ZZZJournal.");
            }
