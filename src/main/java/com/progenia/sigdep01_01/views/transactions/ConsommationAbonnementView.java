...
public class ConsommationAbonnementView extends TransactionBase<ZZZFacturationAbonnement, ZZZFacturationAbonnementConsommation> {
    ...
    */
    ...
    static final String PAGE_TITLE = "Saisie des Consommations de Service Récurrent";
    ...
    */
    ...
    private void configureGrid() {
        ...
        try 
        {
            ...
            this.libelleUniteOeuvreColumn = this.grid.addColumn(ZZZFacturationAbonnementConsommation::getLibelleUniteOeuvre).setKey("LibelleUniteOeuvre").setHeader("Unité d'Oeuvre").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("175px"); // fixed column
        ...
        try 
        {
            if ((this.cboNoExerciceFilter.getValue() != null) && (this.cboCodeCentreIncubateurFilter.getValue() != null) && (this.cboNoPeriodeFilter.getValue() != null) && (this.cboCodeSequenceFacturationFilter.getValue() != null)) {
                ...
                if (this.targetBeanList.size() == 0) {
                    ...
                    //Initialisation de la liste des Données dans ZZZFacturationAbonnementConsommation
    ...
    private void performInitialiser(ZZZFacturationAbonnement facturationAbonnement) {
        try 
        {
            ...
            //2 - Ajout des enrégistrements dans ZZZFacturationAbonnementInstrument - Iterating ArrayList using for-each loop - Traversing list through for-each loop
            for(ZZZIFacturationAbonnementInstrumentSource abonnement:this.facturationAbonnementInstrumentSourceList) {
                //A - Ajout des enrégistrements dans ZZZFacturationAbonnementInstrument
            ...
            //3 - Ajout des enrégistrements dans ZZZFacturationAbonnementDetails - Iterating ArrayList using for-each loop - Traversing list through for-each loop
            ...
            //4 - Ajout des enrégistrements dans ZZZFacturationAbonnementConsommation - Iterating ArrayList using for-each loop - Traversing list through for-each loop
            for(ZZZIFacturationAbonnementConsommationSource abonnement:this.facturationAbonnementConsommationSourceList) {
                //A - Ajout des enrégistrements dans ZZZFacturationAbonnementConsommation
        ...
        try 
        {
            ...
            if (classementInstrumentService != null) {
                if (classementInstrumentService == this.classementInstrumentServiceDS) {
                    //Dénomination Instrument - N° Instrument - Service
                    ...
                    //N° Instrument - Dénomination Instrument - Service
                    ...
                    //Service - Dénomination Instrument - N° Instrument
                    List<GridSortOrder<ZZZFacturationAbonnementConsommation>> sortOrders =
