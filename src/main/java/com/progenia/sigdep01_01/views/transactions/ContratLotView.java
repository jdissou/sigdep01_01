...
public class ContratLotView extends SaisieTransactionMaitreDetailsBase<ZZZContratLot, ZZZContratLotDetails> {
    ...
    */
    ...
    static final String PAGE_TITLE = "Saisie des Contrats de Service Récurrent par Lot";
    ...
    */
    ...
    private void setGridBeanList() {
        try 
        {
            ...
            //Abandonnée, car crée une erreur - this.detailsDataProvider.setSortOrder(ZZZContratLotDetails::getNoInstrument, SortDirection.ASCENDING);
    ...
    private void configureGrid() {
        ...
        try 
        {
            ...
            this.libelleInstrumentColumn = this.grid.addColumn(ZZZContratLotDetails::getLibelleInstrument).setKey("LibelleInstrument").setHeader("Dénomination Instrument").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("400px");
            this.dateDebutContratColumn = this.grid.addColumn(new LocalDateRenderer<>(ZZZContratLotDetails::getDateDebutContrat, DateTimeFormatter.ofLocalizedDate(FormatStyle.SHORT))).setKey("DateDebutContrat").setHeader("Date Début Contrat").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("200px"); // fixed column
