...
public class ConsultationEvenementIncubationLotView extends ConsultationSimpleBase<ZZZEvenementIncubationLot> {
    /*
    ...
    */
    ...
    private ArrayList<ZZZEvenementIncubationLotDetails> evenementIncubationLotDetailsList = new ArrayList<ZZZEvenementIncubationLotDetails>();
    ...
    static final String PAGE_TITLE = "Consultation des Evénements d'Incubation par Lot";
    ...
    */
    ...
    private void setupDataprovider()
    {
        try 
        {
            ...
            */
            ...
            this.dataProvider.setSortOrder(ZZZEvenementIncubationLot::getNoChrono, SortDirection.DESCENDING);
        } 
        catch (Exception e) 
        {
    ...
    private void configureGridWithFilters() {
        ...
        try 
        {
            ...
            Grid.Column<ZZZEvenementIncubationLot> noChronoColumn = this.grid.addColumn(ZZZEvenementIncubationLot::getNoChrono).setKey("NoChrono").setHeader("N° Evénement").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("125px"); // fixed column
            ...
            Grid.Column<ZZZEvenementIncubationLot> coutColumn = this.grid.addColumn(new NumberRenderer<>(ZZZEvenementIncubationLot::getCout, NumberFormat.getIntegerInstance(Locale.FRENCH))).setKey("Cout").setHeader("Coût").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("125px"); // fixed column
    ...
    private Boolean isTransactionCancelable(ZZZEvenementIncubationLot evenementIncubationLotItem) {
        try 
        {
            return (true);
        } 
    ...
    @Override
    protected void workingProcedAnnulerTransactionItem(ZZZEvenementIncubationLot evenementIncubationLotItem) {
        try 
        {
            if (this.isTransactionCancelable(evenementIncubationLotItem) == true) {
                //1 - Mise à jour de SaisieValidée dans ZZZEvenementIncubationLot
                ...
                for(ZZZEvenementIncubationLotDetails evenementIncubationLotDetails:this.evenementIncubationLotDetailsList) {
    ...
    @Override
    protected Long workingGetCurrentNoTransaction(ZZZEvenementIncubationLot evenementIncubationLotItem) {
        try 
        {
