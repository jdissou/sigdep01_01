...
public class ConsultationEvenementPreIncubationView extends ConsultationSimpleBase<ZZZEvenementPreIncubation> {
    /*
    ...
    */
    ...
    static final String PAGE_TITLE = "Consultation des Evénements de Pré Incubation";
    ...
    */
    ...
    private void setupDataprovider()
    {
        try 
        {
            ...
            */
            ...
            this.dataProvider.setSortOrder(ZZZEvenementPreIncubation::getNoChrono, SortDirection.DESCENDING);
        } 
        catch (Exception e) 
        {
    ...
    private void configureGridWithFilters() {
        ...
        try 
        {
            ...
            Grid.Column<ZZZEvenementPreIncubation> noChronoColumn = this.grid.addColumn(ZZZEvenementPreIncubation::getNoChrono).setKey("NoChrono").setHeader("N° Evénement").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("125px"); // fixed column
            ...
            Grid.Column<ZZZEvenementPreIncubation> coutColumn = this.grid.addColumn(new NumberRenderer<>(ZZZEvenementPreIncubation::getCout, NumberFormat.getIntegerInstance(Locale.FRENCH))).setKey("Cout").setHeader("Coût").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("125px"); // fixed column
    ...
    private Boolean isTransactionCancelable(ZZZEvenementPreIncubation evenementPreIncubationItem) {
        try 
        {
            return (true);
        } 
    ...
    @Override
    protected void workingProcedAnnulerTransactionItem(ZZZEvenementPreIncubation evenementPreIncubationItem) {
        try 
        {
            if (this.isTransactionCancelable(evenementPreIncubationItem) == true) {
                //1 - Mise à jour de SaisieValidée dans ZZZEvenementPreIncubation
    ...
    @Override
    protected Long workingGetCurrentNoTransaction(ZZZEvenementPreIncubation evenementPreIncubationItem) {
        try 
        {
