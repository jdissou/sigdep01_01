...
public class ConsultationPrestationDemandeView extends ConsultationSimpleBase<PrestationDemande> {
    ...
    */
    ...
    static final String PAGE_TITLE = "Consultation des Prestations de Service Ponctuel";
        ...
        try 
        {
            ...
            this.dataProvider.setFilter(item -> {
                ...
                */
                ...
                return isExerciceFilterMatch && isUtilisateurFilterMatch && isNoChronoFilterMatch && isDatePrestationFilterMatch && isInstrumentFilterMatch && isServiceFourniFilterMatch && isLibellePrestationFilterMatch && isNoPieceFilterMatch && isObservationsFilterMatch;
            });
