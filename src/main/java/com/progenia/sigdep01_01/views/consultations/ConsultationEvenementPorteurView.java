...
public class ConsultationEvenementInstrumentView extends ConsultationSimpleBase<Decaissement> {
    ...
    */
    ...
    static final String PAGE_TITLE = "Consultation des Evénements d'Incubation par Instrument de Projet";
    ...
    */
    ...
    private void configureGridWithFilters() {
        ...
        try 
        {
            ...
            Grid.Column<Decaissement> noChronoColumn = this.grid.addColumn(Decaissement::getNoChrono).setKey("NoChrono").setHeader("N° Evénement").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("125px"); // fixed column
            ...
            //Grid.Column<Decaissement> dateEvenementColumn = this.grid.addColumn(new LocalDateRenderer<>(Decaissement::getDateEvenement, DateTimeFormatter.ofLocalizedDate(FormatStyle.SHORT))).setKey("DateEvenement").setHeader("Date Evénement").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("175px"); // fixed column
    ...
    protected void workingProcedAnnulerTransactionItem(Decaissement evenementInstrumentItem) {
        try 
        {
            if (this.isTransactionCancelable(evenementInstrumentItem) == true) {
                //1 - Mise à jour de SaisieValidée dans Decaissement
