...
public class ConsultationFacturationActeView extends ConsultationSimpleBase<ZZZFacturationActe> {
    /*
    ...
    */
    ...
    private ArrayList<ZZZFacturationActeDetails> facturationActeDetailsList = new ArrayList<ZZZFacturationActeDetails>();
    ...
    static final String PAGE_TITLE = "Consultation des Facturations de Service Ponctuel";
    ...
    */
    ...
    private void setupDataprovider()
    {
        try 
        {
            ...
            */
            ...
            this.dataProvider.setSortOrder(ZZZFacturationActe::getNoChrono, SortDirection.DESCENDING);
        } 
        catch (Exception e) 
        {
    ...
    private void configureGridWithFilters() {
        ...
        try 
        {
            ...
            Grid.Column<ZZZFacturationActe> noChronoColumn = this.grid.addColumn(ZZZFacturationActe::getNoChrono).setKey("NoChrono").setHeader("N° Facturation").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("125px"); // fixed column
        ...
        try 
        {
            ...
            this.dataProvider.setFilter(item -> {
                ...
                */
                ...
                return isExerciceFilterMatch && isUtilisateurFilterMatch && isNoChronoFilterMatch && isDateFacturationFilterMatch && isInstrumentFilterMatch && isDateDebutPrestationFilterMatch && isDateFinPrestationFilterMatch && isLibelleFacturationFilterMatch && isNoPieceFilterMatch && isObservationsFilterMatch;
            });
    ...
    private Boolean isTransactionCancelable(ZZZFacturationActe facturationActeItem) {
        try 
        {
            return (true);
        }
    ...
    @Override
    protected void workingProcedAnnulerTransactionItem(ZZZFacturationActe facturationActeItem) {
        try 
        {
            if (this.isTransactionCancelable(facturationActeItem) == true) {
                //1 - Mise à jour de SaisieValidée dans ZZZFacturationActe
                ...
                for(ZZZFacturationActeDetails facturationActeDetails:this.facturationActeDetailsList) {
                ...
                //5 - Mise à de Instrument : Restauration SauvegardeCompteurExterne - Recherche avec la Clé
                Optional<Instrument> InstrumentOptional = this.InstrumentBusiness.findById(facturationActeItem.getNoInstrument());
                if (InstrumentOptional.isPresent()) {
                    Instrument Instrument = InstrumentOptional.get();

                    Instrument.setCompteurExterne01(facturationActeItem.getSauvegardeCompteurExterne01());
                    Instrument.setCompteurExterne02(facturationActeItem.getSauvegardeCompteurExterne02());
                    Instrument.setCompteurExterne03(facturationActeItem.getSauvegardeCompteurExterne03());
                    Instrument.setCompteurExterne04(facturationActeItem.getSauvegardeCompteurExterne04());
                    Instrument.setCompteurExterne05(facturationActeItem.getSauvegardeCompteurExterne05());
                    Instrument.setCompteurExterne06(facturationActeItem.getSauvegardeCompteurExterne06());
                    Instrument.setCompteurExterne07(facturationActeItem.getSauvegardeCompteurExterne07());
                    Instrument.setCompteurExterne08(facturationActeItem.getSauvegardeCompteurExterne08());
                    Instrument.setCompteurExterne09(facturationActeItem.getSauvegardeCompteurExterne09());
                    Instrument.setCompteurExterne10(facturationActeItem.getSauvegardeCompteurExterne10());
    ...
    @Override
    protected Long workingGetCurrentNoTransaction(ZZZFacturationActe facturationActeItem) {
        try 
        {
