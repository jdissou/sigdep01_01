...
/*
import com.progenia.sigdep01_01.securities.data.business.CentreIncubateurBusiness;
import com.progenia.sigdep01_01.securities.data.entity.ZZZCentreIncubateur;
*/
...
public class PreferenceUtilisateurView  extends VerticalLayout implements BeforeLeaveObserver {
    ...
    */
    ...
    static final String PAGE_TITLE = "Préférences Utilisateur";
    ...
    static final String DATEPICKER_LEFT_LABEL = "my-datepicker-left-label"; //TO DO
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            */
            ...
            /*
            this.formLayout.addFormItem(this.cboCodeCentreIncubateur, "ZZZCentreIncubateur :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            */
