        ...
        try 
        {
            ...
            accordion.add(createAccordionPanel("Saisie des Transactions",
                new com.vaadin.flow.component.Component[]{    
                    ...
                    createDivAccordionItem("Evénements d'Incubation par Instrument", EvenementInstrumentView.class),
                    createSeparatorItem(),
                    createDivAccordionItem("Contrats de Service Récurrent par Lot", ContratLotView.class),
                    createDivAccordionItem("Contrats de Service Récurrent par Instrument", ContratAccompagnementView.class),
                    ...
                    createDivAccordionItem("Règlements de Facture", ReglementInstrumentView.class),
                    createSeparatorItem(),
            ...
            accordion.add(
                ...
                new com.vaadin.flow.component.Component[]{    
                    ...
                    createDivAccordionItem("Evénements d'Incubation par Instrument", ConsultationEvenementInstrumentView.class),
                    createSeparatorItem(),
                    createDivAccordionItem("Contrats de Service Récurrent par Lot", ConsultationContratLotView.class),
                    createDivAccordionItem("Contrats de Service Récurrent par Instrument", ConsultationContratAccompagnementView.class),
                    createSeparatorItem(),
                    ...
                    createDivAccordionItem("Règlements de Facture", ConsultationReglementInstrumentView.class),
                    createSeparatorItem(),
