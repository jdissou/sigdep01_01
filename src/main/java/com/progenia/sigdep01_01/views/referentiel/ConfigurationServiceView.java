...
import com.progenia.sigdep01_01.dialogs.EditerVariableServiceDialog;
import com.progenia.sigdep01_01.dialogs.EditerVariableServiceDialog.VariableServiceAddEvent;
import com.progenia.sigdep01_01.dialogs.EditerVariableServiceDialog.VariableServiceRefreshEvent;
import com.progenia.sigdep01_01.dialogs.EditerVariableServiceDialog.VariableServiceUpdateEvent;
import com.progenia.sigdep01_01.dialogs.EditerServiceFourniDialog;
import com.progenia.sigdep01_01.dialogs.EditerConstanteDialog;
import com.progenia.sigdep01_01.dialogs.EditerConstanteDialog.ConstanteAddEvent;
import com.progenia.sigdep01_01.dialogs.EditerConstanteDialog.ConstanteRefreshEvent;
import com.progenia.sigdep01_01.dialogs.EditerConstanteDialog.ConstanteUpdateEvent;
import com.progenia.sigdep01_01.dialogs.EditerRubriqueDialog;
import com.progenia.sigdep01_01.dialogs.EditerRubriqueDialog.RubriqueAddEvent;
import com.progenia.sigdep01_01.dialogs.EditerRubriqueDialog.RubriqueRefreshEvent;
import com.progenia.sigdep01_01.dialogs.EditerRubriqueDialog.RubriqueUpdateEvent;
import com.progenia.sigdep01_01.dialogs.EditerServiceFourniDialog.ServiceFourniAddEvent;
import com.progenia.sigdep01_01.dialogs.EditerServiceFourniDialog.ServiceFourniRefreshEvent;
import com.progenia.sigdep01_01.dialogs.EditerServiceFourniDialog.ServiceFourniUpdateEvent;
import com.progenia.sigdep01_01.dialogs.EditerTrancheValeurDialog;
import com.progenia.sigdep01_01.dialogs.EditerTrancheValeurDialog.TrancheValeurAddEvent;
import com.progenia.sigdep01_01.dialogs.EditerTrancheValeurDialog.TrancheValeurRefreshEvent;
import com.progenia.sigdep01_01.dialogs.EditerTrancheValeurDialog.TrancheValeurUpdateEvent;
...
import com.progenia.sigdep01_01.systeme.data.business.*;
...
public class ConfigurationServiceView extends OngletReferentielBase {
    ...
    */
    ...
    static final String PAGE_TITLE = "Configuration des Services";
    static final String CACHED_SELECTED_TAB_INDEX = "ConfigurationServiceViewSelectedTab";
    ...
    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private SystemeTypeCreancierBusiness tab12TypeServiceBusiness;
    private ArrayList<SystemeTypeCreancier> tab12TypeServiceList = new ArrayList<SystemeTypeCreancier>();
    private ListDataProvider<SystemeTypeCreancier> tab12TypeServiceDataProvider;
    ...
    @Autowired
    private SystemeTypeTauxInteretBusiness tab12TypeVariableBusiness;
    @Autowired
    private SecteurEconomiqueBusiness tab12UniteOeuvreBusiness;
    ...
    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private SystemeTypeTauxInteretBusiness tab23TypeVariableBusiness;
    private ArrayList<SystemeTypeTauxInteret> tab23TypeVariableList = new ArrayList<SystemeTypeTauxInteret>();
    private ListDataProvider<SystemeTypeTauxInteret> tab23TypeVariableDataProvider;

    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private SecteurEconomiqueBusiness tab23UniteOeuvreBusiness;
    private ArrayList<SecteurEconomique> tab23UniteOeuvreList = new ArrayList<SecteurEconomique>();
    private ListDataProvider<SecteurEconomique> tab23UniteOeuvreDataProvider;
    ...
    //ATTRIBUTS - tab34 - EmploiFonds
    private Tab tab34ConstanteTab = new Tab();
    private Grid<EmploiFonds> tab34ConstanteGrid = new Grid<>(); //Manually defining columns

    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private EmploiFondsBusiness tab34ConstanteBusiness;
    private ArrayList<EmploiFonds> tab34ConstanteList = new ArrayList<EmploiFonds>();
    //For Lazy Loading
    //DataProvider<EmploiFonds, Void> tab34ConstanteDataProvider; //The second DataProvider type parameter defines how the provider can be filtered. In the example, the filter type is Void
    //For ListDataProvider for Advanced In-memory Data Handling
    private ListDataProvider<EmploiFonds> tab34ConstanteDataProvider;

    /* Fields to filter items in EmploiFonds entity */
    ...
    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private SystemeModeValorisationCommissionBusiness tab45ModeValorisationRubriqueBusiness;
    private ArrayList<SystemeModeValorisationCommission> tab45ModeValorisationRubriqueList = new ArrayList<SystemeModeValorisationCommission>();
    private ListDataProvider<SystemeModeValorisationCommission> tab45ModeValorisationRubriqueDataProvider;

    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private SystemeModeValorisationBaseCommissionBusiness tab45ModeValorisationBaseBusiness;
    private ArrayList<SystemeModeValorisationBaseCommission> tab45ModeValorisationBaseList = new ArrayList<SystemeModeValorisationBaseCommission>();
    private ListDataProvider<SystemeModeValorisationBaseCommission> tab45ModeValorisationBaseDataProvider;

    // @Autowired annotation provides the automatic dependency injection.
    @Autowired
    private SystemeModeValorisationTauxCommissionBusiness tab45ModeValorisationTauxBusiness;
    private ArrayList<SystemeModeValorisationTauxCommission> tab45ModeValorisationTauxList = new ArrayList<SystemeModeValorisationTauxCommission>();
    private ListDataProvider<SystemeModeValorisationTauxCommission> tab45ModeValorisationTauxDataProvider;
    ...
    @Autowired
    private EmploiFondsBusiness tab45ConstanteBusiness;
    @Autowired
    ...
    @Autowired
    private SystemeTypeTauxInteretBusiness tab45TypeVariableBusiness;
    @Autowired
    private SecteurEconomiqueBusiness tab45UniteOeuvreBusiness;

    @Autowired
    private TypeInstrumentBusiness tab45TypeInstrumentBusiness;
    @Autowired
    ...
    */
    ...
    private void tab12SetupDataprovider()
    {
        try 
        {
            ...
            */
            ...
            this.tab12TypeServiceDataProvider.setSortOrder(SystemeTypeCreancier::getLibelleTypeService, SortDirection.ASCENDING);
    ...
    private void tab23SetupDataprovider()
    {
        try 
        {
            ...
            */
            ...
            this.tab23TypeVariableDataProvider.setSortOrder(SystemeTypeTauxInteret::getLibelleTypeVariable, SortDirection.ASCENDING);
            ...
            this.tab23UniteOeuvreDataProvider.setSortOrder(SecteurEconomique::getLibelleUniteOeuvre, SortDirection.ASCENDING);
    ...
    private void tab45SetupDataprovider()
    {
        try 
        {
            ...
            */
            ...
            this.tab45ModeValorisationRubriqueDataProvider.setSortOrder(SystemeModeValorisationCommission::getLibelleModeValorisation, SortDirection.ASCENDING);
            ...
            this.tab45ModeValorisationBaseDataProvider.setSortOrder(SystemeModeValorisationBaseCommission::getLibelleModeValorisation, SortDirection.ASCENDING);
            ...
            this.tab45ModeValorisationTauxDataProvider.setSortOrder(SystemeModeValorisationTauxCommission::getLibelleModeValorisation, SortDirection.ASCENDING);
        ...
        try 
        {
            ...
            Grid.Column<ServiceFourni> typeServiceColumn = this.tab12ServiceFourniGrid.addColumn(new ComponentRenderer<>(
                        serviceFourni -> {
                            ...
                            ComboBox<SystemeTypeCreancier> comboBox = new ComboBox<>();
                            ...
                            comboBox.setItemLabelGenerator(SystemeTypeCreancier::getLibelleTypeService);
    ...
    private void tab23ConfigureGridWithFilters() {
        ...
        try 
        {
            ...
            Grid.Column<VariableService> typeVariableColumn = this.tab23VariableServiceGrid.addColumn(new ComponentRenderer<>(
                        variableService -> {
                            //ComboBox comboBox = new ComboBox();
                            ComboBox<SystemeTypeTauxInteret> comboBox = new ComboBox<>();
                            ...
                            comboBox.setItemLabelGenerator(SystemeTypeTauxInteret::getLibelleTypeVariable);
            ...
            Grid.Column<VariableService> variableServiceColumn = this.tab23VariableServiceGrid.addColumn(new ComponentRenderer<>(
                        variableService -> {
                            //ComboBox comboBox = new ComboBox();
                            ComboBox<SecteurEconomique> comboBox = new ComboBox<>();
                            comboBox.setDataProvider(this.tab23UniteOeuvreDataProvider);
                            //comboBox.setItems(this.tab23UniteOeuvreList);
                            // Choose which property from SecteurEconomique is the presentation value
                            comboBox.setItemLabelGenerator(SecteurEconomique::getLibelleUniteOeuvre);
            ...
            ).setKey("SecteurEconomique").setHeader("Unité d'Oeuvre").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("250px"); // fixed column
    ...
    private void tab34ConfigureGridWithFilters() {
        ...
        try 
        {
            ...
            //2 - Add columns to the empty table and set Data Properties to Columns - Width = 565 + 175 + 175 + 175 + 175 + 100 = 975
            Grid.Column<EmploiFonds> codeConstanteColumn = this.tab34ConstanteGrid.addColumn(EmploiFonds::getCodeConstante).setKey("CodeConstante").setHeader("Code EmploiFonds").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("200px"); // fixed column
            Grid.Column<EmploiFonds> libelleConstanteColumn = this.tab34ConstanteGrid.addColumn(EmploiFonds::getLibelleConstante).setKey("LibelleConstante").setHeader("Libellé EmploiFonds").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("300px"); // fixed column
            Grid.Column<EmploiFonds> libelleCourtConstanteColumn = this.tab34ConstanteGrid.addColumn(EmploiFonds::getLibelleCourtConstante).setKey("LibelleCourtConstante").setHeader("Libellé Abrégé").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("200px"); // fixed column
            Grid.Column<EmploiFonds> valeurConstanteColumn = this.tab34ConstanteGrid.addColumn(new NumberRenderer<>(EmploiFonds::getValeurConstante, NumberFormat.getIntegerInstance(Locale.FRENCH))).setKey("ValeurConstante").setHeader("Valeur").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("200px"); // fixed column
            
            Grid.Column<EmploiFonds> isInactifColumn = this.tab34ConstanteGrid.addColumn(new ComponentRenderer<>(
                        constante -> {
                            Checkbox checkbox = new Checkbox();
    ...
    private void tab45ConfigureGridWithFilters() {
        ...
        try 
        {
            ...
            Grid.Column<Rubrique> modeValorisationRubriqueColumn = this.tab45RubriqueGrid.addColumn(new ComponentRenderer<>(
                        rubrique -> {
                            //ComboBox comboBox = new ComboBox();
                            ComboBox<SystemeModeValorisationCommission> comboBox = new ComboBox<>();
                            comboBox.setDataProvider(this.tab45ModeValorisationRubriqueDataProvider);
                            //comboBox.setItems(this.tab45TypeVariableList);
                            // Choose which property from TypeVariable is the presentation value
                            comboBox.setItemLabelGenerator(SystemeModeValorisationCommission::getLibelleModeValorisation);
            ...
            Grid.Column<Rubrique> modeValorisationBaseColumn = this.tab45RubriqueGrid.addColumn(new ComponentRenderer<>(
                        rubrique -> {
                            //ComboBox comboBox = new ComboBox();
                            ComboBox<SystemeModeValorisationBaseCommission> comboBox = new ComboBox<>();
                            comboBox.setDataProvider(this.tab45ModeValorisationBaseDataProvider);
                            //comboBox.setItems(this.tab45TypeVariableList);
                            // Choose which property from TypeVariable is the presentation value
                            comboBox.setItemLabelGenerator(SystemeModeValorisationBaseCommission::getLibelleModeValorisation);
            ...
            Grid.Column<Rubrique> modeValorisationTauxColumn = this.tab45RubriqueGrid.addColumn(new ComponentRenderer<>(
                        rubrique -> {
                            //ComboBox comboBox = new ComboBox();
                            ComboBox<SystemeModeValorisationTauxCommission> comboBox = new ComboBox<>();
                            comboBox.setDataProvider(this.tab45ModeValorisationTauxDataProvider);
                            //comboBox.setItems(this.tab45TypeVariableList);
                            // Choose which property from TypeVariable is the presentation value
                            comboBox.setItemLabelGenerator(SystemeModeValorisationTauxCommission::getLibelleModeValorisation);
    ...
    protected void workingHandleAjouterClick(ClickEvent event) {
        try 
        {
            ...
            else if (this.selectedTab == this.tab34ConstanteTab)
            {
                ...
                EditerConstanteDialog.getInstance().showDialog("Ajout de EmploiFonds", ModeFormulaireEditerEnum.AJOUTERLOT, new ArrayList<EmploiFonds>(), this.tab34ConstanteList, "", this.uiEventBus);
            }
            else if (this.selectedTab == this.tab45RubriqueTab)
            {
                EditerRubriqueDialog.getInstance().showDialog("Ajout de Rubrique de Facturation", ModeFormulaireEditerEnum.AJOUTERLOT, new ArrayList<Rubrique>(), this.tab45RubriqueList, "", this.uiEventBus, 
                        ...
                        tab45TypeInstrumentBusiness, tab45CompteBusiness);
    ...
    protected void workingHandleModifierClick(ClickEvent event) {
        try 
        {
            ...
            else if (this.selectedTab == this.tab34ConstanteTab)
            {
                ...
                or several items in multi-selection mode.            
                */
                Set<EmploiFonds> selected = this.tab34ConstanteGrid.getSelectedItems();
                ...
                {
                    EditerConstanteDialog.getInstance().showDialog("Modification de EmploiFonds", ModeFormulaireEditerEnum.MODIFIER, new ArrayList<EmploiFonds>(selected), this.tab34ConstanteList, "", this.uiEventBus);
                }
            }
            else if (this.selectedTab == this.tab45RubriqueTab)
            {
            ...
            else if (this.selectedTab == this.tab34ConstanteTab)
            {
                ...
                */
                ...
                else
                {
                    ...
                    EditerConstanteDialog.getInstance().showDialog("Afficher détails EmploiFonds", ModeFormulaireEditerEnum.AFFICHER, new ArrayList<EmploiFonds>(selected), this.tab34ConstanteList, "", this.uiEventBus);
                }
            }
            else if (this.selectedTab == this.tab45RubriqueTab)
            {
    ...
    private void handleConstanteAddEventFromEditorDialog(ConstanteAddEvent event) {
        //Handle EmploiFonds Add Event received from EditorView
        try 
        {
            //1 - Sauvegarder la modification dans le backend
            EmploiFonds newInstance = this.tab34ConstanteBusiness.save(event.getConstante());
    ...
    private void handleConstanteUpdateEventFromEditorDialog(ConstanteUpdateEvent event) {
        //Handle EmploiFonds Udpdate Event received from EditorView
        try 
        {
            //1 - Sauvegarder la modification dans le backend
            EmploiFonds updateInstance = this.tab34ConstanteBusiness.save(event.getConstante());
    ...
    private void handleConstanteRefreshEventFromEditorDialog(ConstanteRefreshEvent event) {
        //Handle EmploiFonds Cloee Event received from EditorView
        try 
        {
            ...
            else if (this.selectedTab == this.tab34ConstanteTab)
            {
                ...
                else
                {
                    ...
                    ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                        //Confirmer la suppression
                        //1 - Iterate Set Using For-Each Loop
                        for(EmploiFonds constanteItem : selected) {
    ...
    protected void workingHandleImprimerClick(ClickEvent event) {
        try 
        {
            ...
            {
                this.execJasperReport("EmploiFonds", "Référentiel des Constantes", this.tab34ConstanteBusiness.getReportData());
            }
            else if (this.selectedTab == this.tab45RubriqueTab)
            {
