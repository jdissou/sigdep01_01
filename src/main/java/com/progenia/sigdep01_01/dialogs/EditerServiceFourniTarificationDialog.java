 ...
 */
public class EditerServiceFourniTarificationDialog extends BaseEditerReferentielDetailFormDialog<XXXServiceFourniTarification> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in XXXServiceFourniTarification entity */
    ...
    public EditerServiceFourniTarificationDialog() {
        ...
        super();
        this.binder = new BeanValidationBinder<>(XXXServiceFourniTarification.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ServiceFourni parentBean, ArrayList<XXXServiceFourniTarification> targetBeanList, ArrayList<XXXServiceFourniTarification> referenceBeanList, EventBus.UIEventBus uiEventBus, RubriqueBusiness rubriqueBusiness) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(XXXServiceFourniTarification::getNoRubrique));
        ...
        try 
        {
            ...
            */
            ...
            this.binder.forField(this.txtNoOrdre)
                ...
                .bind(XXXServiceFourniTarification::getNoOrdre, XXXServiceFourniTarification::setNoOrdre);
            ...
            this.binder.forField(this.cboNoRubrique)
                ...
                .bind(XXXServiceFourniTarification::getRubrique, XXXServiceFourniTarification::setRubrique);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in XXXServiceFourniTarification and ServiceFourniTarificationView based on their names.
            */
    ...
    @Override
    public XXXServiceFourniTarification workingCreateNewBeanInstance()
    {
        try 
        {
            //Initialisation de valeurs par défaut
            XXXServiceFourniTarification serviceFourniTarification = new XXXServiceFourniTarification(this.parentBean);
    ...
    public static abstract class EditerServiceFourniTarificationDialogEvent extends ComponentEvent<Dialog> {
        private XXXServiceFourniTarification serviceFourniTarification;

        protected EditerServiceFourniTarificationDialogEvent(Dialog source, XXXServiceFourniTarification argServiceFourniTarification) {
        ...
        public XXXServiceFourniTarification getServiceFourniTarification() {
            return serviceFourniTarification;
        }
    }

    public static class ServiceFourniTarificationAddEvent extends EditerServiceFourniTarificationDialogEvent {
        public ServiceFourniTarificationAddEvent(Dialog source, XXXServiceFourniTarification serviceFourniTarification) {
    ...
    public static class ServiceFourniTarificationUpdateEvent extends EditerServiceFourniTarificationDialogEvent {
        public ServiceFourniTarificationUpdateEvent(Dialog source, XXXServiceFourniTarification serviceFourniTarification) {
            super(source, serviceFourniTarification);
        }
    }
    ...
    private class SortByNoRubrique implements Comparator<XXXServiceFourniTarification> {
        // Used for sorting in ascending order of
        // getNoRubrique()
        public int compare(XXXServiceFourniTarification a, XXXServiceFourniTarification b)
        {
