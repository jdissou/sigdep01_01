...
public class AfficherPrestationDemandeDialog extends BaseAfficherTransactionDialog<PrestationDemande> {
    ...
    */
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, EventBus.UIEventBus uiEventBus, ZZZCentreIncubateur centreIncubateurCible, PrestationDemandeBusiness prestationDemandeBusiness, ExerciceBusiness exerciceBusiness, UtilisateurBusiness utilisateurBusiness, CentreIncubateurBusiness centreIncubateurBusiness, InstrumentBusiness InstrumentBusiness, ServiceFourniBusiness serviceFourniBusiness) {
    ...
    private void configureGridWithFilters() {
        ...
        try 
        {
            ...
            if (this.grid.getColumnByKey("Exercice") == null) {
                ...
                Grid.Column<PrestationDemande> InstrumentColumn = this.grid.addColumn(new ComponentRenderer<>(
                            prestationDemande -> {
                                //ComboBox comboBox = new ComboBox();
                                ...
                                comboBox.setValue(prestationDemande.getInstrument());
        ...
        try 
        {
            ...
            this.dataProvider.setFilter(item -> {
                ...
                */
                ...
                return isExerciceFilterMatch && isUtilisateurFilterMatch && isNoChronoFilterMatch && isDatePrestationFilterMatch && isCentreIncubateurFilterMatch && isInstrumentFilterMatch && isServiceFourniFilterMatch && isLibellePrestationFilterMatch && isNoPieceFilterMatch && isObservationsFilterMatch;
            });
