 ...
 */
public class EditerJournalDialog extends BaseEditerReferentielMaitreFormDialog<ZZZJournal> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in ZZZJournal entity */
    ...
    public EditerJournalDialog() {
        ...
        super();
        this.binder = new BeanValidationBinder<>(ZZZJournal.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<ZZZJournal> targetBeanList, ArrayList<ZZZJournal> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus, CompteBusiness compteBusiness) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(ZZZJournal::getCodeJournal));
        ...
        try 
        {
            ...
            */
            ...
            this.binder.forField(this.txtCodeJournal)
                .asRequired("La Saisie du Code ZZZJournal est Obligatoire. Veuillez saisir le Code ZZZJournal.")
                .withValidator(text -> text != null && text.length() <= 6, "Code ZZZJournal ne peut contenir au plus 6 caractères")
                ...
                .bind(ZZZJournal::getCodeJournal, ZZZJournal::setCodeJournal);
            
            Label lblLibelleJournalValidationStatus = new Label();
            this.binder.forField(this.txtLibelleJournal)
                .withValidator(text -> text.length() <= 50, "Libellé ZZZJournal ne peut contenir au plus 50 caractères.")
                ...
                .bind(ZZZJournal::getLibelleJournal, ZZZJournal::setLibelleJournal);
            
            Label lblReferenceJournalValidationStatus = new Label();
            this.binder.forField(this.txtReferenceJournal)
                .withValidator(text -> text.length() <= 2, "Référence ZZZJournal ne peut contenir au plus 2 caractères.")
                ...
                .bind(ZZZJournal::getReferenceJournal, ZZZJournal::setReferenceJournal);
            ...
            this.binder.forField(this.cboNoCompte)
                ...
                .bind(ZZZJournal::getCompte, ZZZJournal::setCompte);
            
            this.binder.forField(this.chkInactif)
                .bind(ZZZJournal::isInactif, ZZZJournal::setInactif);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in ZZZJournal and JournalView based on their names.
            */
            ...
            //4 - Alternative
            this.formLayout.addFormItem(this.txtCodeJournal, "Code ZZZJournal :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleJournal, "Libellé ZZZJournal :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtReferenceJournal, "Référence ZZZJournal :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
...
@Override
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            if (this.referenceBeanList.stream()
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Risque de Doublons dans champ clé principale. Veuillez en saisir un autre Code ZZZJournal.");
    ...
    @Override
    public ZZZJournal workingCreateNewBeanInstance()
    {
        return (new ZZZJournal());
    }
    ...
    public static abstract class EditerJournalDialogEvent extends ComponentEvent<Dialog> {
        private ZZZJournal journal;

        protected EditerJournalDialogEvent(Dialog source, ZZZJournal argJournal) {
