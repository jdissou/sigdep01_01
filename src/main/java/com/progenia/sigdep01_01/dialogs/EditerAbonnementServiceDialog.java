 ...
 */
public class EditerAbonnementServiceDialog extends BaseEditerReferentielMaitreFormDialog<ZZZAbonnementService> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in ZZZAbonnementService entity */
    ...
    public EditerAbonnementServiceDialog() {
        ...
        super();
        this.binder = new BeanValidationBinder<>(ZZZAbonnementService.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<ZZZAbonnementService> targetBeanList, ArrayList<ZZZAbonnementService> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus, ServiceFourniBusiness serviceFourniBusiness) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(ZZZAbonnementService::getLibelleService));
        ...
        try 
        {
            ...
            */
            ...
            this.binder.forField(this.txtNoChrono)
                ...
                .bind(ZZZAbonnementService::getNoChrono, null);
            ...
            this.binder.forField(this.cboCodeService)
                ...
                .bind(ZZZAbonnementService::getServiceFourni, ZZZAbonnementService::setServiceFourni);
            ...
            this.binder.forField(this.datDateAbonnement)
                ...
                .bind(ZZZAbonnementService::getDateAbonnement, ZZZAbonnementService::setDateAbonnement);
            ...
            this.binder.forField(this.datDateDebutContrat)
                ...
                .bind(ZZZAbonnementService::getDateDebutContrat, ZZZAbonnementService::setDateDebutContrat);
            
            Label lblDateFinContratValidationStatus = new Label();
            // Store DateFinContrat binding so we can revalidate it later
            Binder.Binding<ZZZAbonnementService, LocalDate> dateFinContratBinding = this.binder.forField(this.datDateFinContrat)
                ...
                .bind(ZZZAbonnementService::getDateFinContrat, ZZZAbonnementService::setDateFinContrat);
            ...
            this.binder.forField(this.chkCloture)
                .bind(ZZZAbonnementService::isCloture, ZZZAbonnementService::setCloture);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in ZZZAbonnementService and AbonnementServiceView based on their names.
            */
    ...
    @Override
    public ZZZAbonnementService workingCreateNewBeanInstance()
    {
        return (new ZZZAbonnementService());
    }
    ...
    */
    ...
    public static abstract class EditerAbonnementServiceDialogEvent extends ComponentEvent<Dialog> {
        private ZZZAbonnementService journal;

        protected EditerAbonnementServiceDialogEvent(Dialog source, ZZZAbonnementService argAbonnementService) {
        ...
        public ZZZAbonnementService getAbonnementService() {
            return journal;
        }
    }

    public static class AbonnementServiceAddEvent extends EditerAbonnementServiceDialogEvent {
        public AbonnementServiceAddEvent(Dialog source, ZZZAbonnementService journal) {
            super(source, journal);
        }
    }

    public static class AbonnementServiceUpdateEvent extends EditerAbonnementServiceDialogEvent {
        public AbonnementServiceUpdateEvent(Dialog source, ZZZAbonnementService journal) {
            super(source, journal);
        }
    }
