...
public class EditerBienImmobilierDialog extends BaseEditerReferentielMaitreFormDialog<ZZZBienImmobilier> {
    ...
    */
        ...
        try 
        {
            ...
            this.cboCodeImmeuble.addValueChangeListener(event -> {
                if (event.getValue() != null) {
                    ...
                    if (event.getValue().isInactif() == true) {
                        MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Le ZZZImmeuble choisi est actuellement désactivé. Veuillez en saisir un autre.");
                        //Cancel
            ...
            this.binder.forField(this.cboCodeImmeuble)
                    .asRequired("La Saisie du ZZZImmeuble est requise. Veuillez sélectionner un ZZZImmeuble")
    ...
    {
        //Ajoute un nouvel ZZZImmeuble en entrant un libellé dans la zone de liste modifiable CodeImmeuble.
        String strNewVal = strProposedVal;
        ...
        try
        {
            if (SecurityService.getInstance().isAccessGranted("EditerImmeubleDialog") == true) {
                ...
                // Affiche une boîte de confirmation demandant si l'utilisateur désire ajouter un nouveau Type Instrument.
                MessageDialogHelper.showYesNoDialog("Le ZZZImmeuble '" + strNewVal + "' n'est pas dans la liste.", "Désirez-vous ajouter un nouvel ZZZImmeuble?. Cliquez sur Oui pour confirmer l'ajout.", yesClickListener, noClickListener);
            }
            else {
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie du ZZZImmeuble est requise. Veuillez en saisir un.");
            } //if (SecurityService.getInstance().isAccessGranted("EditerImmeubleDialog") == true) {
