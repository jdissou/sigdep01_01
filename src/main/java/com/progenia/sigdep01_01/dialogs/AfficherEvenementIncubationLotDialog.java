 ...
 */
public class AfficherEvenementIncubationLotDialog extends BaseAfficherTransactionDialog<ZZZEvenementIncubationLot> {
    /***
     * AfficherEvenementIncubationLotDialog is responsible for launch Dialog. 
    ...
    */
    ...
    /* Fields to filter items in ZZZEvenementIncubationLot entity */
    ...
    public AfficherEvenementIncubationLotDialog() {
        //Cette méthode contient les instructions pour créer les composants
        super();
        this.strNomFormulaire = "EvenementIncubationLotView";
    ...
    public static AfficherEvenementIncubationLotDialog getInstance() {
        try 
        {
            if (VaadinSession.getCurrent().getAttribute(AfficherEvenementIncubationLotDialog.class) ==  null) {
                //Register an instance - We use this registre as a CACHE, i.e we store it only once
                VaadinSession.getCurrent().setAttribute(AfficherEvenementIncubationLotDialog.class, new AfficherEvenementIncubationLotDialog());
            }
            return (AfficherEvenementIncubationLotDialog)(VaadinSession.getCurrent().getAttribute(AfficherEvenementIncubationLotDialog.class));
        } 
        catch (Exception e) 
        {
            MessageDialogHelper.showAlertDialog("AfficherEvenementIncubationLotDialog.getInstance", e.toString());
            e.printStackTrace();
            return null;
        }
    } //public static AfficherEvenementIncubationLotDialog getInstance() {
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, EventBus.UIEventBus uiEventBus, ZZZCentreIncubateur centreIncubateurCible, EvenementIncubationLotBusiness evenementIncubationLotBusiness, ExerciceBusiness exerciceBusiness, UtilisateurBusiness utilisateurBusiness, CentreIncubateurBusiness centreIncubateurBusiness, TypeEvenementBusiness typeEvenementBusiness, CohorteBusiness cohorteBusiness, ProgrammeBusiness programmeBusiness) {
        ...
        try 
        {
            ...
            this.evenementIncubationLotBusiness = evenementIncubationLotBusiness;
            ...
            */
            ...
            this.dataProvider.setSortOrder(ZZZEvenementIncubationLot::getNoEvenement, SortDirection.DESCENDING);
        ...
        {
            MessageDialogHelper.showAlertDialog("AfficherEvenementIncubationLotDialog.showDialog", e.toString());
            e.printStackTrace();
        }
    }
    ...
    private void configureGridWithFilters() {
        ...
        try 
        {
            ...
            if (this.grid.getColumnByKey("Exercice") == null) {
                ...
                Grid.Column<ZZZEvenementIncubationLot> exerciceColumn = this.grid.addColumn(new ComponentRenderer<>(
                ...
                Grid.Column<ZZZEvenementIncubationLot> utilisateurColumn = this.grid.addColumn(new ComponentRenderer<>(
                            evenementIncubationLot -> {
                                //ComboBox comboBox = new ComboBox();
                ...
                Grid.Column<ZZZEvenementIncubationLot> noChronoColumn = this.grid.addColumn(ZZZEvenementIncubationLot::getNoChrono).setKey("NoChrono").setHeader("N° Evénement").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("150px"); // fixed column
                Grid.Column<ZZZEvenementIncubationLot> dateEvenementColumn = this.grid.addColumn(ZZZEvenementIncubationLot::getDateEvenementToString).setKey("DateEvenement").setHeader("Date Evénement").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("150px"); // fixed column
                //Grid.Column<ZZZEvenementIncubationLot> dateEvenementColumn = this.grid.addColumn(new LocalDateRenderer<>(ZZZEvenementIncubationLot::getDateEvenement, DateTimeFormatter.ofLocalizedDate(FormatStyle.SHORT))).setKey("DateEvenement").setHeader("Date Evénement").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("175px"); // fixed column

                Grid.Column<ZZZEvenementIncubationLot> centreIncubateurColumn = this.grid.addColumn(new ComponentRenderer<>(
                            evenementIncubationLot -> {
                                //ComboBox comboBox = new ComboBox();
                                ...
                                comboBox.setValue(evenementIncubationLot.getCentreIncubateur());
                ...
                Grid.Column<ZZZEvenementIncubationLot> typeEvenementColumn = this.grid.addColumn(new ComponentRenderer<>(
                            evenementIncubationLot -> {
                                //ComboBox comboBox = new ComboBox();
                ...
                Grid.Column<ZZZEvenementIncubationLot> cohorteColumn = this.grid.addColumn(new ComponentRenderer<>(
                            evenementIncubationLot -> {
                                //ComboBox comboBox = new ComboBox();
                ...
                Grid.Column<ZZZEvenementIncubationLot> programmeColumn = this.grid.addColumn(new ComponentRenderer<>(
                            evenementIncubationLot -> {
                                //ComboBox comboBox = new ComboBox();
                ...
                Grid.Column<ZZZEvenementIncubationLot> libelleEvenementColumn = this.grid.addColumn(ZZZEvenementIncubationLot::getLibelleEvenement).setKey("LibelleEvenement").setHeader("Objet").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("225px"); // fixed column
                Grid.Column<ZZZEvenementIncubationLot> coutColumn = this.grid.addColumn(new NumberRenderer<>(ZZZEvenementIncubationLot::getCout, NumberFormat.getIntegerInstance(Locale.FRENCH))).setKey("Cout").setHeader("Coût").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("250px"); // fixed column
                Grid.Column<ZZZEvenementIncubationLot> nombreHeureColumn = this.grid.addColumn(new NumberRenderer<>(ZZZEvenementIncubationLot::getNombreHeure, NumberFormat.getIntegerInstance(Locale.FRENCH))).setKey("NombreHeure").setHeader("Nombre d'Heure").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("250px"); // fixed column
                Grid.Column<ZZZEvenementIncubationLot> noPieceColumn = this.grid.addColumn(ZZZEvenementIncubationLot::getNoPiece).setKey("NoPiece").setHeader("N° Pièce").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("125px"); // fixed column
                Grid.Column<ZZZEvenementIncubationLot> observationsColumn = this.grid.addColumn(ZZZEvenementIncubationLot::getObservations).setKey("Observations").setHeader("Observations").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("225px"); // fixed column
        ...
        {
            MessageDialogHelper.showAlertDialog("AfficherEvenementIncubationLotDialog.configureGridWithFilters", e.toString());
            e.printStackTrace();
        }
    }    
    ...
    private void applyFilterToTheGrid() {
        try 
        {
            ...
            this.dataProvider.setFilter(item -> {
                ...
                */
                ...
                return isExerciceFilterMatch && isUtilisateurFilterMatch && isNoChronoFilterMatch && isDateEvenementFilterMatch && isCentreIncubateurFilterMatch && isTypeEvenementFilterMatch && isCohorteFilterMatch && isProgrammeFilterMatch && isLibelleEvenementFilterMatch && isCoutFilterMatch && isNombreHeureFilterMatch && isNoPieceFilterMatch && isObservationsFilterMatch;
            });
        ...
        {
            MessageDialogHelper.showAlertDialog("AfficherEvenementIncubationLotDialog.applyFilterToTheGrid", e.toString());
            e.printStackTrace();
        }
    }
    ...
    protected ArrayList<ZZZEvenementIncubationLot> workingFetchItems() {
        ...
        {
            //1 - Fetch the items
                return (ArrayList)this.evenementIncubationLotBusiness.getBrouillardData(this.codeCentreIncubateurCible);
        } 
        catch (Exception e) 
        {
            MessageDialogHelper.showAlertDialog("AfficherEvenementIncubationLotDialog.workingFetchItems", e.toString());
            e.printStackTrace();
            return (null);
        }
    ...
    @Override
    public void publishLoadEvent(ZZZEvenementIncubationLot selectedItem) {
        //Publish Load Event
        try 
        {
            this.uiEventBus.publish(this, new EvenementIncubationLotLoadEvent(this.dialog, selectedItem));
        } 
        catch (Exception e) 
        {
            MessageDialogHelper.showAlertDialog("AfficherEvenementIncubationLotDialog.publishLoadEvent", e.toString());
            e.printStackTrace();
        }
    }
    ...
    public static abstract class AfficherEvenementIncubationLotDialogEvent extends ComponentEvent<Dialog> {
        private ZZZEvenementIncubationLot evenementIncubationLot;

        protected AfficherEvenementIncubationLotDialogEvent(Dialog source, ZZZEvenementIncubationLot argEvenementIncubationLot) {
            /* The second constructor parameter determines whether the event is triggered 
            by a DOM event in the browser 
            or through the component’s server-side API. */
            super(source, false); //Use false as the second constructor parameter to indicate that the event does not come from the client
            this.evenementIncubationLot = argEvenementIncubationLot;
        }

        public ZZZEvenementIncubationLot getEvenementIncubationLot() {
            return evenementIncubationLot;
        }
    }

    public static class EvenementIncubationLotLoadEvent extends AfficherEvenementIncubationLotDialogEvent {
        public EvenementIncubationLotLoadEvent(Dialog source, ZZZEvenementIncubationLot evenementIncubationLot) {
