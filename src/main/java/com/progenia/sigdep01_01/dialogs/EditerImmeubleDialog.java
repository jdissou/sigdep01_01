 ...
 */
public class EditerImmeubleDialog extends BaseEditerReferentielMaitreFormDialog<ZZZImmeuble> {
    /***
    ...
    */
    ...
    private ArrayList<ZZZLocalisation> localisationList = new ArrayList<ZZZLocalisation>();
    private ListDataProvider<ZZZLocalisation> localisationDataProvider;

    /* Fields to edit properties in ZZZImmeuble entity */
    ...
    //ComboBox<TypeImmeuble> cboCodeTypeImmeuble = new ComboBox<>("Type ZZZImmeuble");
    ...
    ComboBox<ZZZLocalisation> cboCodeLocalisation = new ComboBox<>();
    //ComboBox<ZZZLocalisation> cboCodeLocalisation = new ComboBox<>("ZZZLocalisation");
    ...
    public EditerImmeubleDialog() {
        ...
        super();
        this.binder = new BeanValidationBinder<>(ZZZImmeuble.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<ZZZImmeuble> targetBeanList, ArrayList<ZZZImmeuble> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus, TypeImmeubleBusiness typeImmeubleBusiness, LocalisationBusiness localisationBusiness) {
        ...
        try 
        {
            ...
            this.localisationDataProvider.setSortOrder(ZZZLocalisation::getLibelleLocalisation, SortDirection.ASCENDING);
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(ZZZImmeuble::getCodeImmeuble));
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.cboCodeTypeImmeuble.addValueChangeListener(event -> {
                if (event.getValue() != null) {
                    ...
                    if (event.getValue().isInactif() == true) {
                        MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Le Type ZZZImmeuble choisi est actuellement désactivé. Veuillez en saisir un autre.");
                        //Cancel
            ...
            this.cboCodeLocalisation.setItemLabelGenerator(ZZZLocalisation::getLibelleLocalisation);
            this.cboCodeLocalisation.setRequired(true);
            this.cboCodeLocalisation.setRequiredIndicatorVisible(true);
            //???this.cboCodeLocalisation.setLabel("ZZZLocalisation");
            ...
            this.cboCodeLocalisation.addValueChangeListener(event -> {
                if (event.getValue() != null) {
                    ...
                    if (event.getValue().isInactif() == true) {
                        MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La ZZZLocalisation choisie est actuellement désactivée. Veuillez en saisir un autre.");
                        //Cancel
            ...
            this.binder.forField(this.txtCodeImmeuble)
                .asRequired("La Saisie du Code ZZZImmeuble est Obligatoire. Veuillez saisir le Code ZZZImmeuble.")
                .withValidator(text -> text != null && text.length() <= 2, "Code ZZZImmeuble ne peut contenir au plus 2 caractères")
                ...
                .bind(ZZZImmeuble::getCodeImmeuble, ZZZImmeuble::setCodeImmeuble);
            
            Label lblLibelleImmeubleValidationStatus = new Label();
            this.binder.forField(this.txtLibelleImmeuble)
                .withValidator(text -> text.length() <= 50, "Libellé ZZZImmeuble ne peut contenir au plus 50 caractères.")
                ...
                .bind(ZZZImmeuble::getLibelleImmeuble, ZZZImmeuble::setLibelleImmeuble);
            
            Label lblLibelleCourtImmeubleValidationStatus = new Label();
            this.binder.forField(this.txtLibelleCourtImmeuble)
                .withValidator(text -> text.length() <= 20, "Libellé Abrégé ZZZImmeuble ne peut contenir au plus 20 caractères.")
                ...
                .bind(ZZZImmeuble::getLibelleCourtImmeuble, ZZZImmeuble::setLibelleCourtImmeuble);

            Label lblTypeImmeubleValidationStatus = new Label();
            this.binder.forField(this.cboCodeTypeImmeuble)
                    .asRequired("La Saisie du Type ZZZImmeuble est requise. Veuillez sélectionner un Type ZZZImmeuble")
                    .bind(ZZZImmeuble::getTypeImmeuble, ZZZImmeuble::setTypeImmeuble);
            ...
            this.binder.forField(this.txtSuperficie)
                    ...
                    .bind(ZZZImmeuble::getSuperficie, ZZZImmeuble::setSuperficie);
            ...
            this.binder.forField(this.txtAdresse)
                    ...
                    .bind(ZZZImmeuble::getAdresse, ZZZImmeuble::setAdresse);
            ...
            this.binder.forField(this.txtVille)
                    ...
                    .bind(ZZZImmeuble::getVille, ZZZImmeuble::setVille);

            Label lblLocalisationValidationStatus = new Label();
            this.binder.forField(this.cboCodeLocalisation)
                    .asRequired("La Saisie de la ZZZLocalisation est requise. Veuillez sélectionner une ZZZLocalisation")
                    .bind(ZZZImmeuble::getLocalisation, ZZZImmeuble::setLocalisation);

            this.binder.forField(this.chkInactif)
                .bind(ZZZImmeuble::isInactif, ZZZImmeuble::setInactif);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in ZZZImmeuble and ImmeubleView based on their names.
            */
            ...
            //4 - Alternative
            this.formLayout.addFormItem(this.txtCodeImmeuble, "Code ZZZImmeuble :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleImmeuble, "Libellé ZZZImmeuble :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleCourtImmeuble, "Libellé Abrégé ZZZImmeuble :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.cboCodeTypeImmeuble, "Type ZZZImmeuble :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            ...
            this.formLayout.addFormItem(this.cboCodeLocalisation, "ZZZLocalisation :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
    ...
    {
        //Ajoute un nouveau Type ZZZImmeuble en entrant un libellé dans la zone de liste modifiable CodeTypeImmeuble.
        ...
        try
        {
            if (SecurityService.getInstance().isAccessGranted("EditerTypeImmeubleDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> noClickListener = ev -> {
                    //Ajout non accompli
                    MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie du Type ZZZImmeuble est requise. Veuillez en saisir un.");
                ...
                ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                    ...
                    EditerTypeImmeubleDialog.getInstance().showDialog("Ajout de Type ZZZImmeuble", ModeFormulaireEditerEnum.AJOUTERCIF, new ArrayList<TypeImmeuble>(), this.typeImmeubleList, finalNewVal, this.uiEventBus);
                };

                // Affiche une boîte de confirmation demandant si l'utilisateur désire ajouter un nouveau Type Instrument.
                MessageDialogHelper.showYesNoDialog("Le Type ZZZImmeuble '" + strNewVal + "' n'est pas dans la liste.", "Désirez-vous ajouter un nouveau Type ZZZImmeuble?. Cliquez sur Oui pour confirmer l'ajout.", yesClickListener, noClickListener);
            }
            else {
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie du Type ZZZImmeuble est requise. Veuillez en saisir un.");
            } //if (SecurityService.getInstance().isAccessGranted("EditerTypeImmeubleDialog") == true) {
    ...
    {
        //Ajoute une nouvelle ZZZLocalisation en entrant un libellé dans la zone de liste modifiable CodeLocalisation.
        String strNewVal = strProposedVal;
        ...
        try
        {
            if (SecurityService.getInstance().isAccessGranted("EditerLocalisationDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> noClickListener = ev -> {
                    //Ajout non accompli
                    MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la ZZZLocalisation est requise. Veuillez en saisir un.");
                    //Cancel - Il ne vaut pas la peine d'appeler clear ou setValue (null) sur le composant (ce qui revient au même). Le ComboBox a déjà une valeur nulle
                };
                ...
                ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                    ...
                    EditerLocalisationDialog.getInstance().showDialog("Ajout de ZZZLocalisation", ModeFormulaireEditerEnum.AJOUTERCIF, new ArrayList<ZZZLocalisation>(), this.localisationList, finalNewVal, this.uiEventBus);
                };

                // Affiche une boîte de confirmation demandant si l'utilisateur désire ajouter un nouveau Type Instrument.
                MessageDialogHelper.showYesNoDialog("La ZZZLocalisation '" + strNewVal + "' n'est pas dans la liste.", "Désirez-vous ajouter une nouvelle ZZZLocalisation?. Cliquez sur Oui pour confirmer l'ajout.", yesClickListener, noClickListener);
            }
            else {
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la ZZZLocalisation est requise. Veuillez en saisir un.");
            } //if (SecurityService.getInstance().isAccessGranted("EditerLocalisationDialog") == true) {
    ...
    private void handleLocalisationAddEventFromDialog(LocalisationAddEvent event) {
        //Handle Ajouter ZZZLocalisation Add Event received from Dialog
        //Ajouté à cause du CIF
        try
        {
            //1 - Sauvegarder la modification dans le backend
            ZZZLocalisation newInstance = this.localisationBusiness.save(event.getLocalisation());
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            if (this.referenceBeanList.stream()
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Risque de Doublons dans champ clé principale. Veuillez en saisir un autre Code ZZZImmeuble.");
    ...
    @Override
    public ZZZImmeuble workingCreateNewBeanInstance()
    {
        return (new ZZZImmeuble());
    }
    ...
    public static abstract class EditerImmeubleDialogEvent extends ComponentEvent<Dialog> {
        private ZZZImmeuble indicateurSuivi;

        protected EditerImmeubleDialogEvent(Dialog source, ZZZImmeuble argImmeuble) {
