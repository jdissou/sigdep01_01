 ...
 */
public class EditerLocalisationDialog extends BaseEditerReferentielMaitreFormDialog<ZZZLocalisation> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in ZZZLocalisation entity */
    ...
    public EditerLocalisationDialog() {
        super();
        this.binder = new BeanValidationBinder<>(ZZZLocalisation.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<ZZZLocalisation> targetBeanList, ArrayList<ZZZLocalisation> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(ZZZLocalisation::getCodeLocalisation));
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.binder.forField(this.txtCodeLocalisation)
                .asRequired("La Saisie du Code ZZZLocalisation est Obligatoire. Veuillez saisir le Code ZZZLocalisation.")
                .withValidator(text -> text != null && text.length() <= 10, "Code ZZZLocalisation ne peut contenir au plus 10 caractères")
                ...
                .bind(ZZZLocalisation::getCodeLocalisation, ZZZLocalisation::setCodeLocalisation);
            
            Label lblLibelleLocalisationValidationStatus = new Label();
            this.binder.forField(this.txtLibelleLocalisation)
                .withValidator(text -> text.length() <= 50, "Libellé ZZZLocalisation ne peut contenir au plus 50 caractères.")
                ...
                .bind(ZZZLocalisation::getLibelleLocalisation, ZZZLocalisation::setLibelleLocalisation);
            
            Label lblLibelleCourtLocalisationValidationStatus = new Label();
            this.binder.forField(this.txtLibelleCourtLocalisation)
                .withValidator(text -> text.length() <= 20, "Libellé Abrégé ZZZLocalisation ne peut contenir au plus 20 caractères.")
                ...
                .bind(ZZZLocalisation::getLibelleCourtLocalisation, ZZZLocalisation::setLibelleCourtLocalisation);
            
            this.binder.forField(this.chkInactif)
                .bind(ZZZLocalisation::isInactif, ZZZLocalisation::setInactif);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in ZZZLocalisation and LocalisationView based on their names.
            */
            ...
            //4 - Alternative
            this.formLayout.addFormItem(this.txtCodeLocalisation, "Code ZZZLocalisation :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleLocalisation, "Libellé ZZZLocalisation :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleCourtLocalisation, "Libellé Abrégé ZZZLocalisation :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
...
@Override
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            if (this.referenceBeanList.stream()
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Risque de Doublons dans champ clé principale. Veuillez en saisir un autre Code ZZZLocalisation.");
    ...
    @Override
    public ZZZLocalisation workingCreateNewBeanInstance()
    {
        return (new ZZZLocalisation());
    }
    ...
    public static abstract class EditerLocalisationDialogEvent extends ComponentEvent<Dialog> {
        private ZZZLocalisation competence;

        protected EditerLocalisationDialogEvent(Dialog source, ZZZLocalisation argLocalisation) {
