 ...
 */
public class EditerStandingDialog extends BaseEditerReferentielMaitreFormDialog<ObjetDette> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in ObjetDette entity */
    ...
    public EditerStandingDialog() {
        super();
        this.binder = new BeanValidationBinder<>(ObjetDette.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<ObjetDette> targetBeanList, ArrayList<ObjetDette> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(ObjetDette::getCodeStanding));
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.binder.forField(this.txtCodeStanding)
                .asRequired("La Saisie du Code ObjetDette est Obligatoire. Veuillez saisir le Code ObjetDette.")
                .withValidator(text -> text != null && text.length() <= 2, "Code ObjetDette ne peut contenir au plus 2 caractères")
                ...
                .bind(ObjetDette::getCodeStanding, ObjetDette::setCodeStanding);
            
            Label lblLibelleStandingValidationStatus = new Label();
            this.binder.forField(this.txtLibelleStanding)
                .withValidator(text -> text.length() <= 50, "Libellé ObjetDette ne peut contenir au plus 50 caractères.")
                ...
                .bind(ObjetDette::getLibelleStanding, ObjetDette::setLibelleStanding);
            
            Label lblLibelleCourtStandingValidationStatus = new Label();
            this.binder.forField(this.txtLibelleCourtStanding)
                .withValidator(text -> text.length() <= 20, "Libellé Abrégé ObjetDette ne peut contenir au plus 20 caractères.")
                ...
                .bind(ObjetDette::getLibelleCourtStanding, ObjetDette::setLibelleCourtStanding);
            
            this.binder.forField(this.chkInactif)
                .bind(ObjetDette::isInactif, ObjetDette::setInactif);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in ObjetDette and StandingView based on their names.
            */
            ...
            //4 - Alternative
            this.formLayout.addFormItem(this.txtCodeStanding, "Code ObjetDette :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleStanding, "Libellé ObjetDette :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleCourtStanding, "Libellé Abrégé ObjetDette :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
...
@Override
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            if (this.referenceBeanList.stream()
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Risque de Doublons dans champ clé principale. Veuillez en saisir un autre Code ObjetDette.");
    ...
    @Override
    public ObjetDette workingCreateNewBeanInstance()
    {
        return (new ObjetDette());
    }
    ...
    public static abstract class EditerStandingDialogEvent extends ComponentEvent<Dialog> {
        private ObjetDette competence;

        protected EditerStandingDialogEvent(Dialog source, ObjetDette argStanding) {
