...
import com.progenia.sigdep01_01.dialogs.EditerNatureIndicateurDialog.NatureIndicateurAddEvent;
        ...
        try 
        {
            if (SecurityService.getInstance().isAccessGranted("EditerUniteOeuvreDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                    ...
                    EditerUniteOeuvreDialog.getInstance().showDialog("Ajout d'Unité d'Oeuvre", ModeFormulaireEditerEnum.AJOUTERCIF, new ArrayList<SecteurEconomique>(), this.uniteOeuvreList, finalNewVal, this.uiEventBus);
                };
