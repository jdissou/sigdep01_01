...
import com.progenia.sigdep01_01.dialogs.EditerTypePartenaireDialog.TypePartenaireAddEvent;
 ...
 */
public class EditerPartenaireDialog extends BaseEditerReferentielMaitreFormDialog<Creancier> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in Creancier entity */
    ...
    //private ComboBox<TypePartenaire> cboCodeTypePartenaire = new ComboBox<>("Type Creancier");
    ...
    public EditerPartenaireDialog() {
        ...
        super();
        this.binder = new BeanValidationBinder<>(Creancier.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<Creancier> targetBeanList, ArrayList<Creancier> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus, TypePartenaireBusiness typePartenaireBusiness) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(Creancier::getCodePartenaire));
        ...
        try 
        {
            ...
            this.cboCodeTypePartenaire.addValueChangeListener(event -> {
                if (event.getValue() != null) {
                    ...
                    if (event.getValue().isInactif() == true) {
                        MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Le Type Creancier choisi est actuellement désactivé. Veuillez en saisir un autre.");
                        //Cancel
            ...
            */
            ...
            this.binder.forField(this.txtCodePartenaire)
                .asRequired("La Saisie du Code Creancier est Obligatoire. Veuillez saisir le Code Creancier.")
                .withValidator(text -> text != null && text.length() <= 10, "Code Creancier ne peut contenir au plus 10 caractères")
                ...
                .bind(Creancier::getCodePartenaire, Creancier::setCodePartenaire);
            
            Label lblLibellePartenaireValidationStatus = new Label();
            this.binder.forField(this.txtLibellePartenaire)
                .withValidator(text -> text.length() <= 50, "Dénomination Creancier ne peut contenir au plus 50 caractères.")
                ...
                .bind(Creancier::getLibellePartenaire, Creancier::setLibellePartenaire);
            
            Label lblLibelleCourtPartenaireValidationStatus = new Label();
            this.binder.forField(this.txtLibelleCourtPartenaire)
                .withValidator(text -> text.length() <= 20, "Dénomination Abrégée Creancier ne peut contenir au plus 20 caractères.")
                ...
                .bind(Creancier::getLibelleCourtPartenaire, Creancier::setLibelleCourtPartenaire);
            
            Label lblTypePartenaireValidationStatus = new Label();
            this.binder.forField(this.cboCodeTypePartenaire)
                //Saisie Optionnelle - .asRequired("La Saisie du Type de Creancier est requise. Veuillez sélectionner un TypePartenaire")
                .bind(Creancier::getTypePartenaire, Creancier::setTypePartenaire);
            ...
            this.binder.forField(this.txtAdresse)
                ...
                .bind(Creancier::getAdresse, Creancier::setAdresse);
            ...
            this.binder.forField(this.txtVille)
                ...
                .bind(Creancier::getVille, Creancier::setVille);
            ...
            this.binder.forField(this.txtNoTelephone)
                ...
                .bind(Creancier::getNoTelephone, Creancier::setNoTelephone);
            ...
            this.binder.forField(this.txtNoMobile)
                ...
                .bind(Creancier::getNoMobile, Creancier::setNoMobile);
            ...
            this.binder.forField(this.txtEmail)
                ...
                .bind(Creancier::getEmail, Creancier::setEmail);

            this.binder.forField(this.chkInactif)
                .bind(Creancier::isInactif, Creancier::setInactif);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in Creancier and PartenaireView based on their names.
            */
            ...
            //4 - Alternative
            this.formLayout.addFormItem(this.txtCodePartenaire, "Code Creancier :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibellePartenaire, "Dénomination Creancier :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleCourtPartenaire, "Dénomination Abrégée Creancier :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.cboCodeTypePartenaire, "Type Creancier :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
    ...
    {
        //Ajoute un nouveau Type de Creancier en entrant un libellé dans la zone de liste modifiable CodeTypePartenaire.
        ...
        try 
        {
            if (SecurityService.getInstance().isAccessGranted("EditerTypePartenaireDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> noClickListener = ev -> {
                    //Ajout non accompli
                    MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie du Type de Creancier est requise. Veuillez en saisir un.");
                ...
                ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                    ...
                    if (strNewVal.length() > intMaxFieldLength) {
                        MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Le libellé est trop long. Les libellés de Type Creancier ne peuvent dépasser " + intMaxFieldLength + " caractères. Le Libellé que vous avez introduit sera tronqué.");
                    ...
                    EditerTypePartenaireDialog.getInstance().showDialog("Ajout de Type Creancier", ModeFormulaireEditerEnum.AJOUTERCIF, new ArrayList<TypePartenaire>(), this.typePartenaireList, finalNewVal, this.uiEventBus);
                };

                // Affiche une boîte de confirmation demandant si l'utilisateur désire ajouter un nouveau Type de Creancier.
                MessageDialogHelper.showYesNoDialog("Le Type Creancier '" + strNewVal + "' n'est pas dans la liste.", "Désirez-vous ajouter un nouveau Type de Creancier?. Cliquez sur Oui pour confirmer l'ajout.", yesClickListener, noClickListener);
            }
            else {
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie du Type de Creancier est requise. Veuillez en saisir un.");
            } //if (SecurityService.getInstance().isAccessGranted("EditerTypePartenaireDialog") == true) {
...
@Override
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            if (this.referenceBeanList.stream()
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Risque de Doublons dans champ clé principale. Veuillez en saisir un autre Code Creancier.");
    ...
    @Override
    public Creancier workingCreateNewBeanInstance()
    {
    ...
    public static abstract class EditerPartenaireDialogEvent extends ComponentEvent<Dialog> {
        private Creancier partenaire;

        protected EditerPartenaireDialogEvent(Dialog source, Creancier argPartenaire) {
