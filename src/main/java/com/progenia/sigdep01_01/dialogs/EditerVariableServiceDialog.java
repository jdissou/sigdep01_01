...
public class EditerVariableServiceDialog extends BaseEditerReferentielMaitreFormDialog<VariableService> {
    ...
    */
    ...
    private ArrayList<SystemeTypeTauxInteret> typeVariableList = new ArrayList<SystemeTypeTauxInteret>();
    private ListDataProvider<SystemeTypeTauxInteret> typeVariableDataProvider;
    
    //CIF
    private SecteurEconomiqueBusiness uniteOeuvreBusiness;
    private ArrayList<SecteurEconomique> uniteOeuvreList = new ArrayList<SecteurEconomique>();
    private ListDataProvider<SecteurEconomique> uniteOeuvreDataProvider;
    ...
    ComboBox<SystemeTypeTauxInteret> cboCodeTypeVariable = new ComboBox<>();
    //ComboBox<SystemeTypeTauxInteret> cboCodeTypeVariable = new ComboBox<>("Type de Variable");
    ComboBox<SecteurEconomique> cboCodeUniteOeuvre = new ComboBox<>();
    //ComboBox<SecteurEconomique> cboCodeUniteOeuvre = new ComboBox<>("Unité d'Oeuvre");
    ...
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<VariableService> targetBeanList, ArrayList<VariableService> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus, SystemeTypeTauxInteretBusiness typeVariableBusiness, SecteurEconomiqueBusiness uniteOeuvreBusiness) {
        ...
        try 
        {
            ...
            this.typeVariableDataProvider.setSortOrder(SystemeTypeTauxInteret::getLibelleTypeVariable, SortDirection.ASCENDING);
            ...
            this.uniteOeuvreDataProvider.setSortOrder(SecteurEconomique::getLibelleUniteOeuvre, SortDirection.ASCENDING);
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            // Choose which property from SystemeTypeTauxInteret is the presentation value
            this.cboCodeTypeVariable.setItemLabelGenerator(SystemeTypeTauxInteret::getLibelleTypeVariable);
            ...
            */
            ...
            this.cboCodeUniteOeuvre.setItemLabelGenerator(SecteurEconomique::getLibelleUniteOeuvre);
            this.cboCodeUniteOeuvre.setRequired(true);
            this.cboCodeUniteOeuvre.setRequiredIndicatorVisible(true);
            //???this.cboCodeUniteOeuvre.setLabel("SecteurEconomique");
        ...
        try 
        {
            if (SecurityService.getInstance().isAccessGranted("EditerTypeVariableDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                    ...
                    EditerTypeVariableDialog.getInstance().showDialog("Ajout de Type de Variable", ModeFormulaireEditerEnum.AJOUTERCIF, new ArrayList<SystemeTypeTauxInteret>(), this.typeVariableList, finalNewVal, this.uiEventBus);
                };
    ...
    private void handleTypeVariableAddEventFromDialog(SystemeTypeVariableAddEvent event) {
        //Handle Ajouter SystemeTypeTauxInteret Add Event received from Dialog
        //Ajouté à cause du CIF
        try 
        {
            //1 - Sauvegarder la modification dans le backend
            SystemeTypeTauxInteret newInstance = this.typeVariableBusiness.save(event.getTypeVariable());
    ...
    */
        ...
        try 
        {
            if (SecurityService.getInstance().isAccessGranted("EditerUniteOeuvreDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                    ...
                    EditerUniteOeuvreDialog.getInstance().showDialog("Ajout de Unité d'Oeuvre", ModeFormulaireEditerEnum.AJOUTERCIF, new ArrayList<SecteurEconomique>(), this.uniteOeuvreList, finalNewVal, this.uiEventBus);
                };
    ...
    private void handleUniteOeuvreAddEventFromDialog(UniteOeuvreAddEvent event) {
        //Handle Ajouter SecteurEconomique Add Event received from Dialog
        //Ajouté à cause du CIF
        try 
        {
            //1 - Sauvegarder la modification dans le backend
            SecteurEconomique newInstance = this.uniteOeuvreBusiness.save(event.getUniteOeuvre());
