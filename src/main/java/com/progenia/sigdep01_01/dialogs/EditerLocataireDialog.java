 ...
 */
public class EditerLocataireDialog extends BaseEditerReferentielMaitreTabDialog<Commission> {
    /***
    ...
    */
    ...
    private static final String CACHED_SELECTED_TAB_INDEX = "EditerLocataireDialogSelectedTab";

    //CIF
    private CategorieInstrumentBusiness categorieLocataireBusiness;
    private ArrayList<CategorieInstrument> categorieLocataireList = new ArrayList<CategorieInstrument>();
    private ListDataProvider<CategorieInstrument> categorieLocataireDataProvider;
    
    //CIF
    private MonnaieBusiness nationaliteBusiness;
    private ArrayList<Monnaie> nationaliteList = new ArrayList<Monnaie>();
    private ListDataProvider<Monnaie> nationaliteDataProvider;
    ...
    /* Fields to edit properties in Commission entity */
    ...
    private ComboBox<CategorieInstrument> cboCodeCategorieLocataire = new ComboBox<>();
    //private ComboBox<CategorieInstrument> cboCodeCategorieLocataire = new ComboBox<>("Catégorie Commission");
    private ComboBox<Monnaie> cboCodeNationalite = new ComboBox<>();
    //private ComboBox<Monnaie> cboCodeNationalite = new ComboBox<>("Nationalité");
    ...
    public EditerLocataireDialog() {
        ...
        super();
        this.binder = new BeanValidationBinder<>(Commission.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<Commission> targetBeanList, ArrayList<Commission> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus, CategorieInstrumentBusiness categorieLocataireBusiness, MonnaieBusiness nationaliteBusiness, ProfessionBusiness professionBusiness, TitreCiviliteBusiness titreCiviliteBusiness, CompteBusiness compteBusiness) {
        ...
        try 
        {
            ...
            this.uiEventBus.subscribe(this, false);//Use false as the second constructor parameter to indicate that the event does not come from the Instrument
            ...
            this.categorieLocataireDataProvider.setSortOrder(CategorieInstrument::getLibelleCategorieLocataire, SortDirection.ASCENDING);
            ...
            this.nationaliteDataProvider.setSortOrder(Monnaie::getLibelleNationalite, SortDirection.ASCENDING);
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(Commission::getCodeLocataire));
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.cboCodeCategorieLocataire.setItemLabelGenerator(CategorieInstrument::getLibelleCategorieLocataire);
            this.cboCodeCategorieLocataire.setRequired(true);
            this.cboCodeCategorieLocataire.setRequiredIndicatorVisible(true);
            //???this.cboCodeCategorieLocataire.setLabel("CategorieInstrument");
            ...
            this.cboCodeCategorieLocataire.addValueChangeListener(event -> {
                if (event.getValue() != null) {
                    ...
                    if (event.getValue().isInactif() == true) {
                        MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Catégorie Commission choisie est actuellement désactivée. Veuillez en saisir une autre.");
                        //Cancel
            ...
            */
            ...
            // Choose which property from Monnaie is the presentation value
            this.cboCodeNationalite.setItemLabelGenerator(Monnaie::getLibelleNationalite);
            this.cboCodeNationalite.setRequired(true);
            this.cboCodeNationalite.setRequiredIndicatorVisible(true);
            //???this.cboCodeNationalite.setLabel("Monnaie");
            ...
            */
            ...
            this.binder.forField(this.txtCodeLocataire)
                .asRequired("La Saisie du Code Commission est Obligatoire. Veuillez saisir le Code Commission.")
                .withValidator(text -> text != null && text.length() <= 10, "Code Commission ne peut contenir au plus 10 caractères")
                ...
                .bind(Commission::getCodeLocataire, Commission::setCodeLocataire);
            
            Label lblLibelleLocataireValidationStatus = new Label();
            this.binder.forField(this.txtLibelleLocataire)
                .withValidator(text -> text.length() <= 50, "Dénomination Commission ne peut contenir au plus 50 caractères.")
                ...
                .bind(Commission::getLibelleLocataire, Commission::setLibelleLocataire);
            ...
            this.binder.forField(this.txtLieuNaissance)
                ...
                .bind(Commission::getLieuNaissance, Commission::setLieuNaissance);
            ...
            this.binder.forField(this.txtAdresse)
                ...
                .bind(Commission::getAdresse, Commission::setAdresse);
            ...
            this.binder.forField(this.txtVille)
                ...
                .bind(Commission::getVille, Commission::setVille);
            ...
            this.binder.forField(this.txtNoTelephone)
                ...
                .bind(Commission::getNoTelephone, Commission::setNoTelephone);
            ...
            this.binder.forField(this.txtNoMobile)
                ...
                .bind(Commission::getNoMobile, Commission::setNoMobile);
            ...
            this.binder.forField(this.txtEmail)
                    ...
                    .bind(Commission::getEmail, Commission::setEmail);
            ...
            this.binder.forField(this.txtNoIFU)
                    ...
                    .bind(Commission::getNoIFU, Commission::setNoIFU);

            this.binder.forField(this.chkInactif)
                .bind(Commission::isInactif, Commission::setInactif);

            
            Label lblCategorieLocataireValidationStatus = new Label();
            this.binder.forField(this.cboCodeCategorieLocataire)
                .asRequired("La Saisie de la Catégorie de Commission est requise. Veuillez sélectionner une Catégorie de Commission")
                .bind(Commission::getCategorieLocataire, Commission::setCategorieLocataire);
            ...
            this.binder.forField(this.cboCodeNationalite)
                ...
                .bind(Commission::getNationalite, Commission::setNationalite);
            ...
            this.binder.forField(this.cboCodeProfession)
                ...
                .bind(Commission::getProfession, Commission::setProfession);
            ...
            this.binder.forField(this.cboCodeTitreCivilite)
                ...
                .bind(Commission::getTitreCivilite, Commission::setTitreCivilite);
            ...
            this.binder.forField(this.cboNoCompteClient)
                ...
                .bind(Commission::getCompteClient, Commission::setCompteClient);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in Commission and LocataireView based on their names.
            */
            ...
            //4 - Alternative
            this.tabInfoGeneraleFormLayout.addFormItem(this.txtCodeLocataire, "Code Commission :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH200);
            this.tabInfoGeneraleFormLayout.addFormItem(this.txtLibelleLocataire, "Dénomination Commission :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH200);
            ...
            this.tabQualificationFormLayout.addFormItem(this.cboCodeCategorieLocataire, "Catégorie Commission :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH200);
    ...
    {
        //Ajoute une nouvelle Catégorie de Commission en entrant un libellé dans la zone de liste modifiable CodeCategorieLocataire.
        ...
        try 
        {
            if (SecurityService.getInstance().isAccessGranted("EditerCategorieLocataireDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> noClickListener = ev -> {
                    //Ajout non accompli
                    MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Catégorie de Commission est requise. Veuillez en saisir une.");
                ...
                ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                    ...
                    if (strNewVal.length() > intMaxFieldLength) {
                        MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Le libellé est trop long. Les libellés de Catégorie de Commission ne peuvent dépasser " + intMaxFieldLength + " caractères. Le Libellé que vous avez introduit sera tronqué.");
                    ...
                    EditerCategorieLocataireDialog.getInstance().showDialog("Ajout de Catégorie de Commission", ModeFormulaireEditerEnum.AJOUTERCIF, new ArrayList<CategorieInstrument>(), this.categorieLocataireList, finalNewVal, this.uiEventBus, this.compteBusiness);
                };

                // Affiche une boîte de confirmation demandant si l'utilisateur désire ajouter une nouvelle Catégorie de Commission.
                MessageDialogHelper.showYesNoDialog("La Catégorie de Commission '" + strNewVal + "' n'est pas dans la liste.", "Désirez-vous ajouter une nouvelle Catégorie de Commission?. Cliquez sur Oui pour confirmer l'ajout.", yesClickListener, noClickListener);
            }
            else {
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "La Saisie de la Catégorie de Commission est requise. Veuillez en saisir un.");
            } //if (SecurityService.getInstance().isAccessGranted("EditerCategorieLocataireDialog") == true) {
        } 
        catch (Exception e) 
        {
        ...
        try 
        {
            if (SecurityService.getInstance().isAccessGranted("EditerNationaliteDialog") == true) {
                ...
                ComponentEventListener<ClickEvent<Button>> yesClickListener = ev -> {
                    ...
                    EditerNationaliteDialog.getInstance().showDialog("Ajout de Nationalité", ModeFormulaireEditerEnum.AJOUTERCIF, new ArrayList<Monnaie>(), this.nationaliteList, finalNewVal, this.uiEventBus);
                };
    ...
    private void handleCategorieLocataireAddEventFromDialog(EditerCategorieLocataireDialog.CategorieLocataireAddEvent event) {
        //Handle Ajouter CategorieInstrument Add Event received from Dialog
        //Ajouté à cause du CIF
        try 
        {
            //1 - Sauvegarder la modification dans le backend
            CategorieInstrument newInstance = this.categorieLocataireBusiness.save(event.getCategorieLocataire());
    ...
    private void handleNationaliteAddEventFromDialog(EditerNationaliteDialog.NationaliteAddEvent event) {
        //Handle Ajouter Monnaie Add Event received from Dialog
        //Ajouté à cause du CIF
        try 
        {
            //1 - Sauvegarder la modification dans le backend
            Monnaie newInstance = this.nationaliteBusiness.save(event.getNationalite());
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            if (this.referenceBeanList.stream()
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Risque de Doublons dans champ clé principale. Veuillez en saisir un autre Code Commission.");
    ...
    @Override
    public Commission workingCreateNewBeanInstance()
    {
    ...
    public static abstract class EditerLocataireDialogEvent extends ComponentEvent<Dialog> {
        private Commission Instrument;

        protected EditerLocataireDialogEvent(Dialog source, Commission argLocataire) {
            /* The second constructor parameter determines whether the event is triggered 
            by a DOM event in the browser 
            or through the component’s server-side API. */
            super(source, false); //Use false as the second constructor parameter to indicate that the event does not come from the client
            this.Instrument = argLocataire;
        }

        public Commission getLocataire() {
            return Instrument;
        }
    }

    public static class LocataireAddEvent extends EditerLocataireDialogEvent {
        public LocataireAddEvent(Dialog source, Commission Instrument) {
            super(source, Instrument);
        }
    }

    public static class LocataireUpdateEvent extends EditerLocataireDialogEvent {
        public LocataireUpdateEvent(Dialog source, Commission Instrument) {
            super(source, Instrument);
        }
    }
