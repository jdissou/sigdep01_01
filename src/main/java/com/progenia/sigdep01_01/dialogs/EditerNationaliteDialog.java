 ...
 */
public class EditerNationaliteDialog extends BaseEditerReferentielMaitreFormDialog<Monnaie> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in Monnaie entity */
    ...
    public EditerNationaliteDialog() {
        super();
        this.binder = new BeanValidationBinder<>(Monnaie.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<Monnaie> targetBeanList, ArrayList<Monnaie> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(Monnaie::getCodeNationalite));
    ...
    private void configureComponents() {
        ...
        try 
        {
            ...
            this.binder.forField(this.txtCodeNationalite)
                ...
                .bind(Monnaie::getCodeNationalite, Monnaie::setCodeNationalite);
            ...
            this.binder.forField(this.txtLibelleNationalite)
                ...
                .bind(Monnaie::getLibelleNationalite, Monnaie::setLibelleNationalite);
            ...
            this.binder.forField(this.txtLibelleCourtNationalite)
                ...
                .bind(Monnaie::getLibelleCourtNationalite, Monnaie::setLibelleCourtNationalite);
            
            this.binder.forField(this.chkInactif)
                .bind(Monnaie::isInactif, Monnaie::setInactif);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in Monnaie and NationaliteView based on their names.
            */
...
@Override
    ...
    @Override
    public Monnaie workingCreateNewBeanInstance()
    {
        return (new Monnaie());
    }
    ...
    public static abstract class EditerNationaliteDialogEvent extends ComponentEvent<Dialog> {
        private Monnaie nationalite;

        protected EditerNationaliteDialogEvent(Dialog source, Monnaie argNationalite) {
