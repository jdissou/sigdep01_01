 ...
 */
public class EditerCategorieLocataireDialog extends BaseEditerReferentielMaitreFormDialog<CategorieInstrument> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in CategorieInstrument entity */
    ...
    public EditerCategorieLocataireDialog() {
        ...
        super();
        this.binder = new BeanValidationBinder<>(CategorieInstrument.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ModeFormulaireEditerEnum modeFormulaireEditerEnum, ArrayList<CategorieInstrument> targetBeanList, ArrayList<CategorieInstrument> referenceBeanList, String newComboValue, EventBus.UIEventBus uiEventBus, CompteBusiness compteBusiness) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(CategorieInstrument::getCodeCategorieLocataire));
        ...
        try 
        {
            ...
            */
            ...
            this.binder.forField(this.txtCodeCategorieLocataire)
                .asRequired("La Saisie du Code Catégorie Commission est Obligatoire. Veuillez saisir le Code Catégorie Commission.")
                .withValidator(text -> text != null && text.length() <= 10, "Code Catégorie Commission ne peut contenir au plus 6 caractères")
                ...
                .bind(CategorieInstrument::getCodeCategorieLocataire, CategorieInstrument::setCodeCategorieLocataire);
            
            Label lblLibelleCategorieLocataireValidationStatus = new Label();
            this.binder.forField(this.txtLibelleCategorieLocataire)
                .withValidator(text -> text.length() <= 50, "Libellé Catégorie Commission ne peut contenir au plus 50 caractères.")
                ...
                .bind(CategorieInstrument::getLibelleCategorieLocataire, CategorieInstrument::setLibelleCategorieLocataire);
            ...
            this.binder.forField(this.txtLibelleCourtCategorieLocataire)
                .withValidator(text -> text.length() <= 20, "Libellé Abrégé Catégorie Commission ne peut contenir au plus 2 caractères.")
                ...
                .bind(CategorieInstrument::getLibelleCourtCategorieLocataire, CategorieInstrument::setLibelleCourtCategorieLocataire);
            ...
            this.binder.forField(this.cboNoCompteClient)
                ...
                .bind(CategorieInstrument::getCompteClient, CategorieInstrument::setCompteClient);
            
            this.binder.forField(this.chkInactif)
                .bind(CategorieInstrument::isInactif, CategorieInstrument::setInactif);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in CategorieInstrument and CategorieLocataireView based on their names.
            */
            ...
            //4 - Alternative
            this.formLayout.addFormItem(this.txtCodeCategorieLocataire, "Code Catégorie Commission :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleCategorieLocataire, "Libellé Catégorie Commission :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
            this.formLayout.addFormItem(this.txtLibelleCourtCategorieLocataire, "Référence Catégorie Commission :").getStyle().set("--vaadin-form-item-label-width", FORM_ITEM_LABEL_WIDTH250);
...
@Override
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            if (this.referenceBeanList.stream()
                ...
                MessageDialogHelper.showWarningDialog("Erreur de Saisie", "Risque de Doublons dans champ clé principale. Veuillez en saisir un autre Code Catégorie Commission.");
    ...
    @Override
    public CategorieInstrument workingCreateNewBeanInstance()
    {
        return (new CategorieInstrument());
    }
    ...
    public static abstract class EditerCategorieLocataireDialogEvent extends ComponentEvent<Dialog> {
        private CategorieInstrument categorieLocataire;

        protected EditerCategorieLocataireDialogEvent(Dialog source, CategorieInstrument argCategorieLocataire) {
        ...
        public CategorieInstrument getCategorieLocataire() {
            return categorieLocataire;
        }
    }

    public static class CategorieLocataireAddEvent extends EditerCategorieLocataireDialogEvent {
        public CategorieLocataireAddEvent(Dialog source, CategorieInstrument categorieLocataire) {
    ...
    public static class CategorieLocataireUpdateEvent extends EditerCategorieLocataireDialogEvent {
        public CategorieLocataireUpdateEvent(Dialog source, CategorieInstrument categorieLocataire) {
            super(source, categorieLocataire);
        }
    }
