 ...
 */
public class AfficherLotEcritureDialog extends BaseAfficherTransactionDialog<ZZZLotEcriture> {
    /***
    ...
    */
    ...
    /* Fields to filter items in ZZZLotEcriture entity */
    ...
    public void showDialog(String dialogTitle, EventBus.UIEventBus uiEventBus, ZZZCentreIncubateur centreIncubateurCible, LotEcritureBusiness lotEcritureBusiness, ExerciceBusiness exerciceBusiness, UtilisateurBusiness utilisateurBusiness, CentreIncubateurBusiness centreIncubateurBusiness, JournalBusiness journalBusiness, OperationComptableBusiness operationComptableBusiness, SystemeValidationBusiness validationComptaBusiness) {
        ...
        try 
        {
            ...
            */
            ...
            this.dataProvider.setSortOrder(ZZZLotEcriture::getNoBordereau, SortDirection.DESCENDING);
    ...
    private void configureGridWithFilters() {
        ...
        try 
        {
            ...
            if (this.grid.getColumnByKey("Exercice") == null) {
                ...
                Grid.Column<ZZZLotEcriture> exerciceColumn = this.grid.addColumn(new ComponentRenderer<>(
                            lotEcriture -> {
                ...
                Grid.Column<ZZZLotEcriture> utilisateurColumn = this.grid.addColumn(new ComponentRenderer<>(
                            lotEcriture -> {
                                //ComboBox comboBox = new ComboBox();
                ...
                Grid.Column<ZZZLotEcriture> centreIncubateurColumn = this.grid.addColumn(new ComponentRenderer<>(
                            lotEcriture -> {
                                //ComboBox comboBox = new ComboBox();
                ...
                Grid.Column<ZZZLotEcriture> journalColumn = this.grid.addColumn(new ComponentRenderer<>(
                            lotEcriture -> {
                                //ComboBox comboBox = new ComboBox();
                ...
                ).setKey("ZZZJournal").setHeader("Code ZZZJournal").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("150px"); // fixed column

                Grid.Column<ZZZLotEcriture> operationComptableColumn = this.grid.addColumn(new ComponentRenderer<>(
                            lotEcriture -> {
                                //ComboBox comboBox = new ComboBox();
                ...
                Grid.Column<ZZZLotEcriture> validationComptaColumn = this.grid.addColumn(new ComponentRenderer<>(
                            lotEcriture -> {
                                //ComboBox comboBox = new ComboBox();
    ...
    @Override
    public void publishLoadEvent(ZZZLotEcriture selectedItem) {
        //Publish Load Event
        try 
        {
    ...
    public static abstract class AfficherLotEcritureDialogEvent extends ComponentEvent<Dialog> {
        ...
        protected AfficherLotEcritureDialogEvent(Dialog source, ZZZLotEcriture argLotEcriture) {
        ...
        public ZZZLotEcriture getLotEcriture() {
            return lotEcriture;
        }
    }

    public static class LotEcritureLoadEvent extends AfficherLotEcritureDialogEvent {
        public LotEcritureLoadEvent(Dialog source, ZZZLotEcriture lotEcriture) {
