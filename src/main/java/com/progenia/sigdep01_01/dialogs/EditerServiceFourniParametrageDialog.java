 ...
 */
public class EditerServiceFourniParametrageDialog extends BaseEditerReferentielDetailFormDialog<XXXServiceFourniParametrage> {
    /***
    ...
    */
    ...
    /* Fields to edit properties in XXXServiceFourniParametrage entity */
    ...
    public EditerServiceFourniParametrageDialog() {
        ...
        super();
        this.binder = new BeanValidationBinder<>(XXXServiceFourniParametrage.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ServiceFourni parentBean, ArrayList<XXXServiceFourniParametrage> targetBeanList, ArrayList<XXXServiceFourniParametrage> referenceBeanList, EventBus.UIEventBus uiEventBus, VariableServiceBusiness variableServiceBusiness, SystemeTypeTauxInteretBusiness typeVariableBusiness, SecteurEconomiqueBusiness uniteOeuvreBusiness) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(XXXServiceFourniParametrage::getCodeVariable));
        ...
        try 
        {
            ...
            */
            ...
            this.binder.forField(this.cboCodeVariable)
                ...
                .bind(XXXServiceFourniParametrage::getVariableService, XXXServiceFourniParametrage::setVariableService);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in XXXServiceFourniParametrage and ServiceFourniParametrageView based on their names.
            */
    ...
    @Override
    public XXXServiceFourniParametrage workingCreateNewBeanInstance()
    {
        try 
        {
            //Initialisation de valeurs par défaut
            XXXServiceFourniParametrage serviceFourniParametrage = new XXXServiceFourniParametrage(this.parentBean);
    ...
    public static abstract class EditerServiceFourniParametrageDialogEvent extends ComponentEvent<Dialog> {
        private XXXServiceFourniParametrage serviceFourniParametrage;

        protected EditerServiceFourniParametrageDialogEvent(Dialog source, XXXServiceFourniParametrage argServiceFourniParametrage) {
        ...
        public XXXServiceFourniParametrage getServiceFourniParametrage() {
            return serviceFourniParametrage;
        }
    }

    public static class ServiceFourniParametrageAddEvent extends EditerServiceFourniParametrageDialogEvent {
        public ServiceFourniParametrageAddEvent(Dialog source, XXXServiceFourniParametrage serviceFourniParametrage) {
    ...
    public static class ServiceFourniParametrageUpdateEvent extends EditerServiceFourniParametrageDialogEvent {
        public ServiceFourniParametrageUpdateEvent(Dialog source, XXXServiceFourniParametrage serviceFourniParametrage) {
            super(source, serviceFourniParametrage);
        }
    }
    ...
    private class SortByCodeVariable implements Comparator<XXXServiceFourniParametrage> {
        // Used for sorting in ascending order of
        // getCodeVariable()
        public int compare(XXXServiceFourniParametrage a, XXXServiceFourniParametrage b)
        {
