 ...
 */
public class EditerFacturationActeDetailsDialog extends BaseEditerTransactionDetailDialog<ZZZFacturationActeDetails> {
    /***
    ...
    */
    ...
    private ZZZFacturationActe parentBean;
    ...
    /* Fields to edit properties in ZZZFacturationActeDetails entity */
    ...
    public EditerFacturationActeDetailsDialog() {
        ...
        this.binder = new BeanValidationBinder<>(ZZZFacturationActeDetails.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, ZZZFacturationActe parentBean, ArrayList<ZZZFacturationActeDetails> targetBeanList, EventBus.UIEventBus uiEventBus, FacturationActeDetailsBusiness facturationActeDetailsBusiness, ZZZCentreIncubateur centreIncubateurCible, Instrument InstrumentCible, ServiceFourniBusiness serviceFourniBusiness) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(ZZZFacturationActeDetails::getNoChronoPrestation));
        ...
        try 
        {
            ...
            */
            ...
            this.binder.forField(this.txtNoChronoPrestation)
                ...
                .bind(ZZZFacturationActeDetails::getNoChronoPrestation, ZZZFacturationActeDetails::setNoChronoPrestation);
            ...
            this.binder.forField(this.datDatePrestation)
                ...
                */
                ...
                .bind(ZZZFacturationActeDetails::getDatePrestation, ZZZFacturationActeDetails::setDatePrestation);
            ...
            this.binder.forField(this.cboCodeService)
                ...
                .bind(ZZZFacturationActeDetails::getServiceFourni, ZZZFacturationActeDetails::setServiceFourni);
            ...
            this.binder.forField(this.txtMontantFactureService)
                ...
                .bind(ZZZFacturationActeDetails::getMontantFactureService, ZZZFacturationActeDetails::setMontantFactureService);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in ZZZFacturationActeDetails and FacturationActeDetailsView based on their names.
            */
    ...
    protected void workingDeleteItem(ZZZFacturationActeDetails facturationActeDetailsItem) {
        try 
        {
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            blnCheckOk = true;
            /* Non Pertinent
            //ZZZFacturationActeDetailsId currentKeyValue = new ZZZFacturationActeDetailsId(parentBean, this.txtDebit.getValue(), this.txtCodeService.getValue());
    ...
    @Override
    public ZZZFacturationActeDetails workingCreateNewBeanInstance()
    {
        try 
        {
            //Initialisation de valeurs par défaut
            ZZZFacturationActeDetails facturationActeDetails = new ZZZFacturationActeDetails(this.parentBean);
    ...
    public static abstract class EditerFacturationActeDetailsDialogEvent extends ComponentEvent<Dialog> {
        ...
        private ArrayList<ZZZFacturationActeDetails> facturationActeDetailsList;

        protected EditerFacturationActeDetailsDialogEvent(Dialog source, ArrayList<ZZZFacturationActeDetails> argFacturationActeDetailsList) {
        ...
        public ArrayList<ZZZFacturationActeDetails> getFacturationActeDetailsList() {
    ...
    public static class FacturationActeDetailsAddEvent extends EditerFacturationActeDetailsDialogEvent {
        public FacturationActeDetailsAddEvent(Dialog source, ZZZFacturationActe facturationActe) {
    ...
    public static class FacturationActeDetailsUpdateEvent extends EditerFacturationActeDetailsDialogEvent {
        public FacturationActeDetailsUpdateEvent(Dialog source, ZZZFacturationActe facturationActe) {
            super(source, facturationActe);
        }
    }
    */
    ...
    public static class FacturationActeDetailsRefreshEvent extends EditerFacturationActeDetailsDialogEvent {
        public FacturationActeDetailsRefreshEvent(Dialog source, ArrayList<ZZZFacturationActeDetails> facturationActeDetailsList) {
            super(source, facturationActeDetailsList);
        }
    }
    /* End of the API - EVENTS OUT */

    public void setParentBean(ZZZFacturationActe parentBean) {
