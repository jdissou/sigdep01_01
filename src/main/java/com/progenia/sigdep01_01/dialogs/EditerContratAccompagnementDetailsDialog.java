 ...
 */
public class EditerContratAccompagnementDetailsDialog extends BaseEditerTransactionDetailDialog<RemboursementDetails> {
    /***
    ...
    */
    ...
    private Remboursement parentBean;
    ...
    /* Fields to edit properties in RemboursementDetails entity */
    ...
    public EditerContratAccompagnementDetailsDialog() {
        ...
        super();
        this.binder = new BeanValidationBinder<>(RemboursementDetails.class);
    ...
    // Show Dialog
    public void showDialog(String dialogTitle, Remboursement parentBean, ArrayList<RemboursementDetails> targetBeanList, EventBus.UIEventBus uiEventBus, RemboursementDetailsBusiness contratAccompagnementDetailsBusiness, ServiceFourniBusiness serviceFourniBusiness, AbonnementServiceBusiness abonnementServiceBusiness, ZZZCentreIncubateur centreIncubateurCible, Instrument InstrumentCible) {
        ...
        try 
        {
            ...
            Collections.sort(this.targetBeanList, Comparator.comparing(RemboursementDetails::getLibelleService));
        ...
        try 
        {
            ...
            */
            ...
            this.binder.forField(this.cboCodeService)
                ...
                .bind(RemboursementDetails::getServiceFourni, RemboursementDetails::setServiceFourni);
            ...
            this.binder.forField(this.txtObservations)
                ...
                .bind(RemboursementDetails::getObservations, RemboursementDetails::setObservations);
            
            /* 3 - Alternative : Bind Fields instances that need validators manually and then bind all remaining fields using the bindInstanceFields method
            this.binder.bindInstanceFields(this.formLayout); //Automatic Data Binding
            //bindInstanceFields matches fields in RemboursementDetails and ContratAccompagnementDetailsView based on their names.
            */
    ...
    protected void workingDeleteItem(RemboursementDetails contratAccompagnementDetailsItem) {
        try 
        {
    ...
    protected boolean workingIsPrimaryKeyAndBeanExtraCheckValidated()
    {
        ...
        try
        {
            //RemboursementDetailsId currentKeyValue = new RemboursementDetailsId(parentBean, this.txtDebit.getValue(), this.txtCodeService.getValue());
            String currentKeyValue = this.cboCodeService.getValue().getCodeService();
            
            this.abonnementServiceEnCoursList = (ArrayList)this.abonnementServiceBusiness.getAbonnementServiceEnCours(this.centreIncubateurCible, this.InstrumentCible);
    ...
    @Override
    public RemboursementDetails workingCreateNewBeanInstance()
    {
        try 
        {
            //Initialisation de valeurs par défaut
            RemboursementDetails contratAccompagnementDetails = new RemboursementDetails(this.parentBean);
    ...
    public static abstract class EditerContratAccompagnementDetailsDialogEvent extends ComponentEvent<Dialog> {
        ...
        private ArrayList<RemboursementDetails> contratAccompagnementDetailsList;

        protected EditerContratAccompagnementDetailsDialogEvent(Dialog source, ArrayList<RemboursementDetails> argContratAccompagnementDetailsList) {
        ...
        public ArrayList<RemboursementDetails> getContratAccompagnementDetailsList() {
    ...
    public static class ContratAccompagnementDetailsAddEvent extends EditerContratAccompagnementDetailsDialogEvent {
        public ContratAccompagnementDetailsAddEvent(Dialog source, Remboursement contratAccompagnement) {
    ...
    public static class ContratAccompagnementDetailsUpdateEvent extends EditerContratAccompagnementDetailsDialogEvent {
        public ContratAccompagnementDetailsUpdateEvent(Dialog source, Remboursement contratAccompagnement) {
            super(source, contratAccompagnement);
        }
    }
    */
    ...
    public static class ContratAccompagnementDetailsRefreshEvent extends EditerContratAccompagnementDetailsDialogEvent {
        public ContratAccompagnementDetailsRefreshEvent(Dialog source, ArrayList<RemboursementDetails> contratAccompagnementDetailsList) {
            super(source, contratAccompagnementDetailsList);
        }
    }
    /* End of the API - EVENTS OUT */

    public void setParentBean(Remboursement parentBean) {
