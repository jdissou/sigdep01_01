 ...
 */
public class AfficherContratLotDialog extends BaseAfficherTransactionDialog<ZZZContratLot> {
    /***
    ...
    */
    ...
    public void showDialog(String dialogTitle, EventBus.UIEventBus uiEventBus, ZZZCentreIncubateur centreIncubateurCible, ContratLotBusiness contratLotBusiness, ExerciceBusiness exerciceBusiness, UtilisateurBusiness utilisateurBusiness, CentreIncubateurBusiness centreIncubateurBusiness, ServiceFourniBusiness serviceFourniBusiness) {
        ...
        try 
        {
            ...
            */
            ...
            this.dataProvider.setSortOrder(ZZZContratLot::getNoContrat, SortDirection.DESCENDING);
    ...
    private void configureGridWithFilters() {
        ...
        try 
        {
            ...
            if (this.grid.getColumnByKey("Exercice") == null) {
                ...
                Grid.Column<ZZZContratLot> noChronoColumn = this.grid.addColumn(ZZZContratLot::getNoChrono).setKey("NoChrono").setHeader("N° Contrat").setTextAlign(ColumnTextAlign.START).setFlexGrow(0).setWidth("150px"); // fixed column
                ...
                //Grid.Column<ZZZContratLot> dateContratColumn = this.grid.addColumn(new LocalDateRenderer<>(ZZZContratLot::getDateContrat, DateTimeFormatter.ofLocalizedDate(FormatStyle.SHORT))).setKey("DateContrat").setHeader("Date Contrat").setTextAlign(ColumnTextAlign.CENTER).setFlexGrow(0).setWidth("175px"); // fixed column

                Grid.Column<ZZZContratLot> centreIncubateurColumn = this.grid.addColumn(new ComponentRenderer<>(
                            contratLot -> {
                                //ComboBox comboBox = new ComboBox();
    ...
    @Override
    public void publishLoadEvent(ZZZContratLot selectedItem) {
        //Publish Load Event
        try 
        {
    ...
    public static abstract class AfficherContratLotDialogEvent extends ComponentEvent<Dialog> {
        ...
        protected AfficherContratLotDialogEvent(Dialog source, ZZZContratLot argContratLot) {
        ...
        public ZZZContratLot getContratLot() {
            return contratLot;
        }
    }

    public static class ContratLotLoadEvent extends AfficherContratLotDialogEvent {
        public ContratLotLoadEvent(Dialog source, ZZZContratLot contratLot) {
