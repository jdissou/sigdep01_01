...
@SqlResultSetMapping(name = "ServiceFourniPojo", 
        classes = @ConstructorResult(targetClass = ServiceFourniPojo.class, 
                columns = { 
                    @ColumnResult(name = "CodeService", type = String.class),  
...
/*
In this class, I’ve created a mapping with the name “ServiceFourniPojo” 
and specified the ServiceFourniPojo.class class as the targetClass in the ConstructorResult annotation.
...
@Entity
public class ServiceFourniPojo {
    @Id
