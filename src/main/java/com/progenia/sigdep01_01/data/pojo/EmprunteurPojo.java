...
@SqlResultSetMapping(name = "EmprunteurPojo", 
        classes = @ConstructorResult(targetClass = EmprunteurPojo.class, 
                columns = { 
                    @ColumnResult(name = "codeEmprunteur", type = String.class),
                        @ColumnResult(name = "libelleEmprunteur", type = String.class),
                        @ColumnResult(name = "libelleCourtEmprunteur", type = String.class),
                        @ColumnResult(name = "codeCategorieEmprunteur", type = String.class),
                        ...
                        @ColumnResult(name = "libelleCategorieEmprunteur", type = String.class)
}))

/*
In this class, I’ve created a mapping with the name “EmprunteurPojo” 
and specified the EmprunteurPojo.class class as the targetClass in the ConstructorResult annotation.
...
public class EmprunteurPojo {
    ...
    private String libelleCategorieEmprunteur;
