...
@Entity
@Table(name="ZZZCentreIncubateurExercice")
/*
...
public class ZZZCentreIncubateurExercice implements Serializable {
    @EmbeddedId
    private ZZZCentreIncubateurExerciceId centreIncubateurExerciceId;
    ...
    public ZZZCentreIncubateurExercice() {
        //Initialisation des valeurs par défaut
        this.isCloture = false;
        this.noMouvementComptaCloture = 0L;
    }

    public ZZZCentreIncubateurExercice(ZZZCentreIncubateur centreIncubateur, Exercice exercice) {
        this.centreIncubateurExerciceId = new ZZZCentreIncubateurExerciceId();
    ...
    public ZZZCentreIncubateurExercice(Exercice exercice) {
        this.centreIncubateurExerciceId = new ZZZCentreIncubateurExerciceId();
        this.centreIncubateurExerciceId.setNoExercice(exercice.getNoExercice());
        this.exercice = exercice;
    ...
    public ZZZCentreIncubateurExercice(ZZZCentreIncubateur centreIncubateur) {
        this.centreIncubateurExerciceId = new ZZZCentreIncubateurExerciceId();
        this.centreIncubateurExerciceId.setCodeCentreIncubateur(centreIncubateur.getCodeCentreIncubateur());
        this.centreIncubateur = centreIncubateur;
