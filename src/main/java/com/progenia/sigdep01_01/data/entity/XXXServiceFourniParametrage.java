...
public class XXXServiceFourniParametrage implements Serializable {
    @EmbeddedId
    ...
    public XXXServiceFourniParametrage(ServiceFourni serviceFourni, VariableService variableService) {
    ...
    public XXXServiceFourniParametrage(ServiceFourni serviceFourni) {
        this.serviceFourniParametrageId = new ServiceFourniParametrageId();
        this.serviceFourniParametrageId.setCodeService(serviceFourni.getCodeService()); 
        this.serviceFourni = serviceFourni;
    }

    public XXXServiceFourniParametrage(VariableService variableService) {
        this.serviceFourniParametrageId = new ServiceFourniParametrageId();
        this.serviceFourniParametrageId.setCodeVariable(variableService.getCodeVariable()); 
        this.variableService = variableService;
    }
