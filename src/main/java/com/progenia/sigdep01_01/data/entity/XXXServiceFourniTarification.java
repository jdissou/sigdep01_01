...
public class XXXServiceFourniTarification implements Serializable {
    @EmbeddedId
    ...
    public XXXServiceFourniTarification(ServiceFourni serviceFourni, Rubrique rubrique) {
    ...
    public XXXServiceFourniTarification(ServiceFourni serviceFourni) {
        this.serviceFourniTarificationId = new ServiceFourniTarificationId();
        this.serviceFourniTarificationId.setCodeService(serviceFourni.getCodeService()); 
        this.serviceFourni = serviceFourni;
    }

    public XXXServiceFourniTarification(Rubrique rubrique) {
        this.serviceFourniTarificationId = new ServiceFourniTarificationId();
        this.serviceFourniTarificationId.setNoRubrique(rubrique.getNoRubrique()); 
        this.rubrique = rubrique;
    }
