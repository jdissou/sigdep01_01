...
/*
    ...
    CreancierRepositoryImpl extends CreancierRepositoryCustom.
*/

public class CreancierRepositoryImpl implements CreancierRepositoryCustom {
    ...
    public List<CreancierPojo> getReportData() {
        List<CreancierPojo> results = new ArrayList<>();
        ...
        try {
            ...
            results = this.entityManager.createNativeQuery("{call ReqSpEtatCreancier()}", "CreancierPojo")
               .getResultList();
            return results;
        }
        catch (Exception e) 
        {
            MessageDialogHelper.showAlertDialog("CreancierRepositoryImpl.getReportData", e.toString());
            e.printStackTrace();
            return null;
        }
    }
