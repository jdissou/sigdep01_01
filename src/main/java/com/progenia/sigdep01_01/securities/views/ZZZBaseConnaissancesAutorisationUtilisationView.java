...
public class ZZZBaseConnaissancesAutorisationUtilisationView extends VerticalLayout {
    ...
    */
    ...
    static final String PAGE_TITLE = "Autorisations d'utilisation";
    static final String CACHED_TAB43_SELECTED_MENU = "ParametrageUtilisateurViewSelectedMenu";
    static final String CACHED_TAB43_SELECTED_COMMANDE = "ParametrageUtilisateurViewSelectedCommande";
